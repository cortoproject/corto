...
/* $begin(::tc_event::Point::construct_onThis) */
    ...
    tcResult[observableOnConstructThis].this = this;
...
/* $begin(::tc_event::Point::destruct_onThis) */
    ...
    tcResult[observableOnDestructThis].this = this;
...
/* $begin(::tc_event::Point::new_onThis) */
    ...
    tcResult[observableOnNewThis].this = this;
...
/* $begin(::tc_event::Point::update_onThis) */
    ...
    tcResult[observableOnUpdateThis].this = this;
