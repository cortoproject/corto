...
int tc_event_load(void) {
    ...
    /* Declare ::tc_event */
    tc_o = cx_declareChild(root_o, "tc_event", cx_type(cx_object_o));
    if (!tc_o) {
    ...
    tc_construct_onBoth_o = cx_declareChild(tc_o, "construct_onBoth", cx_type(cx_observer_o));
    ...
    tc_construct_onChild_o = cx_declareChild(tc_o, "construct_onChild", cx_type(cx_observer_o));
    ...
    tc_construct_onRootChilds_o = cx_declareChild(tc_o, "construct_onRootChilds", cx_type(cx_observer_o));
    ...
    tc_construct_onRootSelf_o = cx_declareChild(tc_o, "construct_onRootSelf", cx_type(cx_observer_o));
    ...
    tc_construct_onSelf_o = cx_declareChild(tc_o, "construct_onSelf", cx_type(cx_observer_o));
    ...
    tc_destruct_onBoth_o = cx_declareChild(tc_o, "destruct_onBoth", cx_type(cx_observer_o));
    ...
    tc_destruct_onChild_o = cx_declareChild(tc_o, "destruct_onChild", cx_type(cx_observer_o));
    ...
    tc_destruct_onRootChilds_o = cx_declareChild(tc_o, "destruct_onRootChilds", cx_type(cx_observer_o));
    ...
    tc_destruct_onRootSelf_o = cx_declareChild(tc_o, "destruct_onRootSelf", cx_type(cx_observer_o));
    ...
    tc_destruct_onSelf_o = cx_declareChild(tc_o, "destruct_onSelf", cx_type(cx_observer_o));
    ...
    tc_new_onBoth_o = cx_declareChild(tc_o, "new_onBoth", cx_type(cx_observer_o));
    if (!tc_new_onBoth_o) {
    ...
    tc_new_onChild_o = cx_declareChild(tc_o, "new_onChild", cx_type(cx_observer_o));
    if (!tc_new_onChild_o) {
    ...
    tc_new_onRootChilds_o = cx_declareChild(tc_o, "new_onRootChilds", cx_type(cx_observer_o));
    ...
    tc_new_onRootSelf_o = cx_declareChild(tc_o, "new_onRootSelf", cx_type(cx_observer_o));
    ...
    tc_new_onSelf_o = cx_declareChild(tc_o, "new_onSelf", cx_type(cx_observer_o));
    if (!tc_new_onSelf_o) {
    ...
    tc_Point_o = cx_declareChild(tc_o, "Point", cx_type(cx_class_o));
    if (!tc_Point_o) {
    ...
    tc_Point_construct_onThis_o = cx_declareChild(tc_Point_o, "construct_onThis", cx_type(cx_observer_o));
    ...
    tc_Point_destruct_onThis_o = cx_declareChild(tc_Point_o, "destruct_onThis", cx_type(cx_observer_o));
    ...
    tc_Point_new_onThis_o = cx_declareChild(tc_Point_o, "new_onThis", cx_type(cx_observer_o));
    ...
    tc_Point_update_onThis_o = cx_declareChild(tc_Point_o, "update_onThis", cx_type(cx_observer_o));
    ...
    tc_Point_x_o = cx_declareChild(tc_Point_o, "x", cx_type(cx_member_o));
    if (!tc_Point_x_o) {
    ...
    tc_Point_y_o = cx_declareChild(tc_Point_o, "y", cx_type(cx_member_o));
    if (!tc_Point_y_o) {
    ...
    tc_parent_o = cx_declareChild(tc_o, "parent", cx_type(tc_Point_o));
    if (!tc_parent_o) {
    ...
    tc_update_onBoth_o = cx_declareChild(tc_o, "update_onBoth", cx_type(cx_observer_o));
    ...
    tc_update_onChild_o = cx_declareChild(tc_o, "update_onChild", cx_type(cx_observer_o));
    ...
    tc_update_onSelf_o = cx_declareChild(tc_o, "update_onSelf", cx_type(cx_observer_o));
    ...
    tc_parent_child_o = cx_declareChild(tc_parent_o, "child", cx_type(tc_Point_o));
    ...
    tc_update_onRootChilds_o = cx_declareChild(tc_o, "update_onRootChilds", cx_type(cx_observer_o));
    ...
    tc_update_onRootSelf_o = cx_declareChild(tc_o, "update_onRootSelf", cx_type(cx_observer_o));
    ...
    tc_value_o = cx_declareChild(tc_o, "value", cx_type(cx_type_o));
    if (!tc_value_o) {
