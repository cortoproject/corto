    ...
    uint64_t limit)
{
    ...
    while (ut_iter_hasNext(&iter)) {
        ...
        listItem->parent = ut_strdup(item->parent);
        listItem->name = ut_strdup(item->name);
        listItem->type = ut_strdup(item->type);
        ut_ll_append(result, listItem);
    }
        ...
        if (!strcmp(item->parent, parent)) {
            if (!strcmp(item->name, name)) {
                if (!strcmp(item->type, type)) {
                    ...
                    ut_throw("type does not match (%s vs %s)", item->type, type);
                }

            } else {
                ut_throw("name does not match (%s vs %s)", item->name, name);
            }

        } else {
            ut_throw("parent does not match (%s vs %s)", item->parent, parent);
        }
    ...
    test_Select this)
{
    ...
    test_assertint(ut_ll_count(results), 1);
    ...
    test_Select this)
{
    ...
    test_assert(results != NULL);
    test_assertint(ut_ll_count(results), 3);
    ...
    test_Select this)
{
    ...
    test_assert(results != NULL);
    test_assertint(ut_ll_count(results), 2);
    ...
    test_Select this)
{
    ...
    test_assertint(ut_ll_count(results), 8);
    ...
    test_Select this)
{
    ...
    test_assert(results != NULL);
    test_assertint(ut_ll_count(results), 24);
    ...
    test_Select this)
{
    ...
    test_assertint(ut_ll_count(results), 4);
    ...
    test_Select this)
{
    ...
    test_assert(results != NULL);
    test_assertint(ut_ll_count(results), 20);
    ...
    test_Select this)
{
    ...
    results = test_Select_collect(NULL, "/corto/", 0, 0);
    test_assert(results != NULL);
    test_assertint(ut_ll_count(results), 5);
    ...
    test_Select this)
{
    ...
    test_assertint(ut_ll_count(results), 6);
    ...
    test_Select this)
{
    ...
    test_assert(results != NULL);
    test_assertint(ut_ll_count(results), 18);
    ...
    test_Select this)
{
    ...
    test_assert(ut_iter_hasNext(&it) == 1);
    corto_record *r = ut_iter_next(&it);
