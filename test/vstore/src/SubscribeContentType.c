    ...
    test_SubscribeContentType this)
{
    ...
    test_assert(corto_publish(CORTO_UPDATE, NULL, "json/c", "/test/Point", "text/json", "{\"x\":70,\"y\":80}") == 0);
    ...
    test_SubscribeContentType this)
{
    ...
    test_assert(corto_publish(CORTO_UPDATE, NULL, "str/c", "/test/Point", "text/corto", "{70,80}") == 0);
    test_assertint(this->eventsReceived, 4);
    ...
    test_SubscribeContentType this)
{
    ...
    test_assert(corto_publish(CORTO_UPDATE, NULL, "json/c", "/test/ContentTypeTest", "text/json", "{\"x\":70,\"y\":80}") == 0);
    test_assertint(this->eventsReceived, 4);
