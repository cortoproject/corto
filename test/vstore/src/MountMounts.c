    ...
    test_MountMounts this)
{
    ...
    test_assert(ut_ll_count(mnt->subscribes) == 0);
    test_assert(ut_ll_count(mnt->unsubscribes) == 0);
    test_assert(ut_ll_count(mnt->mounts) == 0);
    test_assert(ut_ll_count(mnt->unmounts) == 0);
    ...
    test_assert(ut_ll_count(mnt->subscribes) == 0);
    test_assert(ut_ll_count(mnt->unsubscribes) == 0);
    test_assert(ut_ll_count(mnt->mounts) == 1);
    test_assert(ut_ll_count(mnt->unmounts) == 0);
}
