    ...
    test_Util this)
{
    ...
    corto_string ullongMax = corto_asprintf("%llu", ULLONG_MAX);
    test_assert(strcmp(corto_ulltoa(ULLONG_MAX, buffer, 10), ullongMax) == 0);

    corto_string ulongMax = corto_asprintf("%lu", ULONG_MAX);
    test_assert(strcmp(corto_ulltoa(ULONG_MAX, buffer, 10), ulongMax) == 0);

    corto_string longMin = corto_asprintf("%lu", LONG_MIN);
    ...
    corto_string a3 = corto_asprintf("%d", 65535);
    test_assert(strcmp(corto_ulltoa(65535, buffer, 10), a3) == 0);

    corto_string a4 = corto_asprintf("%d", -65535);
