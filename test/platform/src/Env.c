...
{
    ut_setenv("CORTO_TEST_A", "A");
    ut_setenv("CORTO_TEST_B",  "A/%s/$CORTO_TEST_A", "A");
    test_assert(!strcmp(ut_getenv("CORTO_TEST_B"), "A/A/A"));
}
...
{
    ut_setenv("CORTO_TEST_A", "A");
    test_assert(!strcmp(ut_getenv("CORTO_TEST_A"), "A"));
    ut_setenv("CORTO_TEST_A", NULL);
    test_assert(ut_getenv("CORTO_TEST_A") == NULL);
}

void test_Env_tc_setenvReplaceMultiple(
    test_Env this)
{
    test_assert(!ut_setenv("CORTO_TEST_A", "A"));
    test_assert(!ut_setenv("CORTO_TEST_B", "<$CORTO_TEST_A $CORTO_TEST_A $CORTO_TEST_A>"));
    test_assert(!strcmp(ut_getenv("CORTO_TEST_B"), "<A A A>"));
}
...
{
    test_assert(!ut_setenv("CORTO_TEST_A", "A"));
    test_assert(!ut_setenv("CORTO_TEST_A", "$CORTO_TEST_A:$CORTO_TEST_A"));
    test_assert(!strcmp(ut_getenv("CORTO_TEST_A"), "A:A"));
}
...
void test_Env_tc_setenvSimpleFormat(
    test_Env this)
{
    test_assert(!ut_setenv("CORTO_TEST_A", "A %s", "B"));
    test_assert(!strcmp(ut_getenv("CORTO_TEST_A"), "A B"));
}
...
{
    test_assert(!ut_setenv("CORTO_TEST_A", "A"));
    test_assert(!ut_setenv("CORTO_TEST_B", "B $CORTO_TEST_A"));
    test_assert(!strcmp(ut_getenv("CORTO_TEST_B"), "B A"));
}

void test_Env_tc_setenvVariableNotFound(
    test_Env this)
{
    test_assert(ut_setenv("CORTO_TEST_A", "ABC ABC $CORTO_NOT_FOUND"));
    test_assert(ut_catch());
}
