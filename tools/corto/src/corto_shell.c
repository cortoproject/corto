...
static int cxsh_scopeWalk(cx_object o, void* udata) {
    ...
    /* Get name of type */
    if (cx_checkAttr(cx_typeof(o), CX_ATTR_SCOPED) && (cx_parentof(cx_typeof(o)) == corto_lang_o)) {
...
static int cxsh_treeWalk(cx_object o, void* userData) {
    ...
    /* Limit name-buffer to local scope */
    {
        ...
        /* Object */
        name = cx_nameof(o);
        if (cx_parentof(cx_typeof(o)) == corto_lang_o) {
...
int corto_shell(int argc, char* argv[]) {
    int i;
