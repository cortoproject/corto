...
corto_container _corto_containerCreateChild(corto_object _parent, corto_string _id, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value) {
    corto_container _this;
...
corto_destructAction* _corto_destructActionCreate(corto_object instance, corto_function procedure) {
    ...
    _this = (corto_destructAction*)corto_declare(NULL, NULL, corto_destructAction_o);
    if (!_this) {
        return NULL;
    }
    if (!corto_check_state(_this, CORTO_VALID)) {
...
corto_destructAction* _corto_destructActionCreateChild(corto_object _parent, corto_string _id, corto_object instance, corto_function procedure) {
    corto_destructAction* _this;
    _this = (corto_destructAction*)corto_declare(_parent, _id, corto_destructAction_o);
    if (!_this) {
        return NULL;
    }
    if (!corto_check_state(_this, CORTO_VALID)) {
...
corto_initAction* _corto_initActionCreate(corto_object instance, corto_function procedure) {
    ...
    _this = (corto_initAction*)corto_declare(NULL, NULL, corto_initAction_o);
    if (!_this) {
        return NULL;
    }
    if (!corto_check_state(_this, CORTO_VALID)) {
...
corto_initAction* _corto_initActionCreateChild(corto_object _parent, corto_string _id, corto_object instance, corto_function procedure) {
    corto_initAction* _this;
    _this = (corto_initAction*)corto_declare(_parent, _id, corto_initAction_o);
    if (!_this) {
        return NULL;
    }
    if (!corto_check_state(_this, CORTO_VALID)) {
...
corto_leaf _corto_leafCreateChild(corto_object _parent, corto_string _id, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value) {
    corto_leaf _this;
...
corto_nameAction* _corto_nameActionCreate(corto_object instance, corto_function procedure) {
    ...
    _this = (corto_nameAction*)corto_declare(NULL, NULL, corto_nameAction_o);
    if (!_this) {
        return NULL;
    }
    if (!corto_check_state(_this, CORTO_VALID)) {
...
corto_nameAction* _corto_nameActionCreateChild(corto_object _parent, corto_string _id, corto_object instance, corto_function procedure) {
    corto_nameAction* _this;
    _this = (corto_nameAction*)corto_declare(_parent, _id, corto_nameAction_o);
    if (!_this) {
        return NULL;
    }
    if (!corto_check_state(_this, CORTO_VALID)) {
...
corto_parameter* _corto_parameterCreateChild(corto_object _parent, corto_string _id, const char * name, corto_type type, corto_inout inout, bool passByReference) {
    corto_parameter* _this;
...
corto_quantity _corto_quantityCreateChild(corto_object _parent, corto_string _id, const char * description) {
    corto_quantity _this;
...
corto_table _corto_tableCreateChild(corto_object _parent, corto_string _id, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value) {
    corto_table _this;
...
corto_unit _corto_unitCreateChild(corto_object _parent, corto_string _id, corto_quantity quantity, const char * symbol, const char * conversion, corto_type type) {
    corto_unit _this;
...
void* _corto_unknownCreateChild(corto_object _parent, corto_string _id) {
    void* _this;
...
corto_verbatim _corto_verbatimCreateChild(corto_object _parent, corto_string _id, const char * contentType) {
    corto_verbatim _this;
