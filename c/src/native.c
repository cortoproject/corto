...
corto_native_type _corto_native_type__create(corto_object _parent, const char *_id, const char * name) {
...
corto_int16 _corto_native_type__update(corto_native_type _this, const char * name) {
    CORTO_UNUSED(_this);
...
corto_native_type _corto_native_type__assign(corto_native_type _this, const char * name) {
    CORTO_UNUSED(_this);
    corto_set_str(&((corto_native_type)_this)->name, name);
    return _this;
}
