...
#define corto_dispatcher__assign(_this) _corto_dispatcher__assign(corto_dispatcher(_this))
#define corto_dispatcher__set(_this) _this = _this ? _this : (corto_dispatcher*)corto_ptr_new(corto_dispatcher_o); _corto_dispatcher__assign(corto_dispatcher(_this))
...
#define corto_event__assign(_this) _corto_event__assign(corto_event(_this))
#define corto_event__set(_this) _this = _this ? _this : (corto_event*)corto_ptr_new(corto_event_o); _corto_event__assign(corto_event(_this))
...
#define corto_eventMask__assign(_this, value) _corto_eventMask__assign(corto_eventMask(_this), value)
#define corto_eventMask__set(_this, value) _this = _this ? _this : (corto_eventMask*)corto_ptr_new(corto_eventMask_o); _corto_eventMask__assign(corto_eventMask(_this), value)
...
#define corto_frame__assign(_this, kind, value) _corto_frame__assign(corto_frame(_this), kind, value)
#define corto_frame__set(_this, kind, value) _this = _this ? _this : (corto_frame*)corto_ptr_new(corto_frame_o); _corto_frame__assign(corto_frame(_this), kind, value)
...
#define corto_frameKind__assign(_this, value) _corto_frameKind__assign(corto_frameKind(_this), value)
#define corto_frameKind__set(_this, value) _this = _this ? _this : (corto_frameKind*)corto_ptr_new(corto_frameKind_o); _corto_frameKind__assign(corto_frameKind(_this), value)
...
#define corto_handleAction__assign(_this, instance, procedure) _corto_handleAction__assign(corto_handleAction(_this), instance, corto_function(procedure))
#define corto_handleAction__set(_this, instance, procedure) _this = _this ? _this : (corto_handleAction*)corto_ptr_new(corto_handleAction_o); _corto_handleAction__assign(corto_handleAction(_this), instance, corto_function(procedure))
...
#define corto_invokeEvent__assign(_this, mount, instance, function, args) _corto_invokeEvent__assign(corto_invokeEvent(_this), corto_mount(mount), instance, corto_function(function), args)
#define corto_invokeEvent__set(_this, mount, instance, function, args) _this = _this ? _this : (corto_invokeEvent*)corto_ptr_new(corto_invokeEvent_o); _corto_invokeEvent__assign(corto_invokeEvent(_this), corto_mount(mount), instance, corto_function(function), args)
...
#define corto_loader__assign(_this, autoLoad) _corto_loader__assign(corto_loader(_this), autoLoad)
#define corto_loader__set(_this, autoLoad) _this = _this ? _this : (corto_loader*)corto_ptr_new(corto_loader_o); _corto_loader__assign(corto_loader(_this), autoLoad)
...
#define corto_mount__assign(_this, query, contentType, policy) _corto_mount__assign(corto_mount(_this), query, contentType, policy)
#define corto_mount__set(_this, query, contentType, policy) _this = _this ? _this : (corto_mount*)corto_ptr_new(corto_mount_o); _corto_mount__assign(corto_mount(_this), query, contentType, policy)
...
#define corto_mountMask__assign(_this, value) _corto_mountMask__assign(corto_mountMask(_this), value)
#define corto_mountMask__set(_this, value) _this = _this ? _this : (corto_mountMask*)corto_ptr_new(corto_mountMask_o); _corto_mountMask__assign(corto_mountMask(_this), value)
...
#define corto_mountPolicy__assign(_this, ownership, mask, sampleRate, queue, expiryTime, filterResults) _corto_mountPolicy__assign(corto_mountPolicy(_this), ownership, mask, sampleRate, queue, expiryTime, filterResults)
#define corto_mountPolicy__set(_this, ownership, mask, sampleRate, queue, expiryTime, filterResults) _this = _this ? _this : (corto_mountPolicy*)corto_ptr_new(corto_mountPolicy_o); _corto_mountPolicy__assign(corto_mountPolicy(_this), ownership, mask, sampleRate, queue, expiryTime, filterResults)
...
#define corto_mountSubscription__assign(_this, query, mountCount, subscriberCount, mountCtx, subscriberCtx) _corto_mountSubscription__assign(corto_mountSubscription(_this), query, mountCount, subscriberCount, mountCtx, subscriberCtx)
#define corto_mountSubscription__set(_this, query, mountCount, subscriberCount, mountCtx, subscriberCtx) _this = _this ? _this : (corto_mountSubscription*)corto_ptr_new(corto_mountSubscription_o); _corto_mountSubscription__assign(corto_mountSubscription(_this), query, mountCount, subscriberCount, mountCtx, subscriberCtx)
...
#define corto_mountSubscriptionList__assign(_this, length, elements) _corto_mountSubscriptionList__assign(corto_mountSubscriptionList(_this), length, elements)
#define corto_mountSubscriptionList__set(_this, length, elements) _this = _this ? _this : (corto_mountSubscriptionList*)corto_ptr_new(corto_mountSubscriptionList_o); _corto_mountSubscriptionList__assign(corto_mountSubscriptionList(_this), length, elements)
...
#define corto_objectIter__assign(_this) _corto_objectIter__assign(corto_objectIter(_this))
#define corto_objectIter__set(_this) _this = _this ? _this : (corto_objectIter*)corto_ptr_new(corto_objectIter_o); _corto_objectIter__assign(corto_objectIter(_this))
...
#define corto_observer__assign(_this, mask, observable, instance, dispatcher, type, enabled, _impl) _corto_observer__assign(corto_observer(_this), mask, observable, instance, corto_dispatcher(dispatcher), corto_type(type), enabled, (void(*)(void))_impl)
#define corto_observer__set(_this, mask, observable, instance, dispatcher, type, enabled, _impl) _this = _this ? _this : (corto_observer*)corto_ptr_new(corto_observer_o); _corto_observer__assign(corto_observer(_this), mask, observable, instance, corto_dispatcher(dispatcher), corto_type(type), enabled, (void(*)(void))_impl)
...
#define corto_observerEvent__assign(_this, observer, instance, source, event, data, thread) _corto_observerEvent__assign(corto_observerEvent(_this), corto_observer(observer), instance, source, event, data, thread)
#define corto_observerEvent__set(_this, observer, instance, source, event, data, thread) _this = _this ? _this : (corto_observerEvent*)corto_ptr_new(corto_observerEvent_o); _corto_observerEvent__assign(corto_observerEvent(_this), corto_observer(observer), instance, source, event, data, thread)
...
#define corto_operatorKind__assign(_this, value) _corto_operatorKind__assign(corto_operatorKind(_this), value)
#define corto_operatorKind__set(_this, value) _this = _this ? _this : (corto_operatorKind*)corto_ptr_new(corto_operatorKind_o); _corto_operatorKind__assign(corto_operatorKind(_this), value)
...
#define corto_ownership__assign(_this, value) _corto_ownership__assign(corto_ownership(_this), value)
#define corto_ownership__set(_this, value) _this = _this ? _this : (corto_ownership*)corto_ptr_new(corto_ownership_o); _corto_ownership__assign(corto_ownership(_this), value)
...
#define corto_query__assign(_this, select, from, type, member, where, offset, limit, soffset, slimit, timeBegin, timeEnd) _corto_query__assign(corto_query(_this), select, from, type, member, where, offset, limit, soffset, slimit, timeBegin, timeEnd)
#define corto_query__set(_this, select, from, type, member, where, offset, limit, soffset, slimit, timeBegin, timeEnd) _this = _this ? _this : (corto_query*)corto_ptr_new(corto_query_o); _corto_query__assign(corto_query(_this), select, from, type, member, where, offset, limit, soffset, slimit, timeBegin, timeEnd)
...
#define corto_queuePolicy__assign(_this, max) _corto_queuePolicy__assign(corto_queuePolicy(_this), max)
#define corto_queuePolicy__set(_this, max) _this = _this ? _this : (corto_queuePolicy*)corto_ptr_new(corto_queuePolicy_o); _corto_queuePolicy__assign(corto_queuePolicy(_this), max)
...
#define corto_remote__assign(_this, returnType, returnsReference, _impl) _corto_remote__assign(corto_remote(_this), corto_type(returnType), returnsReference, (void(*)(void))_impl)
#define corto_remote__set(_this, returnType, returnsReference, _impl) _this = _this ? _this : (corto_remote*)corto_ptr_new(corto_remote_o); _corto_remote__assign(corto_remote(_this), corto_type(returnType), returnsReference, (void(*)(void))_impl)
...
#define corto_result__assign(_this, id, name, parent, type, value, flags) _corto_result__assign(corto_result(_this), id, name, parent, type, value, flags)
#define corto_result__set(_this, id, name, parent, type, value, flags) _this = _this ? _this : (corto_result*)corto_ptr_new(corto_result_o); _corto_result__assign(corto_result(_this), id, name, parent, type, value, flags)
...
#define corto_resultIter__assign(_this) _corto_resultIter__assign(corto_resultIter(_this))
#define corto_resultIter__set(_this) _this = _this ? _this : (corto_resultIter*)corto_ptr_new(corto_resultIter_o); _corto_resultIter__assign(corto_resultIter(_this))
...
#define corto_resultList__assign(_this, length, elements) _corto_resultList__assign(corto_resultList(_this), length, elements)
#define corto_resultList__set(_this, length, elements) _this = _this ? _this : (corto_resultList*)corto_ptr_new(corto_resultList_o); _corto_resultList__assign(corto_resultList(_this), length, elements)
...
#define corto_resultMask__assign(_this, value) _corto_resultMask__assign(corto_resultMask(_this), value)
#define corto_resultMask__set(_this, value) _this = _this ? _this : (corto_resultMask*)corto_ptr_new(corto_resultMask_o); _corto_resultMask__assign(corto_resultMask(_this), value)
...
#define corto_route__assign(_this, pattern, _impl) _corto_route__assign(corto_route(_this), pattern, (void(*)(void))_impl)
#define corto_route__set(_this, pattern, _impl) _this = _this ? _this : (corto_route*)corto_ptr_new(corto_route_o); _corto_route__assign(corto_route(_this), pattern, (void(*)(void))_impl)
...
#define corto_router__assign(_this, returnType, paramType, paramName, routerDataType, routerDataName, elementSeparator) _corto_router__assign(corto_router(_this), corto_type(returnType), corto_type(paramType), paramName, corto_type(routerDataType), routerDataName, elementSeparator)
#define corto_router__set(_this, returnType, paramType, paramName, routerDataType, routerDataName, elementSeparator) _this = _this ? _this : (corto_router*)corto_ptr_new(corto_router_o); _corto_router__assign(corto_router(_this), corto_type(returnType), corto_type(paramType), paramName, corto_type(routerDataType), routerDataName, elementSeparator)
...
#define corto_routerimpl__assign(_this, base, baseAccess, implements) _corto_routerimpl__assign(corto_routerimpl(_this), corto_interface(base), baseAccess, implements)
#define corto_routerimpl__set(_this, base, baseAccess, implements) _this = _this ? _this : (corto_routerimpl*)corto_ptr_new(corto_routerimpl_o); _corto_routerimpl__assign(corto_routerimpl(_this), corto_interface(base), baseAccess, implements)
...
#define corto_sample__assign(_this, timestamp, value) _corto_sample__assign(corto_sample(_this), timestamp, value)
#define corto_sample__set(_this, timestamp, value) _this = _this ? _this : (corto_sample*)corto_ptr_new(corto_sample_o); _corto_sample__assign(corto_sample(_this), timestamp, value)
...
#define corto_sampleIter__assign(_this) _corto_sampleIter__assign(corto_sampleIter(_this))
#define corto_sampleIter__set(_this) _this = _this ? _this : (corto_sampleIter*)corto_ptr_new(corto_sampleIter_o); _corto_sampleIter__assign(corto_sampleIter(_this))
...
#define corto_subscriber__assign(_this, query, contentType, instance, dispatcher, enabled, _impl) _corto_subscriber__assign(corto_subscriber(_this), query, contentType, instance, corto_dispatcher(dispatcher), enabled, (void(*)(void))_impl)
#define corto_subscriber__set(_this, query, contentType, instance, dispatcher, enabled, _impl) _this = _this ? _this : (corto_subscriber*)corto_ptr_new(corto_subscriber_o); _corto_subscriber__assign(corto_subscriber(_this), query, contentType, instance, corto_dispatcher(dispatcher), enabled, (void(*)(void))_impl)
...
#define corto_subscriberEvent__assign(_this, subscriber, instance, source, event, data, contentTypeHandle) _corto_subscriberEvent__assign(corto_subscriberEvent(_this), corto_subscriber(subscriber), instance, source, event, data, contentTypeHandle)
#define corto_subscriberEvent__set(_this, subscriber, instance, source, event, data, contentTypeHandle) _this = _this ? _this : (corto_subscriberEvent*)corto_ptr_new(corto_subscriberEvent_o); _corto_subscriberEvent__assign(corto_subscriberEvent(_this), corto_subscriber(subscriber), instance, source, event, data, contentTypeHandle)
...
#define corto_subscriberEventIter__assign(_this) _corto_subscriberEventIter__assign(corto_subscriberEventIter(_this))
#define corto_subscriberEventIter__set(_this) _this = _this ? _this : (corto_subscriberEventIter*)corto_ptr_new(corto_subscriberEventIter_o); _corto_subscriberEventIter__assign(corto_subscriberEventIter(_this))
...
#define corto_time__assign(_this, sec, nanosec) _corto_time__assign(corto_time(_this), sec, nanosec)
#define corto_time__set(_this, sec, nanosec) _this = _this ? _this : (corto_time*)corto_ptr_new(corto_time_o); _corto_time__assign(corto_time(_this), sec, nanosec)
...
CORTO_EXPORT void corto_mountSubscriptionList_clear(corto_mountSubscriptionList list);
...
CORTO_EXPORT void corto_resultList_clear(corto_resultList list);
