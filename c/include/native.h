...
#endif
/* /corto/native/type */
CORTO_EXPORT corto_native_type _corto_native_typeCreate(const char * name);
...
CORTO_EXPORT corto_native_type _corto_native_typeCreateChild(corto_object _parent, const char *_id, const char * name);
...
CORTO_EXPORT corto_int16 _corto_native_typeUpdate(corto_native_type _this, const char * name);
...
CORTO_EXPORT corto_native_type _corto_native_typeDeclareChild(corto_object _parent, const char *_id);
...
CORTO_EXPORT corto_int16 _corto_native_typeDefine(corto_native_type _this, const char * name);
#define corto_native_typeDefine(_this, name) _corto_native_typeDefine(corto_native_type(_this), name)
CORTO_EXPORT corto_native_type _corto_native_typeAssign(corto_native_type _this, const char * name);
#define corto_native_type__optional_NotSet NULL
#define corto_native_type__optional_Set(name) (corto_native_type*)corto_native_typeAssign((corto_native_type*)corto_ptr_new(corto_native_type_o), name)
#define corto_native_type__optional_SetCond(cond, name) cond ? (corto_native_type*)corto_native_typeAssign((corto_native_type*)corto_ptr_new(corto_native_type_o), name) : NULL
