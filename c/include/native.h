...
/* /corto/native/type */
CORTO_EXPORT corto_native_type _corto_native_type__create(corto_object _parent, const char *_id, const char * name, bool is_ptr);
...
CORTO_EXPORT corto_int16 _corto_native_type__update(corto_native_type _this, const char * name, bool is_ptr);
#define corto_native_type__update(_this, name, is_ptr) _corto_native_type__update(corto_native_type(_this), name, is_ptr)
CORTO_EXPORT corto_native_type _corto_native_type__assign(corto_native_type _this, const char * name, bool is_ptr);
