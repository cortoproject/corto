...
#define corto_native_type__optional_set_cond(__cond, name) __cond ? (corto_native_type*)corto_native_type__assign((corto_native_type*)corto_ptr_new(corto_native_type_o), name) : NULL
