...
/* alias */
CORTO_C_EXPORT corto_alias _corto_alias__create(corto_object _parent, const char *_id, corto_member member);
...
CORTO_C_EXPORT corto_int16 _corto_alias__update(corto_alias _this, corto_member member);
#define corto_alias__update(_this, member) _corto_alias__update(corto_alias(_this), corto_member(member))
CORTO_C_EXPORT corto_alias _corto_alias__assign(corto_alias _this, corto_member member);
...
/* any */
CORTO_C_EXPORT corto_any* _corto_any__create(corto_object _parent, const char *_id, corto_type type, void *value);
...
CORTO_C_EXPORT corto_int16 _corto_any__update(corto_any* _this, corto_type type, void *value);
#define corto_any__update(_this, type, value) _corto_any__update(corto_any(_this), corto_type(type), value)
CORTO_C_EXPORT corto_any* _corto_any__assign(corto_any* _this, corto_type type, void *value);
...
/* application */
CORTO_C_EXPORT corto_application _corto_application__create(corto_object _parent, const char *_id);
...
CORTO_C_EXPORT corto_int16 _corto_application__update(corto_application _this);
#define corto_application__update(_this) _corto_application__update(corto_application(_this))
CORTO_C_EXPORT corto_application _corto_application__assign(corto_application _this);
...
/* array */
CORTO_C_EXPORT corto_array _corto_array__create(corto_object _parent, const char *_id, corto_type element_type, uint32_t max);
...
CORTO_C_EXPORT corto_int16 _corto_array__update(corto_array _this, corto_type element_type, uint32_t max);
#define corto_array__update(_this, element_type, max) _corto_array__update(corto_array(_this), corto_type(element_type), max)
CORTO_C_EXPORT corto_array _corto_array__assign(corto_array _this, corto_type element_type, uint32_t max);
...
/* attr */
CORTO_C_EXPORT corto_attr* _corto_attr__create(corto_object _parent, const char *_id, corto_attr value);
...
CORTO_C_EXPORT corto_int16 _corto_attr__update(corto_attr* _this, corto_attr value);
#define corto_attr__update(_this, value) _corto_attr__update(corto_attr(_this), value)
CORTO_C_EXPORT corto_attr* _corto_attr__assign(corto_attr* _this, corto_attr value);
...
/* binary */
CORTO_C_EXPORT corto_binary _corto_binary__create(corto_object _parent, const char *_id, corto_width width);
...
CORTO_C_EXPORT corto_int16 _corto_binary__update(corto_binary _this, corto_width width);
#define corto_binary__update(_this, width) _corto_binary__update(corto_binary(_this), width)
CORTO_C_EXPORT corto_binary _corto_binary__assign(corto_binary _this, corto_width width);
...
/* bitmask */
CORTO_C_EXPORT corto_bitmask _corto_bitmask__create(corto_object _parent, const char *_id);
...
CORTO_C_EXPORT corto_int16 _corto_bitmask__update(corto_bitmask _this);
#define corto_bitmask__update(_this) _corto_bitmask__update(corto_bitmask(_this))
CORTO_C_EXPORT corto_bitmask _corto_bitmask__assign(corto_bitmask _this);
...
/* bool */
CORTO_C_EXPORT bool* _corto_bool__create(corto_object _parent, const char *_id, bool value);
...
CORTO_C_EXPORT corto_int16 _corto_bool__update(bool* _this, bool value);
#define corto_bool__update(_this, value) _corto_bool__update(corto_bool(_this), value)
CORTO_C_EXPORT bool* _corto_bool__assign(bool* _this, bool value);
...
/* boolean */
CORTO_C_EXPORT corto_boolean _corto_boolean__create(corto_object _parent, const char *_id);
...
CORTO_C_EXPORT corto_int16 _corto_boolean__update(corto_boolean _this);
#define corto_boolean__update(_this) _corto_boolean__update(corto_boolean(_this))
CORTO_C_EXPORT corto_boolean _corto_boolean__assign(corto_boolean _this);
...
/* case */
CORTO_C_EXPORT corto_case _corto_case__create(corto_object _parent, const char *_id, corto_int32seq discriminator, corto_type type, corto_modifierMask modifiers);
...
CORTO_C_EXPORT corto_int16 _corto_case__update(corto_case _this, corto_int32seq discriminator, corto_type type, corto_modifierMask modifiers);
...
CORTO_C_EXPORT corto_case _corto_case__assign(corto_case _this, corto_int32seq discriminator, corto_type type, corto_modifierMask modifiers);
...
/* char */
CORTO_C_EXPORT char* _corto_char__create(corto_object _parent, const char *_id, char value);
...
CORTO_C_EXPORT corto_int16 _corto_char__update(char* _this, char value);
#define corto_char__update(_this, value) _corto_char__update(corto_char(_this), value)
CORTO_C_EXPORT char* _corto_char__assign(char* _this, char value);
...
/* character */
CORTO_C_EXPORT corto_character _corto_character__create(corto_object _parent, const char *_id, corto_width width);
...
CORTO_C_EXPORT corto_int16 _corto_character__update(corto_character _this, corto_width width);
#define corto_character__update(_this, width) _corto_character__update(corto_character(_this), width)
CORTO_C_EXPORT corto_character _corto_character__assign(corto_character _this, corto_width width);
...
/* class */
CORTO_C_EXPORT corto_class _corto_class__create(corto_object _parent, const char *_id, corto_interface base, corto_modifierMask base_modifiers, corto_interfaceseq implements);
...
CORTO_C_EXPORT corto_int16 _corto_class__update(corto_class _this, corto_interface base, corto_modifierMask base_modifiers, corto_interfaceseq implements);
...
CORTO_C_EXPORT corto_class _corto_class__assign(corto_class _this, corto_interface base, corto_modifierMask base_modifiers, corto_interfaceseq implements);
...
/* collection */
CORTO_C_EXPORT corto_collection _corto_collection__create(corto_object _parent, const char *_id, corto_type element_type, uint32_t max);
...
CORTO_C_EXPORT corto_int16 _corto_collection__update(corto_collection _this, corto_type element_type, uint32_t max);
...
CORTO_C_EXPORT corto_collection _corto_collection__assign(corto_collection _this, corto_type element_type, uint32_t max);
...
/* collectionKind */
CORTO_C_EXPORT corto_collectionKind* _corto_collectionKind__create(corto_object _parent, const char *_id, corto_collectionKind value);
...
CORTO_C_EXPORT corto_int16 _corto_collectionKind__update(corto_collectionKind* _this, corto_collectionKind value);
#define corto_collectionKind__update(_this, value) _corto_collectionKind__update(corto_collectionKind(_this), value)
CORTO_C_EXPORT corto_collectionKind* _corto_collectionKind__assign(corto_collectionKind* _this, corto_collectionKind value);
...
/* compositeKind */
CORTO_C_EXPORT corto_compositeKind* _corto_compositeKind__create(corto_object _parent, const char *_id, corto_compositeKind value);
...
CORTO_C_EXPORT corto_int16 _corto_compositeKind__update(corto_compositeKind* _this, corto_compositeKind value);
#define corto_compositeKind__update(_this, value) _corto_compositeKind__update(corto_compositeKind(_this), value)
CORTO_C_EXPORT corto_compositeKind* _corto_compositeKind__assign(corto_compositeKind* _this, corto_compositeKind value);
...
/* constant */
CORTO_C_EXPORT int32_t* _corto_constant__create(corto_object _parent, const char *_id, int32_t value);
...
CORTO_C_EXPORT corto_int16 _corto_constant__update(int32_t* _this, int32_t value);
#define corto_constant__update(_this, value) _corto_constant__update(corto_constant(_this), value)
CORTO_C_EXPORT int32_t* _corto_constant__assign(int32_t* _this, int32_t value);
...
/* container */
CORTO_C_EXPORT corto_container _corto_container__create(corto_object _parent, const char *_id, corto_interface base, corto_modifierMask base_modifiers, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_C_EXPORT corto_int16 _corto_container__update(corto_container _this, corto_interface base, corto_modifierMask base_modifiers, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_C_EXPORT corto_container _corto_container__assign(corto_container _this, corto_interface base, corto_modifierMask base_modifiers, corto_interfaceseq implements, corto_type type, const char * value);
...
/* default */
CORTO_C_EXPORT corto_default _corto_default__create(corto_object _parent, const char *_id, corto_type type);
...
CORTO_C_EXPORT corto_int16 _corto_default__update(corto_default _this, corto_type type);
#define corto_default__update(_this, type) _corto_default__update(corto_default(_this), corto_type(type))
CORTO_C_EXPORT corto_default _corto_default__assign(corto_default _this, corto_type type);
...
/* delegate */
CORTO_C_EXPORT corto_delegate _corto_delegate__create(corto_object _parent, const char *_id, corto_type return_type, bool is_reference, corto_parameterseq parameters);
...
CORTO_C_EXPORT corto_int16 _corto_delegate__update(corto_delegate _this, corto_type return_type, bool is_reference, corto_parameterseq parameters);
...
CORTO_C_EXPORT corto_delegate _corto_delegate__assign(corto_delegate _this, corto_type return_type, bool is_reference, corto_parameterseq parameters);
...
/* delegatedata */
CORTO_C_EXPORT corto_delegatedata* _corto_delegatedata__create(corto_object _parent, const char *_id, corto_object instance, corto_function procedure);
...
CORTO_C_EXPORT corto_int16 _corto_delegatedata__update(corto_delegatedata* _this, corto_object instance, corto_function procedure);
...
CORTO_C_EXPORT corto_delegatedata* _corto_delegatedata__assign(corto_delegatedata* _this, corto_object instance, corto_function procedure);
...
/* enum */
CORTO_C_EXPORT corto_enum _corto_enum__create(corto_object _parent, const char *_id);
...
CORTO_C_EXPORT corto_int16 _corto_enum__update(corto_enum _this);
#define corto_enum__update(_this) _corto_enum__update(corto_enum(_this))
CORTO_C_EXPORT corto_enum _corto_enum__assign(corto_enum _this);
...
/* equalityKind */
CORTO_C_EXPORT corto_equalityKind* _corto_equalityKind__create(corto_object _parent, const char *_id, corto_equalityKind value);
...
CORTO_C_EXPORT corto_int16 _corto_equalityKind__update(corto_equalityKind* _this, corto_equalityKind value);
#define corto_equalityKind__update(_this, value) _corto_equalityKind__update(corto_equalityKind(_this), value)
CORTO_C_EXPORT corto_equalityKind* _corto_equalityKind__assign(corto_equalityKind* _this, corto_equalityKind value);
...
/* float */
CORTO_C_EXPORT corto_float _corto_float__create(corto_object _parent, const char *_id, corto_width width, double min, double max);
...
CORTO_C_EXPORT corto_int16 _corto_float__update(corto_float _this, corto_width width, double min, double max);
#define corto_float__update(_this, width, min, max) _corto_float__update(corto_float(_this), width, min, max)
CORTO_C_EXPORT corto_float _corto_float__assign(corto_float _this, corto_width width, double min, double max);
...
/* float32 */
CORTO_C_EXPORT float* _corto_float32__create(corto_object _parent, const char *_id, float value);
...
CORTO_C_EXPORT corto_int16 _corto_float32__update(float* _this, float value);
#define corto_float32__update(_this, value) _corto_float32__update(corto_float32(_this), value)
CORTO_C_EXPORT float* _corto_float32__assign(float* _this, float value);
...
/* float64 */
CORTO_C_EXPORT double* _corto_float64__create(corto_object _parent, const char *_id, double value);
...
CORTO_C_EXPORT corto_int16 _corto_float64__update(double* _this, double value);
#define corto_float64__update(_this, value) _corto_float64__update(corto_float64(_this), value)
CORTO_C_EXPORT double* _corto_float64__assign(double* _this, double value);
...
/* function */
CORTO_C_EXPORT corto_function _corto_function__create(corto_object _parent, const char *_id, corto_type return_type, bool is_reference, void(*_impl)(void));
...
CORTO_C_EXPORT corto_int16 _corto_function__update(corto_function _this, corto_type return_type, bool is_reference, void(*_impl)(void));
...
CORTO_C_EXPORT corto_function _corto_function__assign(corto_function _this, corto_type return_type, bool is_reference, void(*_impl)(void));
...
/* inout */
CORTO_C_EXPORT corto_inout* _corto_inout__create(corto_object _parent, const char *_id, corto_inout value);
...
CORTO_C_EXPORT corto_int16 _corto_inout__update(corto_inout* _this, corto_inout value);
#define corto_inout__update(_this, value) _corto_inout__update(corto_inout(_this), value)
CORTO_C_EXPORT corto_inout* _corto_inout__assign(corto_inout* _this, corto_inout value);
...
/* int */
CORTO_C_EXPORT corto_int _corto_int__create(corto_object _parent, const char *_id, corto_width width, int64_t min, int64_t max);
...
CORTO_C_EXPORT corto_int16 _corto_int__update(corto_int _this, corto_width width, int64_t min, int64_t max);
#define corto_int__update(_this, width, min, max) _corto_int__update(corto_int(_this), width, min, max)
CORTO_C_EXPORT corto_int _corto_int__assign(corto_int _this, corto_width width, int64_t min, int64_t max);
...
/* int16 */
CORTO_C_EXPORT int16_t* _corto_int16__create(corto_object _parent, const char *_id, int16_t value);
...
CORTO_C_EXPORT corto_int16 _corto_int16__update(int16_t* _this, int16_t value);
#define corto_int16__update(_this, value) _corto_int16__update(corto_int16(_this), value)
CORTO_C_EXPORT int16_t* _corto_int16__assign(int16_t* _this, int16_t value);
...
/* int32 */
CORTO_C_EXPORT int32_t* _corto_int32__create(corto_object _parent, const char *_id, int32_t value);
...
CORTO_C_EXPORT corto_int16 _corto_int32__update(int32_t* _this, int32_t value);
#define corto_int32__update(_this, value) _corto_int32__update(corto_int32(_this), value)
CORTO_C_EXPORT int32_t* _corto_int32__assign(int32_t* _this, int32_t value);
...
/* int32seq */
CORTO_C_EXPORT corto_int32seq* _corto_int32seq__create(corto_object _parent, const char *_id, corto_uint32 length, int32_t* elements);
...
CORTO_C_EXPORT corto_int16 _corto_int32seq__update(corto_int32seq* _this, corto_uint32 length, int32_t* elements);
#define corto_int32seq__update(_this, length, elements) _corto_int32seq__update(corto_int32seq(_this), length, elements)
CORTO_C_EXPORT corto_int32seq* _corto_int32seq__assign(corto_int32seq* _this, corto_uint32 length, int32_t* elements);
...
/* int64 */
CORTO_C_EXPORT int64_t* _corto_int64__create(corto_object _parent, const char *_id, int64_t value);
...
CORTO_C_EXPORT corto_int16 _corto_int64__update(int64_t* _this, int64_t value);
#define corto_int64__update(_this, value) _corto_int64__update(corto_int64(_this), value)
CORTO_C_EXPORT int64_t* _corto_int64__assign(int64_t* _this, int64_t value);
...
/* int8 */
CORTO_C_EXPORT int8_t* _corto_int8__create(corto_object _parent, const char *_id, int8_t value);
...
CORTO_C_EXPORT corto_int16 _corto_int8__update(int8_t* _this, int8_t value);
#define corto_int8__update(_this, value) _corto_int8__update(corto_int8(_this), value)
CORTO_C_EXPORT int8_t* _corto_int8__assign(int8_t* _this, int8_t value);
...
/* interface */
CORTO_C_EXPORT corto_interface _corto_interface__create(corto_object _parent, const char *_id, corto_interface base);
...
CORTO_C_EXPORT corto_int16 _corto_interface__update(corto_interface _this, corto_interface base);
#define corto_interface__update(_this, base) _corto_interface__update(corto_interface(_this), corto_interface(base))
CORTO_C_EXPORT corto_interface _corto_interface__assign(corto_interface _this, corto_interface base);
...
/* interfaceseq */
CORTO_C_EXPORT corto_interfaceseq* _corto_interfaceseq__create(corto_object _parent, const char *_id, corto_uint32 length, corto_interface* elements);
...
CORTO_C_EXPORT corto_int16 _corto_interfaceseq__update(corto_interfaceseq* _this, corto_uint32 length, corto_interface* elements);
...
CORTO_C_EXPORT corto_interfaceseq* _corto_interfaceseq__assign(corto_interfaceseq* _this, corto_uint32 length, corto_interface* elements);
...
/* interfaceVector */
CORTO_C_EXPORT corto_interfaceVector* _corto_interfaceVector__create(corto_object _parent, const char *_id, corto_interface interface, corto_objectseq vector);
...
CORTO_C_EXPORT corto_int16 _corto_interfaceVector__update(corto_interfaceVector* _this, corto_interface interface, corto_objectseq vector);
...
CORTO_C_EXPORT corto_interfaceVector* _corto_interfaceVector__assign(corto_interfaceVector* _this, corto_interface interface, corto_objectseq vector);
...
/* interfaceVectorseq */
CORTO_C_EXPORT corto_interfaceVectorseq* _corto_interfaceVectorseq__create(corto_object _parent, const char *_id, corto_uint32 length, corto_interfaceVector* elements);
...
CORTO_C_EXPORT corto_int16 _corto_interfaceVectorseq__update(corto_interfaceVectorseq* _this, corto_uint32 length, corto_interfaceVector* elements);
...
CORTO_C_EXPORT corto_interfaceVectorseq* _corto_interfaceVectorseq__assign(corto_interfaceVectorseq* _this, corto_uint32 length, corto_interfaceVector* elements);
...
/* iterator */
CORTO_C_EXPORT corto_iterator _corto_iterator__create(corto_object _parent, const char *_id, corto_type element_type);
...
CORTO_C_EXPORT corto_int16 _corto_iterator__update(corto_iterator _this, corto_type element_type);
#define corto_iterator__update(_this, element_type) _corto_iterator__update(corto_iterator(_this), corto_type(element_type))
CORTO_C_EXPORT corto_iterator _corto_iterator__assign(corto_iterator _this, corto_type element_type);
...
/* leaf */
CORTO_C_EXPORT corto_leaf _corto_leaf__create(corto_object _parent, const char *_id, corto_interface base, corto_modifierMask base_modifiers, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_C_EXPORT corto_int16 _corto_leaf__update(corto_leaf _this, corto_interface base, corto_modifierMask base_modifiers, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_C_EXPORT corto_leaf _corto_leaf__assign(corto_leaf _this, corto_interface base, corto_modifierMask base_modifiers, corto_interfaceseq implements, corto_type type, const char * value);
...
/* list */
CORTO_C_EXPORT corto_list _corto_list__create(corto_object _parent, const char *_id, corto_type element_type, uint32_t max);
...
CORTO_C_EXPORT corto_int16 _corto_list__update(corto_list _this, corto_type element_type, uint32_t max);
#define corto_list__update(_this, element_type, max) _corto_list__update(corto_list(_this), corto_type(element_type), max)
CORTO_C_EXPORT corto_list _corto_list__assign(corto_list _this, corto_type element_type, uint32_t max);
...
/* map */
CORTO_C_EXPORT corto_map _corto_map__create(corto_object _parent, const char *_id, corto_type key_type, corto_type element_type, uint32_t max);
...
CORTO_C_EXPORT corto_int16 _corto_map__update(corto_map _this, corto_type key_type, corto_type element_type, uint32_t max);
...
CORTO_C_EXPORT corto_map _corto_map__assign(corto_map _this, corto_type key_type, corto_type element_type, uint32_t max);
...
/* member */
CORTO_C_EXPORT corto_member _corto_member__create(corto_object _parent, const char *_id, corto_type type, corto_modifierMask modifiers);
...
CORTO_C_EXPORT corto_int16 _corto_member__update(corto_member _this, corto_type type, corto_modifierMask modifiers);
#define corto_member__update(_this, type, modifiers) _corto_member__update(corto_member(_this), corto_type(type), modifiers)
CORTO_C_EXPORT corto_member _corto_member__assign(corto_member _this, corto_type type, corto_modifierMask modifiers);
...
/* metaprocedure */
CORTO_C_EXPORT corto_metaprocedure _corto_metaprocedure__create(corto_object _parent, const char *_id, corto_type return_type, bool is_reference, bool referenceOnly, void(*_impl)(void));
...
CORTO_C_EXPORT corto_int16 _corto_metaprocedure__update(corto_metaprocedure _this, corto_type return_type, bool is_reference, bool referenceOnly, void(*_impl)(void));
...
CORTO_C_EXPORT corto_metaprocedure _corto_metaprocedure__assign(corto_metaprocedure _this, corto_type return_type, bool is_reference, bool referenceOnly, void(*_impl)(void));
...
/* method */
CORTO_C_EXPORT corto_method _corto_method__create(corto_object _parent, const char *_id, corto_type return_type, bool is_reference, void(*_impl)(void));
...
CORTO_C_EXPORT corto_int16 _corto_method__update(corto_method _this, corto_type return_type, bool is_reference, void(*_impl)(void));
...
CORTO_C_EXPORT corto_method _corto_method__assign(corto_method _this, corto_type return_type, bool is_reference, void(*_impl)(void));
...
/* modifierMask */
CORTO_C_EXPORT corto_modifierMask* _corto_modifierMask__create(corto_object _parent, const char *_id, corto_modifierMask value);
...
CORTO_C_EXPORT corto_int16 _corto_modifierMask__update(corto_modifierMask* _this, corto_modifierMask value);
#define corto_modifierMask__update(_this, value) _corto_modifierMask__update(corto_modifierMask(_this), value)
CORTO_C_EXPORT corto_modifierMask* _corto_modifierMask__assign(corto_modifierMask* _this, corto_modifierMask value);
...
/* name_action */
CORTO_C_EXPORT corto_name_action* _corto_name_action__create(corto_object _parent, const char *_id, corto_object instance, corto_function procedure);
...
CORTO_C_EXPORT corto_int16 _corto_name_action__update(corto_name_action* _this, corto_object instance, corto_function procedure);
...
CORTO_C_EXPORT corto_name_action* _corto_name_action__assign(corto_name_action* _this, corto_object instance, corto_function procedure);
...
CORTO_C_EXPORT corto_int16 corto_name_action__init_c(corto_name_action *d, corto_string ___ (*callback)(void));
...
CORTO_C_EXPORT corto_int16 corto_name_action_init_c_instance(corto_name_action *d, corto_object instance, corto_string ___ (*callback)(corto_object));

/* object */
CORTO_C_EXPORT corto_object _corto_object__create(corto_object _parent, const char *_id, corto_object value);
...
CORTO_C_EXPORT corto_int16 _corto_object__update(corto_object _this, corto_object value);
#define corto_object__update(_this, value) _corto_object__update(corto_object(_this), value)
CORTO_C_EXPORT corto_object _corto_object__assign(corto_object _this, corto_object value);
...
/* objectlist */
CORTO_C_EXPORT corto_objectlist* _corto_objectlist__create(corto_object _parent, const char *_id, corto_uint32 length, corto_object* elements);
...
CORTO_C_EXPORT corto_int16 _corto_objectlist__update(corto_objectlist* _this, corto_uint32 length, corto_object* elements);
#define corto_objectlist__update(_this, length, elements) _corto_objectlist__update(corto_objectlist(_this), length, elements)
CORTO_C_EXPORT corto_objectlist* _corto_objectlist__assign(corto_objectlist* _this, corto_uint32 length, corto_object* elements);
...
/* objectseq */
CORTO_C_EXPORT corto_objectseq* _corto_objectseq__create(corto_object _parent, const char *_id, corto_uint32 length, corto_object* elements);
...
CORTO_C_EXPORT corto_int16 _corto_objectseq__update(corto_objectseq* _this, corto_uint32 length, corto_object* elements);
#define corto_objectseq__update(_this, length, elements) _corto_objectseq__update(corto_objectseq(_this), length, elements)
CORTO_C_EXPORT corto_objectseq* _corto_objectseq__assign(corto_objectseq* _this, corto_uint32 length, corto_object* elements);
...
/* octet */
CORTO_C_EXPORT uint8_t* _corto_octet__create(corto_object _parent, const char *_id, uint8_t value);
...
CORTO_C_EXPORT corto_int16 _corto_octet__update(uint8_t* _this, uint8_t value);
#define corto_octet__update(_this, value) _corto_octet__update(corto_octet(_this), value)
CORTO_C_EXPORT uint8_t* _corto_octet__assign(uint8_t* _this, uint8_t value);
...
/* overridable */
CORTO_C_EXPORT corto_overridable _corto_overridable__create(corto_object _parent, const char *_id, corto_type return_type, bool is_reference, void(*_impl)(void));
...
CORTO_C_EXPORT corto_int16 _corto_overridable__update(corto_overridable _this, corto_type return_type, bool is_reference, void(*_impl)(void));
...
CORTO_C_EXPORT corto_overridable _corto_overridable__assign(corto_overridable _this, corto_type return_type, bool is_reference, void(*_impl)(void));
...
/* override */
CORTO_C_EXPORT corto_override _corto_override__create(corto_object _parent, const char *_id, corto_type return_type, bool is_reference, void(*_impl)(void));
...
CORTO_C_EXPORT corto_int16 _corto_override__update(corto_override _this, corto_type return_type, bool is_reference, void(*_impl)(void));
...
CORTO_C_EXPORT corto_override _corto_override__assign(corto_override _this, corto_type return_type, bool is_reference, void(*_impl)(void));
...
/* package */
CORTO_C_EXPORT corto_package _corto_package__create(corto_object _parent, const char *_id);
...
CORTO_C_EXPORT corto_int16 _corto_package__update(corto_package _this);
#define corto_package__update(_this) _corto_package__update(corto_package(_this))
CORTO_C_EXPORT corto_package _corto_package__assign(corto_package _this);
...
/* parameter */
CORTO_C_EXPORT corto_parameter* _corto_parameter__create(corto_object _parent, const char *_id, const char * name, corto_type type, corto_inout inout, bool is_reference);
...
CORTO_C_EXPORT corto_int16 _corto_parameter__update(corto_parameter* _this, const char * name, corto_type type, corto_inout inout, bool is_reference);
...
CORTO_C_EXPORT corto_parameter* _corto_parameter__assign(corto_parameter* _this, const char * name, corto_type type, corto_inout inout, bool is_reference);
...
/* parameterseq */
CORTO_C_EXPORT corto_parameterseq* _corto_parameterseq__create(corto_object _parent, const char *_id, corto_uint32 length, corto_parameter* elements);
...
CORTO_C_EXPORT corto_int16 _corto_parameterseq__update(corto_parameterseq* _this, corto_uint32 length, corto_parameter* elements);
...
CORTO_C_EXPORT corto_parameterseq* _corto_parameterseq__assign(corto_parameterseq* _this, corto_uint32 length, corto_parameter* elements);
...
/* post_action */
CORTO_C_EXPORT corto_post_action* _corto_post_action__create(corto_object _parent, const char *_id, corto_object instance, corto_function procedure);
...
CORTO_C_EXPORT corto_int16 _corto_post_action__update(corto_post_action* _this, corto_object instance, corto_function procedure);
...
CORTO_C_EXPORT corto_post_action* _corto_post_action__assign(corto_post_action* _this, corto_object instance, corto_function procedure);
...
CORTO_C_EXPORT corto_int16 corto_post_action__init_c(corto_post_action *d, corto_void ___ (*callback)(void));
...
CORTO_C_EXPORT corto_int16 corto_post_action_init_c_instance(corto_post_action *d, corto_object instance, corto_void ___ (*callback)(corto_object));

/* pre_action */
CORTO_C_EXPORT corto_pre_action* _corto_pre_action__create(corto_object _parent, const char *_id, corto_object instance, corto_function procedure);
...
CORTO_C_EXPORT corto_int16 _corto_pre_action__update(corto_pre_action* _this, corto_object instance, corto_function procedure);
...
CORTO_C_EXPORT corto_pre_action* _corto_pre_action__assign(corto_pre_action* _this, corto_object instance, corto_function procedure);
...
CORTO_C_EXPORT corto_int16 corto_pre_action__init_c(corto_pre_action *d, corto_int16 ___ (*callback)(void));
...
CORTO_C_EXPORT corto_int16 corto_pre_action_init_c_instance(corto_pre_action *d, corto_object instance, corto_int16 ___ (*callback)(corto_object));

/* primitive */
CORTO_C_EXPORT corto_primitive _corto_primitive__create(corto_object _parent, const char *_id, corto_width width);
...
CORTO_C_EXPORT corto_int16 _corto_primitive__update(corto_primitive _this, corto_width width);
#define corto_primitive__update(_this, width) _corto_primitive__update(corto_primitive(_this), width)
CORTO_C_EXPORT corto_primitive _corto_primitive__assign(corto_primitive _this, corto_width width);
...
/* primitiveKind */
CORTO_C_EXPORT corto_primitiveKind* _corto_primitiveKind__create(corto_object _parent, const char *_id, corto_primitiveKind value);
...
CORTO_C_EXPORT corto_int16 _corto_primitiveKind__update(corto_primitiveKind* _this, corto_primitiveKind value);
#define corto_primitiveKind__update(_this, value) _corto_primitiveKind__update(corto_primitiveKind(_this), value)
CORTO_C_EXPORT corto_primitiveKind* _corto_primitiveKind__assign(corto_primitiveKind* _this, corto_primitiveKind value);
...
/* procedure */
CORTO_C_EXPORT corto_procedure _corto_procedure__create(corto_object _parent, const char *_id, bool has_this, corto_type this_type);
...
CORTO_C_EXPORT corto_int16 _corto_procedure__update(corto_procedure _this, bool has_this, corto_type this_type);
...
CORTO_C_EXPORT corto_procedure _corto_procedure__assign(corto_procedure _this, bool has_this, corto_type this_type);
...
/* quantity */
CORTO_C_EXPORT corto_quantity _corto_quantity__create(corto_object _parent, const char *_id, corto_unit base_unit);
...
CORTO_C_EXPORT corto_int16 _corto_quantity__update(corto_quantity _this, corto_unit base_unit);
#define corto_quantity__update(_this, base_unit) _corto_quantity__update(corto_quantity(_this), corto_unit(base_unit))
CORTO_C_EXPORT corto_quantity _corto_quantity__assign(corto_quantity _this, corto_unit base_unit);
...
/* ref_kind */
CORTO_C_EXPORT corto_ref_kind* _corto_ref_kind__create(corto_object _parent, const char *_id, corto_ref_kind value);
...
CORTO_C_EXPORT corto_int16 _corto_ref_kind__update(corto_ref_kind* _this, corto_ref_kind value);
#define corto_ref_kind__update(_this, value) _corto_ref_kind__update(corto_ref_kind(_this), value)
CORTO_C_EXPORT corto_ref_kind* _corto_ref_kind__assign(corto_ref_kind* _this, corto_ref_kind value);
...
/* sequence */
CORTO_C_EXPORT corto_sequence _corto_sequence__create(corto_object _parent, const char *_id, corto_type element_type, uint32_t max);
...
CORTO_C_EXPORT corto_int16 _corto_sequence__update(corto_sequence _this, corto_type element_type, uint32_t max);
...
CORTO_C_EXPORT corto_sequence _corto_sequence__assign(corto_sequence _this, corto_type element_type, uint32_t max);
...
/* state */
CORTO_C_EXPORT corto_state* _corto_state__create(corto_object _parent, const char *_id, corto_state value);
...
CORTO_C_EXPORT corto_int16 _corto_state__update(corto_state* _this, corto_state value);
#define corto_state__update(_this, value) _corto_state__update(corto_state(_this), value)
CORTO_C_EXPORT corto_state* _corto_state__assign(corto_state* _this, corto_state value);
...
/* string */
CORTO_C_EXPORT corto_string* _corto_string__create(corto_object _parent, const char *_id, corto_string value);
...
CORTO_C_EXPORT corto_int16 _corto_string__update(corto_string* _this, corto_string value);
#define corto_string__update(_this, value) _corto_string__update(corto_string(_this), value)
CORTO_C_EXPORT corto_string* _corto_string__assign(corto_string* _this, corto_string value);
...
/* stringlist */
CORTO_C_EXPORT corto_stringlist* _corto_stringlist__create(corto_object _parent, const char *_id, corto_uint32 length, corto_string* elements);
...
CORTO_C_EXPORT corto_int16 _corto_stringlist__update(corto_stringlist* _this, corto_uint32 length, corto_string* elements);
#define corto_stringlist__update(_this, length, elements) _corto_stringlist__update(corto_stringlist(_this), length, elements)
CORTO_C_EXPORT corto_stringlist* _corto_stringlist__assign(corto_stringlist* _this, corto_uint32 length, corto_string* elements);
...
/* stringseq */
CORTO_C_EXPORT corto_stringseq* _corto_stringseq__create(corto_object _parent, const char *_id, corto_uint32 length, corto_string* elements);
...
CORTO_C_EXPORT corto_int16 _corto_stringseq__update(corto_stringseq* _this, corto_uint32 length, corto_string* elements);
#define corto_stringseq__update(_this, length, elements) _corto_stringseq__update(corto_stringseq(_this), length, elements)
CORTO_C_EXPORT corto_stringseq* _corto_stringseq__assign(corto_stringseq* _this, corto_uint32 length, corto_string* elements);
...
/* struct */
CORTO_C_EXPORT corto_struct _corto_struct__create(corto_object _parent, const char *_id, corto_interface base, corto_modifierMask base_modifiers);
...
CORTO_C_EXPORT corto_int16 _corto_struct__update(corto_struct _this, corto_interface base, corto_modifierMask base_modifiers);
...
CORTO_C_EXPORT corto_struct _corto_struct__assign(corto_struct _this, corto_interface base, corto_modifierMask base_modifiers);
...
/* table */
CORTO_C_EXPORT corto_table _corto_table__create(corto_object _parent, const char *_id, corto_interface base, corto_modifierMask base_modifiers, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_C_EXPORT corto_int16 _corto_table__update(corto_table _this, corto_interface base, corto_modifierMask base_modifiers, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_C_EXPORT corto_table _corto_table__assign(corto_table _this, corto_interface base, corto_modifierMask base_modifiers, corto_interfaceseq implements, corto_type type, const char * value);
...
/* tableinstance */
CORTO_C_EXPORT corto_tableinstance _corto_tableinstance__create(corto_object _parent, const char *_id, corto_type type);
...
CORTO_C_EXPORT corto_int16 _corto_tableinstance__update(corto_tableinstance _this, corto_type type);
#define corto_tableinstance__update(_this, type) _corto_tableinstance__update(corto_tableinstance(_this), corto_type(type))
CORTO_C_EXPORT corto_tableinstance _corto_tableinstance__assign(corto_tableinstance _this, corto_type type);
...
/* tag */
CORTO_C_EXPORT corto_tag _corto_tag__create(corto_object _parent, const char *_id);
...
CORTO_C_EXPORT corto_int16 _corto_tag__update(corto_tag _this);
#define corto_tag__update(_this) _corto_tag__update(corto_tag(_this))
CORTO_C_EXPORT corto_tag _corto_tag__assign(corto_tag _this);
...
/* taglist */
CORTO_C_EXPORT corto_taglist* _corto_taglist__create(corto_object _parent, const char *_id, corto_uint32 length, corto_tag* elements);
...
CORTO_C_EXPORT corto_int16 _corto_taglist__update(corto_taglist* _this, corto_uint32 length, corto_tag* elements);
#define corto_taglist__update(_this, length, elements) _corto_taglist__update(corto_taglist(_this), length, elements)
CORTO_C_EXPORT corto_taglist* _corto_taglist__assign(corto_taglist* _this, corto_uint32 length, corto_tag* elements);
...
/* target */
CORTO_C_EXPORT corto_target _corto_target__create(corto_object _parent, const char *_id, corto_type type);
...
CORTO_C_EXPORT corto_int16 _corto_target__update(corto_target _this, corto_type type);
#define corto_target__update(_this, type) _corto_target__update(corto_target(_this), corto_type(type))
CORTO_C_EXPORT corto_target _corto_target__assign(corto_target _this, corto_type type);
...
/* text */
CORTO_C_EXPORT corto_text _corto_text__create(corto_object _parent, const char *_id, corto_width char_width, uint64_t length);
...
CORTO_C_EXPORT corto_int16 _corto_text__update(corto_text _this, corto_width char_width, uint64_t length);
#define corto_text__update(_this, char_width, length) _corto_text__update(corto_text(_this), char_width, length)
CORTO_C_EXPORT corto_text _corto_text__assign(corto_text _this, corto_width char_width, uint64_t length);
...
/* tool */
CORTO_C_EXPORT corto_tool _corto_tool__create(corto_object _parent, const char *_id);
...
CORTO_C_EXPORT corto_int16 _corto_tool__update(corto_tool _this);
#define corto_tool__update(_this) _corto_tool__update(corto_tool(_this))
CORTO_C_EXPORT corto_tool _corto_tool__assign(corto_tool _this);
...
/* type */
CORTO_C_EXPORT corto_type _corto_type__create(corto_object _parent, const char *_id, bool reference);
...
CORTO_C_EXPORT corto_int16 _corto_type__update(corto_type _this, bool reference);
#define corto_type__update(_this, reference) _corto_type__update(corto_type(_this), reference)
CORTO_C_EXPORT corto_type _corto_type__assign(corto_type _this, bool reference);
...
/* typeKind */
CORTO_C_EXPORT corto_typeKind* _corto_typeKind__create(corto_object _parent, const char *_id, corto_typeKind value);
...
CORTO_C_EXPORT corto_int16 _corto_typeKind__update(corto_typeKind* _this, corto_typeKind value);
#define corto_typeKind__update(_this, value) _corto_typeKind__update(corto_typeKind(_this), value)
CORTO_C_EXPORT corto_typeKind* _corto_typeKind__assign(corto_typeKind* _this, corto_typeKind value);
...
/* uint */
CORTO_C_EXPORT corto_uint _corto_uint__create(corto_object _parent, const char *_id, corto_width width, uint64_t min, uint64_t max);
...
CORTO_C_EXPORT corto_int16 _corto_uint__update(corto_uint _this, corto_width width, uint64_t min, uint64_t max);
#define corto_uint__update(_this, width, min, max) _corto_uint__update(corto_uint(_this), width, min, max)
CORTO_C_EXPORT corto_uint _corto_uint__assign(corto_uint _this, corto_width width, uint64_t min, uint64_t max);
...
/* uint16 */
CORTO_C_EXPORT uint16_t* _corto_uint16__create(corto_object _parent, const char *_id, uint16_t value);
...
CORTO_C_EXPORT corto_int16 _corto_uint16__update(uint16_t* _this, uint16_t value);
#define corto_uint16__update(_this, value) _corto_uint16__update(corto_uint16(_this), value)
CORTO_C_EXPORT uint16_t* _corto_uint16__assign(uint16_t* _this, uint16_t value);
...
/* uint32 */
CORTO_C_EXPORT uint32_t* _corto_uint32__create(corto_object _parent, const char *_id, uint32_t value);
...
CORTO_C_EXPORT corto_int16 _corto_uint32__update(uint32_t* _this, uint32_t value);
#define corto_uint32__update(_this, value) _corto_uint32__update(corto_uint32(_this), value)
CORTO_C_EXPORT uint32_t* _corto_uint32__assign(uint32_t* _this, uint32_t value);
...
/* uint64 */
CORTO_C_EXPORT uint64_t* _corto_uint64__create(corto_object _parent, const char *_id, uint64_t value);
...
CORTO_C_EXPORT corto_int16 _corto_uint64__update(uint64_t* _this, uint64_t value);
#define corto_uint64__update(_this, value) _corto_uint64__update(corto_uint64(_this), value)
CORTO_C_EXPORT uint64_t* _corto_uint64__assign(uint64_t* _this, uint64_t value);
...
/* uint8 */
CORTO_C_EXPORT uint8_t* _corto_uint8__create(corto_object _parent, const char *_id, uint8_t value);
...
CORTO_C_EXPORT corto_int16 _corto_uint8__update(uint8_t* _this, uint8_t value);
#define corto_uint8__update(_this, value) _corto_uint8__update(corto_uint8(_this), value)
CORTO_C_EXPORT uint8_t* _corto_uint8__assign(uint8_t* _this, uint8_t value);
...
/* union */
CORTO_C_EXPORT corto_union _corto_union__create(corto_object _parent, const char *_id, corto_type discriminator);
...
CORTO_C_EXPORT corto_int16 _corto_union__update(corto_union _this, corto_type discriminator);
#define corto_union__update(_this, discriminator) _corto_union__update(corto_union(_this), corto_type(discriminator))
CORTO_C_EXPORT corto_union _corto_union__assign(corto_union _this, corto_type discriminator);
...
/* unit */
CORTO_C_EXPORT corto_unit _corto_unit__create(corto_object _parent, const char *_id, corto_quantity quantity, const char * symbol, const char * conversion, corto_type type);
...
CORTO_C_EXPORT corto_int16 _corto_unit__update(corto_unit _this, corto_quantity quantity, const char * symbol, const char * conversion, corto_type type);
...
CORTO_C_EXPORT corto_unit _corto_unit__assign(corto_unit _this, corto_quantity quantity, const char * symbol, const char * conversion, corto_type type);
...
/* unknown */
CORTO_C_EXPORT void* _corto_unknown__create(corto_object _parent, const char *_id);
...
CORTO_C_EXPORT corto_int16 _corto_unknown__update(void* _this);
#define corto_unknown__update(_this) _corto_unknown__update(corto_unknown(_this))

/* verbatim */
CORTO_C_EXPORT corto_verbatim _corto_verbatim__create(corto_object _parent, const char *_id, const char * format);
...
CORTO_C_EXPORT corto_int16 _corto_verbatim__update(corto_verbatim _this, const char * format);
#define corto_verbatim__update(_this, format) _corto_verbatim__update(corto_verbatim(_this), format)
CORTO_C_EXPORT corto_verbatim _corto_verbatim__assign(corto_verbatim _this, const char * format);
...
/* void */
CORTO_C_EXPORT void* _corto_void__create(corto_object _parent, const char *_id);
...
CORTO_C_EXPORT corto_int16 _corto_void__update(void* _this);
#define corto_void__update(_this) _corto_void__update(corto_void(_this))

/* width */
CORTO_C_EXPORT corto_width* _corto_width__create(corto_object _parent, const char *_id, corto_width value);
...
CORTO_C_EXPORT corto_int16 _corto_width__update(corto_width* _this, corto_width value);
#define corto_width__update(_this, value) _corto_width__update(corto_width(_this), value)
CORTO_C_EXPORT corto_width* _corto_width__assign(corto_width* _this, corto_width value);
...
/* word */
CORTO_C_EXPORT uintptr_t* _corto_word__create(corto_object _parent, const char *_id, uintptr_t value);
...
CORTO_C_EXPORT corto_int16 _corto_word__update(uintptr_t* _this, uintptr_t value);
#define corto_word__update(_this, value) _corto_word__update(corto_word(_this), value)
CORTO_C_EXPORT uintptr_t* _corto_word__assign(uintptr_t* _this, uintptr_t value);
...
/* wordseq */
CORTO_C_EXPORT corto_wordseq* _corto_wordseq__create(corto_object _parent, const char *_id, corto_uint32 length, uintptr_t* elements);
...
CORTO_C_EXPORT corto_int16 _corto_wordseq__update(corto_wordseq* _this, corto_uint32 length, uintptr_t* elements);
#define corto_wordseq__update(_this, length, elements) _corto_wordseq__update(corto_wordseq(_this), length, elements)
CORTO_C_EXPORT corto_wordseq* _corto_wordseq__assign(corto_wordseq* _this, corto_uint32 length, uintptr_t* elements);
...
/* int32seq */
CORTO_C_EXPORT int32_t* corto_int32seq__append(corto_int32seq *seq, int32_t element);
CORTO_C_EXPORT int32_t* corto_int32seq__append_alloc(corto_int32seq *seq);
CORTO_C_EXPORT void corto_int32seq__resize(corto_int32seq *seq, corto_uint32 length);
CORTO_C_EXPORT void corto_int32seq__clear(corto_int32seq *seq);

/* interfaceseq */
CORTO_C_EXPORT corto_interface* corto_interfaceseq__append(corto_interfaceseq *seq, corto_interface element);
CORTO_C_EXPORT corto_interface* corto_interfaceseq__append_alloc(corto_interfaceseq *seq);
CORTO_C_EXPORT void corto_interfaceseq__resize(corto_interfaceseq *seq, corto_uint32 length);
CORTO_C_EXPORT void corto_interfaceseq__clear(corto_interfaceseq *seq);

/* interfaceVectorseq */
CORTO_C_EXPORT corto_interfaceVector* corto_interfaceVectorseq__append(corto_interfaceVectorseq *seq, corto_interfaceVector element);
CORTO_C_EXPORT corto_interfaceVector* corto_interfaceVectorseq__append_alloc(corto_interfaceVectorseq *seq);
CORTO_C_EXPORT void corto_interfaceVectorseq__resize(corto_interfaceVectorseq *seq, corto_uint32 length);
CORTO_C_EXPORT void corto_interfaceVectorseq__clear(corto_interfaceVectorseq *seq);

/* objectlist */
CORTO_C_EXPORT void corto_objectlist__insert(corto_objectlist list, corto_object element);
CORTO_C_EXPORT void corto_objectlist__append(corto_objectlist list, corto_object element);
CORTO_C_EXPORT void corto_objectlist__remove(corto_objectlist list, corto_object element);
CORTO_C_EXPORT corto_object corto_objectlist__takeFirst(corto_objectlist list);
CORTO_C_EXPORT corto_object corto_objectlist__last(corto_objectlist list);
CORTO_C_EXPORT corto_object corto_objectlist__get(corto_objectlist list, corto_uint32 index);
CORTO_C_EXPORT void corto_objectlist__clear(corto_objectlist list);

/* objectseq */
CORTO_C_EXPORT corto_object* corto_objectseq__append(corto_objectseq *seq, corto_object element);
CORTO_C_EXPORT corto_object* corto_objectseq__append_alloc(corto_objectseq *seq);
CORTO_C_EXPORT void corto_objectseq__resize(corto_objectseq *seq, corto_uint32 length);
CORTO_C_EXPORT void corto_objectseq__clear(corto_objectseq *seq);

/* parameterseq */
CORTO_C_EXPORT corto_parameter* corto_parameterseq__append(corto_parameterseq *seq, corto_parameter element);
CORTO_C_EXPORT corto_parameter* corto_parameterseq__append_alloc(corto_parameterseq *seq);
CORTO_C_EXPORT void corto_parameterseq__resize(corto_parameterseq *seq, corto_uint32 length);
CORTO_C_EXPORT void corto_parameterseq__clear(corto_parameterseq *seq);

/* stringlist */
CORTO_C_EXPORT void corto_stringlist__insert(corto_stringlist list, corto_string element);
CORTO_C_EXPORT void corto_stringlist__append(corto_stringlist list, corto_string element);
CORTO_C_EXPORT corto_string corto_stringlist__takeFirst(corto_stringlist list);
CORTO_C_EXPORT corto_string corto_stringlist__last(corto_stringlist list);
CORTO_C_EXPORT corto_string corto_stringlist__get(corto_stringlist list, corto_uint32 index);
CORTO_C_EXPORT void corto_stringlist__clear(corto_stringlist list);

/* stringseq */
CORTO_C_EXPORT corto_string* corto_stringseq__append(corto_stringseq *seq, corto_string element);
CORTO_C_EXPORT corto_string* corto_stringseq__append_alloc(corto_stringseq *seq);
CORTO_C_EXPORT void corto_stringseq__resize(corto_stringseq *seq, corto_uint32 length);
CORTO_C_EXPORT void corto_stringseq__clear(corto_stringseq *seq);

/* taglist */
CORTO_C_EXPORT void corto_taglist__insert(corto_taglist list, corto_tag element);
CORTO_C_EXPORT void corto_taglist__append(corto_taglist list, corto_tag element);
CORTO_C_EXPORT void corto_taglist__remove(corto_taglist list, corto_tag element);
CORTO_C_EXPORT corto_tag corto_taglist__takeFirst(corto_taglist list);
CORTO_C_EXPORT corto_tag corto_taglist__last(corto_taglist list);
CORTO_C_EXPORT corto_tag corto_taglist__get(corto_taglist list, corto_uint32 index);
CORTO_C_EXPORT void corto_taglist__clear(corto_taglist list);

/* wordseq */
CORTO_C_EXPORT uintptr_t* corto_wordseq__append(corto_wordseq *seq, uintptr_t element);
CORTO_C_EXPORT uintptr_t* corto_wordseq__append_alloc(corto_wordseq *seq);
CORTO_C_EXPORT void corto_wordseq__resize(corto_wordseq *seq, corto_uint32 length);
CORTO_C_EXPORT void corto_wordseq__clear(corto_wordseq *seq);
