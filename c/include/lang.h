...
CORTO_EXPORT corto_alias _corto_aliasCreateChild(corto_object _parent, const char *_id, corto_member member);
...
CORTO_EXPORT corto_alias _corto_aliasDeclareChild(corto_object _parent, const char *_id);
...
#define corto_alias__optional_Set(member) (corto_alias*)corto_aliasAssign((corto_alias*)corto_ptr_new(corto_alias_o), member)
#define corto_alias__optional_SetCond(cond, member) cond ? (corto_alias*)corto_aliasAssign((corto_alias*)corto_ptr_new(corto_alias_o), member) : NULL
...
CORTO_EXPORT corto_any* _corto_anyCreateChild(corto_object _parent, const char *_id, corto_type type, void *value);
...
CORTO_EXPORT corto_any* _corto_anyDeclareChild(corto_object _parent, const char *_id);
...
#define corto_any__optional_Set(type, value) (corto_any*)corto_anyAssign((corto_any*)corto_ptr_new(corto_any_o), type, value)
#define corto_any__optional_SetCond(cond, type, value) cond ? (corto_any*)corto_anyAssign((corto_any*)corto_ptr_new(corto_any_o), type, value) : NULL
...
CORTO_EXPORT corto_application _corto_applicationCreateChild(corto_object _parent, const char *_id);
...
CORTO_EXPORT corto_application _corto_applicationDeclareChild(corto_object _parent, const char *_id);
...
#define corto_application__optional_Set() (corto_application*)corto_applicationAssign((corto_application*)corto_ptr_new(corto_application_o))
#define corto_application__optional_SetCond(cond) cond ? (corto_application*)corto_applicationAssign((corto_application*)corto_ptr_new(corto_application_o)) : NULL
#define corto_applicationUnset(_this) _this ? corto_ptr_free(_this, corto_application_o), 0 : 0; _this = NULL;
#define corto_applicationAssign(_this) _corto_applicationAssign(_this)
#define corto_applicationSet(_this) _this = _this ? _this : (corto_application*)corto_ptr_new(corto_application_o); _corto_applicationAssign(_this)
...
CORTO_EXPORT corto_array _corto_arrayCreateChild(corto_object _parent, const char *_id, corto_type elementType, uint32_t max);
...
CORTO_EXPORT corto_array _corto_arrayDeclareChild(corto_object _parent, const char *_id);
...
#define corto_array__optional_Set(elementType, max) (corto_array*)corto_arrayAssign((corto_array*)corto_ptr_new(corto_array_o), elementType, max)
#define corto_array__optional_SetCond(cond, elementType, max) cond ? (corto_array*)corto_arrayAssign((corto_array*)corto_ptr_new(corto_array_o), elementType, max) : NULL
...
CORTO_EXPORT corto_attr* _corto_attrCreateChild(corto_object _parent, const char *_id, corto_attr value);
...
CORTO_EXPORT corto_attr* _corto_attrDeclareChild(corto_object _parent, const char *_id);
...
#define corto_attr__optional_Set(value) (corto_attr*)corto_attrAssign((corto_attr*)corto_ptr_new(corto_attr_o), value)
#define corto_attr__optional_SetCond(cond, value) cond ? (corto_attr*)corto_attrAssign((corto_attr*)corto_ptr_new(corto_attr_o), value) : NULL
...
CORTO_EXPORT corto_binary _corto_binaryCreateChild(corto_object _parent, const char *_id, corto_width width);
...
CORTO_EXPORT corto_binary _corto_binaryDeclareChild(corto_object _parent, const char *_id);
...
#define corto_binary__optional_Set(width) (corto_binary*)corto_binaryAssign((corto_binary*)corto_ptr_new(corto_binary_o), width)
#define corto_binary__optional_SetCond(cond, width) cond ? (corto_binary*)corto_binaryAssign((corto_binary*)corto_ptr_new(corto_binary_o), width) : NULL
...
CORTO_EXPORT corto_bitmask _corto_bitmaskCreateChild(corto_object _parent, const char *_id);
...
CORTO_EXPORT corto_bitmask _corto_bitmaskDeclareChild(corto_object _parent, const char *_id);
...
#define corto_bitmask__optional_Set() (corto_bitmask*)corto_bitmaskAssign((corto_bitmask*)corto_ptr_new(corto_bitmask_o))
#define corto_bitmask__optional_SetCond(cond) cond ? (corto_bitmask*)corto_bitmaskAssign((corto_bitmask*)corto_ptr_new(corto_bitmask_o)) : NULL
...
CORTO_EXPORT bool* _corto_boolCreateChild(corto_object _parent, const char *_id, bool value);
...
CORTO_EXPORT bool* _corto_boolDeclareChild(corto_object _parent, const char *_id);
...
#define corto_bool__optional_Set(value) (corto_bool*)corto_boolAssign((corto_bool*)corto_ptr_new(corto_bool_o), value)
#define corto_bool__optional_SetCond(cond, value) cond ? (corto_bool*)corto_boolAssign((corto_bool*)corto_ptr_new(corto_bool_o), value) : NULL
...
CORTO_EXPORT corto_boolean _corto_booleanCreateChild(corto_object _parent, const char *_id);
...
CORTO_EXPORT corto_boolean _corto_booleanDeclareChild(corto_object _parent, const char *_id);
...
#define corto_boolean__optional_Set() (corto_boolean*)corto_booleanAssign((corto_boolean*)corto_ptr_new(corto_boolean_o))
#define corto_boolean__optional_SetCond(cond) cond ? (corto_boolean*)corto_booleanAssign((corto_boolean*)corto_ptr_new(corto_boolean_o)) : NULL
...
/* case */
CORTO_EXPORT corto_case _corto_caseCreate(corto_int32seq discriminator, corto_type type, corto_modifier modifiers);
#define corto_caseCreate(discriminator, type, modifiers) _corto_caseCreate(discriminator, corto_type(type), modifiers)
#define corto_caseCreate_auto(_id, discriminator, type, modifiers) corto_case _id = corto_caseCreate(discriminator, type, modifiers); (void)_id
CORTO_EXPORT corto_case _corto_caseCreateChild(corto_object _parent, const char *_id, corto_int32seq discriminator, corto_type type, corto_modifier modifiers);
#define corto_caseCreateChild(_parent, _id, discriminator, type, modifiers) _corto_caseCreateChild(_parent, _id, discriminator, corto_type(type), modifiers)
#define corto_caseCreateChild_auto(_parent, _id, discriminator, type, modifiers) corto_case _id = corto_caseCreateChild(_parent, #_id, discriminator, type, modifiers); (void)_id
CORTO_EXPORT corto_int16 _corto_caseUpdate(corto_case _this, corto_int32seq discriminator, corto_type type, corto_modifier modifiers);
#define corto_caseUpdate(_this, discriminator, type, modifiers) _corto_caseUpdate(corto_case(_this), discriminator, corto_type(type), modifiers)
...
CORTO_EXPORT corto_case _corto_caseDeclareChild(corto_object _parent, const char *_id);
...
CORTO_EXPORT corto_int16 _corto_caseDefine(corto_case _this, corto_int32seq discriminator, corto_type type, corto_modifier modifiers);
#define corto_caseDefine(_this, discriminator, type, modifiers) _corto_caseDefine(corto_case(_this), discriminator, corto_type(type), modifiers)
CORTO_EXPORT corto_case _corto_caseAssign(corto_case _this, corto_int32seq discriminator, corto_type type, corto_modifier modifiers);
#define corto_case__optional_NotSet NULL
#define corto_case__optional_Set(discriminator, type, modifiers) (corto_case*)corto_caseAssign((corto_case*)corto_ptr_new(corto_case_o), discriminator, type, modifiers)
#define corto_case__optional_SetCond(cond, discriminator, type, modifiers) cond ? (corto_case*)corto_caseAssign((corto_case*)corto_ptr_new(corto_case_o), discriminator, type, modifiers) : NULL
#define corto_caseUnset(_this) _this ? corto_ptr_free(_this, corto_case_o), 0 : 0; _this = NULL;
#define corto_caseAssign(_this, discriminator, type, modifiers) _corto_caseAssign(_this, discriminator, corto_type(type), modifiers)
#define corto_caseSet(_this, discriminator, type, modifiers) _this = _this ? _this : (corto_case*)corto_ptr_new(corto_case_o); _corto_caseAssign(_this, discriminator, corto_type(type), modifiers)
...
CORTO_EXPORT char* _corto_charCreateChild(corto_object _parent, const char *_id, char value);
...
CORTO_EXPORT char* _corto_charDeclareChild(corto_object _parent, const char *_id);
...
#define corto_char__optional_Set(value) (corto_char*)corto_charAssign((corto_char*)corto_ptr_new(corto_char_o), value)
#define corto_char__optional_SetCond(cond, value) cond ? (corto_char*)corto_charAssign((corto_char*)corto_ptr_new(corto_char_o), value) : NULL
...
CORTO_EXPORT corto_character _corto_characterCreateChild(corto_object _parent, const char *_id, corto_width width);
...
CORTO_EXPORT corto_character _corto_characterDeclareChild(corto_object _parent, const char *_id);
...
#define corto_character__optional_Set(width) (corto_character*)corto_characterAssign((corto_character*)corto_ptr_new(corto_character_o), width)
#define corto_character__optional_SetCond(cond, width) cond ? (corto_character*)corto_characterAssign((corto_character*)corto_ptr_new(corto_character_o), width) : NULL
...
CORTO_EXPORT corto_class _corto_classCreateChild(corto_object _parent, const char *_id, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements);
...
CORTO_EXPORT corto_class _corto_classDeclareChild(corto_object _parent, const char *_id);
...
#define corto_class__optional_Set(base, baseAccess, implements) (corto_class*)corto_classAssign((corto_class*)corto_ptr_new(corto_class_o), base, baseAccess, implements)
#define corto_class__optional_SetCond(cond, base, baseAccess, implements) cond ? (corto_class*)corto_classAssign((corto_class*)corto_ptr_new(corto_class_o), base, baseAccess, implements) : NULL
...
CORTO_EXPORT corto_collection _corto_collectionCreateChild(corto_object _parent, const char *_id, corto_type elementType, uint32_t max);
...
CORTO_EXPORT corto_collection _corto_collectionDeclareChild(corto_object _parent, const char *_id);
...
#define corto_collection__optional_Set(elementType, max) (corto_collection*)corto_collectionAssign((corto_collection*)corto_ptr_new(corto_collection_o), elementType, max)
#define corto_collection__optional_SetCond(cond, elementType, max) cond ? (corto_collection*)corto_collectionAssign((corto_collection*)corto_ptr_new(corto_collection_o), elementType, max) : NULL
...
CORTO_EXPORT corto_collectionKind* _corto_collectionKindCreateChild(corto_object _parent, const char *_id, corto_collectionKind value);
...
CORTO_EXPORT corto_collectionKind* _corto_collectionKindDeclareChild(corto_object _parent, const char *_id);
...
#define corto_collectionKind__optional_Set(value) (corto_collectionKind*)corto_collectionKindAssign((corto_collectionKind*)corto_ptr_new(corto_collectionKind_o), value)
#define corto_collectionKind__optional_SetCond(cond, value) cond ? (corto_collectionKind*)corto_collectionKindAssign((corto_collectionKind*)corto_ptr_new(corto_collectionKind_o), value) : NULL
...
CORTO_EXPORT corto_compositeKind* _corto_compositeKindCreateChild(corto_object _parent, const char *_id, corto_compositeKind value);
...
CORTO_EXPORT corto_compositeKind* _corto_compositeKindDeclareChild(corto_object _parent, const char *_id);
...
#define corto_compositeKind__optional_Set(value) (corto_compositeKind*)corto_compositeKindAssign((corto_compositeKind*)corto_ptr_new(corto_compositeKind_o), value)
#define corto_compositeKind__optional_SetCond(cond, value) cond ? (corto_compositeKind*)corto_compositeKindAssign((corto_compositeKind*)corto_ptr_new(corto_compositeKind_o), value) : NULL
...
CORTO_EXPORT int32_t* _corto_constantCreateChild(corto_object _parent, const char *_id, int32_t value);
...
CORTO_EXPORT int32_t* _corto_constantDeclareChild(corto_object _parent, const char *_id);
...
#define corto_constant__optional_Set(value) (corto_constant*)corto_constantAssign((corto_constant*)corto_ptr_new(corto_constant_o), value)
#define corto_constant__optional_SetCond(cond, value) cond ? (corto_constant*)corto_constantAssign((corto_constant*)corto_ptr_new(corto_constant_o), value) : NULL
...
/* container */
CORTO_EXPORT corto_container _corto_containerCreate(corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_EXPORT corto_container _corto_containerCreateChild(corto_object _parent, const char *_id, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_EXPORT corto_int16 _corto_containerUpdate(corto_container _this, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_EXPORT corto_container _corto_containerDeclareChild(corto_object _parent, const char *_id);
...
CORTO_EXPORT corto_int16 _corto_containerDefine(corto_container _this, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_EXPORT corto_container _corto_containerAssign(corto_container _this, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value);
#define corto_container__optional_NotSet NULL
#define corto_container__optional_Set(base, baseAccess, implements, type, value) (corto_container*)corto_containerAssign((corto_container*)corto_ptr_new(corto_container_o), base, baseAccess, implements, type, value)
#define corto_container__optional_SetCond(cond, base, baseAccess, implements, type, value) cond ? (corto_container*)corto_containerAssign((corto_container*)corto_ptr_new(corto_container_o), base, baseAccess, implements, type, value) : NULL
...
CORTO_EXPORT corto_default _corto_defaultCreateChild(corto_object _parent, const char *_id, corto_type type);
...
CORTO_EXPORT corto_default _corto_defaultDeclareChild(corto_object _parent, const char *_id);
...
#define corto_default__optional_Set(type) (corto_default*)corto_defaultAssign((corto_default*)corto_ptr_new(corto_default_o), type)
#define corto_default__optional_SetCond(cond, type) cond ? (corto_default*)corto_defaultAssign((corto_default*)corto_ptr_new(corto_default_o), type) : NULL
...
CORTO_EXPORT corto_delegate _corto_delegateCreateChild(corto_object _parent, const char *_id, corto_type returnType, bool returnsReference, corto_parameterseq parameters);
...
CORTO_EXPORT corto_delegate _corto_delegateDeclareChild(corto_object _parent, const char *_id);
...
#define corto_delegate__optional_Set(returnType, returnsReference, parameters) (corto_delegate*)corto_delegateAssign((corto_delegate*)corto_ptr_new(corto_delegate_o), returnType, returnsReference, parameters)
#define corto_delegate__optional_SetCond(cond, returnType, returnsReference, parameters) cond ? (corto_delegate*)corto_delegateAssign((corto_delegate*)corto_ptr_new(corto_delegate_o), returnType, returnsReference, parameters) : NULL
...
CORTO_EXPORT corto_delegatedata* _corto_delegatedataCreateChild(corto_object _parent, const char *_id, corto_object instance, corto_function procedure);
...
CORTO_EXPORT corto_delegatedata* _corto_delegatedataDeclareChild(corto_object _parent, const char *_id);
...
#define corto_delegatedata__optional_Set(instance, procedure) (corto_delegatedata*)corto_delegatedataAssign((corto_delegatedata*)corto_ptr_new(corto_delegatedata_o), instance, procedure)
#define corto_delegatedata__optional_SetCond(cond, instance, procedure) cond ? (corto_delegatedata*)corto_delegatedataAssign((corto_delegatedata*)corto_ptr_new(corto_delegatedata_o), instance, procedure) : NULL
...
CORTO_EXPORT corto_enum _corto_enumCreateChild(corto_object _parent, const char *_id);
...
CORTO_EXPORT corto_enum _corto_enumDeclareChild(corto_object _parent, const char *_id);
...
#define corto_enum__optional_Set() (corto_enum*)corto_enumAssign((corto_enum*)corto_ptr_new(corto_enum_o))
#define corto_enum__optional_SetCond(cond) cond ? (corto_enum*)corto_enumAssign((corto_enum*)corto_ptr_new(corto_enum_o)) : NULL
...
CORTO_EXPORT corto_equalityKind* _corto_equalityKindCreateChild(corto_object _parent, const char *_id, corto_equalityKind value);
...
CORTO_EXPORT corto_equalityKind* _corto_equalityKindDeclareChild(corto_object _parent, const char *_id);
...
#define corto_equalityKind__optional_Set(value) (corto_equalityKind*)corto_equalityKindAssign((corto_equalityKind*)corto_ptr_new(corto_equalityKind_o), value)
#define corto_equalityKind__optional_SetCond(cond, value) cond ? (corto_equalityKind*)corto_equalityKindAssign((corto_equalityKind*)corto_ptr_new(corto_equalityKind_o), value) : NULL
...
CORTO_EXPORT corto_float _corto_floatCreateChild(corto_object _parent, const char *_id, corto_width width, double min, double max);
...
CORTO_EXPORT corto_float _corto_floatDeclareChild(corto_object _parent, const char *_id);
...
#define corto_float__optional_Set(width, min, max) (corto_float*)corto_floatAssign((corto_float*)corto_ptr_new(corto_float_o), width, min, max)
#define corto_float__optional_SetCond(cond, width, min, max) cond ? (corto_float*)corto_floatAssign((corto_float*)corto_ptr_new(corto_float_o), width, min, max) : NULL
...
CORTO_EXPORT float* _corto_float32CreateChild(corto_object _parent, const char *_id, float value);
...
CORTO_EXPORT float* _corto_float32DeclareChild(corto_object _parent, const char *_id);
...
#define corto_float32__optional_Set(value) (corto_float32*)corto_float32Assign((corto_float32*)corto_ptr_new(corto_float32_o), value)
#define corto_float32__optional_SetCond(cond, value) cond ? (corto_float32*)corto_float32Assign((corto_float32*)corto_ptr_new(corto_float32_o), value) : NULL
...
CORTO_EXPORT double* _corto_float64CreateChild(corto_object _parent, const char *_id, double value);
...
CORTO_EXPORT double* _corto_float64DeclareChild(corto_object _parent, const char *_id);
...
#define corto_float64__optional_Set(value) (corto_float64*)corto_float64Assign((corto_float64*)corto_ptr_new(corto_float64_o), value)
#define corto_float64__optional_SetCond(cond, value) cond ? (corto_float64*)corto_float64Assign((corto_float64*)corto_ptr_new(corto_float64_o), value) : NULL
...
CORTO_EXPORT corto_function _corto_functionCreateChild(corto_object _parent, const char *_id, corto_type returnType, bool returnsReference, void(*_impl)(void));
...
CORTO_EXPORT corto_function _corto_functionDeclareChild(corto_object _parent, const char *_id);
...
#define corto_function__optional_Set(returnType, returnsReference, _impl) (corto_function*)corto_functionAssign((corto_function*)corto_ptr_new(corto_function_o), returnType, returnsReference, _impl)
#define corto_function__optional_SetCond(cond, returnType, returnsReference, _impl) cond ? (corto_function*)corto_functionAssign((corto_function*)corto_ptr_new(corto_function_o), returnType, returnsReference, _impl) : NULL
...
CORTO_EXPORT corto_inout* _corto_inoutCreateChild(corto_object _parent, const char *_id, corto_inout value);
...
CORTO_EXPORT corto_inout* _corto_inoutDeclareChild(corto_object _parent, const char *_id);
...
#define corto_inout__optional_Set(value) (corto_inout*)corto_inoutAssign((corto_inout*)corto_ptr_new(corto_inout_o), value)
#define corto_inout__optional_SetCond(cond, value) cond ? (corto_inout*)corto_inoutAssign((corto_inout*)corto_ptr_new(corto_inout_o), value) : NULL
...
CORTO_EXPORT corto_int _corto_intCreateChild(corto_object _parent, const char *_id, corto_width width, int64_t min, int64_t max);
...
CORTO_EXPORT corto_int _corto_intDeclareChild(corto_object _parent, const char *_id);
...
#define corto_int__optional_Set(width, min, max) (corto_int*)corto_intAssign((corto_int*)corto_ptr_new(corto_int_o), width, min, max)
#define corto_int__optional_SetCond(cond, width, min, max) cond ? (corto_int*)corto_intAssign((corto_int*)corto_ptr_new(corto_int_o), width, min, max) : NULL
...
CORTO_EXPORT int16_t* _corto_int16CreateChild(corto_object _parent, const char *_id, int16_t value);
...
CORTO_EXPORT int16_t* _corto_int16DeclareChild(corto_object _parent, const char *_id);
...
#define corto_int16__optional_Set(value) (corto_int16*)corto_int16Assign((corto_int16*)corto_ptr_new(corto_int16_o), value)
#define corto_int16__optional_SetCond(cond, value) cond ? (corto_int16*)corto_int16Assign((corto_int16*)corto_ptr_new(corto_int16_o), value) : NULL
...
CORTO_EXPORT int32_t* _corto_int32CreateChild(corto_object _parent, const char *_id, int32_t value);
...
CORTO_EXPORT int32_t* _corto_int32DeclareChild(corto_object _parent, const char *_id);
...
#define corto_int32__optional_Set(value) (corto_int32*)corto_int32Assign((corto_int32*)corto_ptr_new(corto_int32_o), value)
#define corto_int32__optional_SetCond(cond, value) cond ? (corto_int32*)corto_int32Assign((corto_int32*)corto_ptr_new(corto_int32_o), value) : NULL
...
CORTO_EXPORT corto_int32seq* _corto_int32seqCreateChild(corto_object _parent, const char *_id, corto_uint32 length, int32_t* elements);
...
CORTO_EXPORT corto_int32seq* _corto_int32seqDeclareChild(corto_object _parent, const char *_id);
...
#define corto_int32seq__optional_Set(length, elements) (corto_int32seq*)corto_int32seqAssign((corto_int32seq*)corto_ptr_new(corto_int32seq_o), length, elements)
#define corto_int32seq__optional_SetCond(cond, length, elements) cond ? (corto_int32seq*)corto_int32seqAssign((corto_int32seq*)corto_ptr_new(corto_int32seq_o), length, elements) : NULL
...
CORTO_EXPORT int64_t* _corto_int64CreateChild(corto_object _parent, const char *_id, int64_t value);
...
CORTO_EXPORT int64_t* _corto_int64DeclareChild(corto_object _parent, const char *_id);
...
#define corto_int64__optional_Set(value) (corto_int64*)corto_int64Assign((corto_int64*)corto_ptr_new(corto_int64_o), value)
#define corto_int64__optional_SetCond(cond, value) cond ? (corto_int64*)corto_int64Assign((corto_int64*)corto_ptr_new(corto_int64_o), value) : NULL
...
CORTO_EXPORT int8_t* _corto_int8CreateChild(corto_object _parent, const char *_id, int8_t value);
...
CORTO_EXPORT int8_t* _corto_int8DeclareChild(corto_object _parent, const char *_id);
...
#define corto_int8__optional_Set(value) (corto_int8*)corto_int8Assign((corto_int8*)corto_ptr_new(corto_int8_o), value)
#define corto_int8__optional_SetCond(cond, value) cond ? (corto_int8*)corto_int8Assign((corto_int8*)corto_ptr_new(corto_int8_o), value) : NULL
...
CORTO_EXPORT corto_interface _corto_interfaceCreateChild(corto_object _parent, const char *_id, corto_interface base);
...
CORTO_EXPORT corto_interface _corto_interfaceDeclareChild(corto_object _parent, const char *_id);
...
#define corto_interface__optional_Set(base) (corto_interface*)corto_interfaceAssign((corto_interface*)corto_ptr_new(corto_interface_o), base)
#define corto_interface__optional_SetCond(cond, base) cond ? (corto_interface*)corto_interfaceAssign((corto_interface*)corto_ptr_new(corto_interface_o), base) : NULL
...
CORTO_EXPORT corto_interfaceseq* _corto_interfaceseqCreateChild(corto_object _parent, const char *_id, corto_uint32 length, corto_interface* elements);
...
CORTO_EXPORT corto_interfaceseq* _corto_interfaceseqDeclareChild(corto_object _parent, const char *_id);
...
#define corto_interfaceseq__optional_Set(length, elements) (corto_interfaceseq*)corto_interfaceseqAssign((corto_interfaceseq*)corto_ptr_new(corto_interfaceseq_o), length, elements)
#define corto_interfaceseq__optional_SetCond(cond, length, elements) cond ? (corto_interfaceseq*)corto_interfaceseqAssign((corto_interfaceseq*)corto_ptr_new(corto_interfaceseq_o), length, elements) : NULL
...
CORTO_EXPORT corto_interfaceVector* _corto_interfaceVectorCreateChild(corto_object _parent, const char *_id, corto_interface interface, corto_objectseq vector);
...
CORTO_EXPORT corto_interfaceVector* _corto_interfaceVectorDeclareChild(corto_object _parent, const char *_id);
...
#define corto_interfaceVector__optional_Set(interface, vector) (corto_interfaceVector*)corto_interfaceVectorAssign((corto_interfaceVector*)corto_ptr_new(corto_interfaceVector_o), interface, vector)
#define corto_interfaceVector__optional_SetCond(cond, interface, vector) cond ? (corto_interfaceVector*)corto_interfaceVectorAssign((corto_interfaceVector*)corto_ptr_new(corto_interfaceVector_o), interface, vector) : NULL
...
CORTO_EXPORT corto_interfaceVectorseq* _corto_interfaceVectorseqCreateChild(corto_object _parent, const char *_id, corto_uint32 length, corto_interfaceVector* elements);
...
CORTO_EXPORT corto_interfaceVectorseq* _corto_interfaceVectorseqDeclareChild(corto_object _parent, const char *_id);
...
#define corto_interfaceVectorseq__optional_Set(length, elements) (corto_interfaceVectorseq*)corto_interfaceVectorseqAssign((corto_interfaceVectorseq*)corto_ptr_new(corto_interfaceVectorseq_o), length, elements)
#define corto_interfaceVectorseq__optional_SetCond(cond, length, elements) cond ? (corto_interfaceVectorseq*)corto_interfaceVectorseqAssign((corto_interfaceVectorseq*)corto_ptr_new(corto_interfaceVectorseq_o), length, elements) : NULL
...
CORTO_EXPORT corto_iterator _corto_iteratorCreateChild(corto_object _parent, const char *_id, corto_type elementType);
...
CORTO_EXPORT corto_iterator _corto_iteratorDeclareChild(corto_object _parent, const char *_id);
...
#define corto_iterator__optional_Set(elementType) (corto_iterator*)corto_iteratorAssign((corto_iterator*)corto_ptr_new(corto_iterator_o), elementType)
#define corto_iterator__optional_SetCond(cond, elementType) cond ? (corto_iterator*)corto_iteratorAssign((corto_iterator*)corto_ptr_new(corto_iterator_o), elementType) : NULL
...
/* leaf */
CORTO_EXPORT corto_leaf _corto_leafCreate(corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_EXPORT corto_leaf _corto_leafCreateChild(corto_object _parent, const char *_id, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_EXPORT corto_int16 _corto_leafUpdate(corto_leaf _this, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_EXPORT corto_leaf _corto_leafDeclareChild(corto_object _parent, const char *_id);
...
CORTO_EXPORT corto_int16 _corto_leafDefine(corto_leaf _this, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_EXPORT corto_leaf _corto_leafAssign(corto_leaf _this, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value);
#define corto_leaf__optional_NotSet NULL
#define corto_leaf__optional_Set(base, baseAccess, implements, type, value) (corto_leaf*)corto_leafAssign((corto_leaf*)corto_ptr_new(corto_leaf_o), base, baseAccess, implements, type, value)
#define corto_leaf__optional_SetCond(cond, base, baseAccess, implements, type, value) cond ? (corto_leaf*)corto_leafAssign((corto_leaf*)corto_ptr_new(corto_leaf_o), base, baseAccess, implements, type, value) : NULL
...
CORTO_EXPORT corto_list _corto_listCreateChild(corto_object _parent, const char *_id, corto_type elementType, uint32_t max);
...
CORTO_EXPORT corto_list _corto_listDeclareChild(corto_object _parent, const char *_id);
...
#define corto_list__optional_Set(elementType, max) (corto_list*)corto_listAssign((corto_list*)corto_ptr_new(corto_list_o), elementType, max)
#define corto_list__optional_SetCond(cond, elementType, max) cond ? (corto_list*)corto_listAssign((corto_list*)corto_ptr_new(corto_list_o), elementType, max) : NULL
...
CORTO_EXPORT corto_map _corto_mapCreateChild(corto_object _parent, const char *_id, corto_type elementType, corto_type keyType, uint32_t max);
...
CORTO_EXPORT corto_map _corto_mapDeclareChild(corto_object _parent, const char *_id);
...
#define corto_map__optional_Set(elementType, keyType, max) (corto_map*)corto_mapAssign((corto_map*)corto_ptr_new(corto_map_o), elementType, keyType, max)
#define corto_map__optional_SetCond(cond, elementType, keyType, max) cond ? (corto_map*)corto_mapAssign((corto_map*)corto_ptr_new(corto_map_o), elementType, keyType, max) : NULL
...
CORTO_EXPORT corto_member _corto_memberCreateChild(corto_object _parent, const char *_id, corto_type type, corto_modifier modifiers);
...
CORTO_EXPORT corto_member _corto_memberDeclareChild(corto_object _parent, const char *_id);
...
#define corto_member__optional_Set(type, modifiers) (corto_member*)corto_memberAssign((corto_member*)corto_ptr_new(corto_member_o), type, modifiers)
#define corto_member__optional_SetCond(cond, type, modifiers) cond ? (corto_member*)corto_memberAssign((corto_member*)corto_ptr_new(corto_member_o), type, modifiers) : NULL
...
CORTO_EXPORT corto_metaprocedure _corto_metaprocedureCreateChild(corto_object _parent, const char *_id, corto_type returnType, bool returnsReference, bool referenceOnly, void(*_impl)(void));
...
CORTO_EXPORT corto_metaprocedure _corto_metaprocedureDeclareChild(corto_object _parent, const char *_id);
...
#define corto_metaprocedure__optional_Set(returnType, returnsReference, referenceOnly, _impl) (corto_metaprocedure*)corto_metaprocedureAssign((corto_metaprocedure*)corto_ptr_new(corto_metaprocedure_o), returnType, returnsReference, referenceOnly, _impl)
#define corto_metaprocedure__optional_SetCond(cond, returnType, returnsReference, referenceOnly, _impl) cond ? (corto_metaprocedure*)corto_metaprocedureAssign((corto_metaprocedure*)corto_ptr_new(corto_metaprocedure_o), returnType, returnsReference, referenceOnly, _impl) : NULL
...
CORTO_EXPORT corto_method _corto_methodCreateChild(corto_object _parent, const char *_id, corto_type returnType, bool returnsReference, void(*_impl)(void));
...
CORTO_EXPORT corto_method _corto_methodDeclareChild(corto_object _parent, const char *_id);
...
#define corto_method__optional_Set(returnType, returnsReference, _impl) (corto_method*)corto_methodAssign((corto_method*)corto_ptr_new(corto_method_o), returnType, returnsReference, _impl)
#define corto_method__optional_SetCond(cond, returnType, returnsReference, _impl) cond ? (corto_method*)corto_methodAssign((corto_method*)corto_ptr_new(corto_method_o), returnType, returnsReference, _impl) : NULL
...
CORTO_EXPORT corto_modifier* _corto_modifierCreateChild(corto_object _parent, const char *_id, corto_modifier value);
...
CORTO_EXPORT corto_modifier* _corto_modifierDeclareChild(corto_object _parent, const char *_id);
...
#define corto_modifier__optional_Set(value) (corto_modifier*)corto_modifierAssign((corto_modifier*)corto_ptr_new(corto_modifier_o), value)
#define corto_modifier__optional_SetCond(cond, value) cond ? (corto_modifier*)corto_modifierAssign((corto_modifier*)corto_ptr_new(corto_modifier_o), value) : NULL
...
/* name_action */
CORTO_EXPORT corto_name_action* _corto_name_actionCreate(corto_object instance, corto_function procedure);
#define corto_name_actionCreate(instance, procedure) _corto_name_actionCreate(instance, corto_function(procedure))
#define corto_name_actionCreate_auto(_id, instance, procedure) corto_name_action* _id = corto_name_actionCreate(instance, procedure); (void)_id
CORTO_EXPORT corto_name_action* _corto_name_actionCreateChild(corto_object _parent, const char *_id, corto_object instance, corto_function procedure);
#define corto_name_actionCreateChild(_parent, _id, instance, procedure) _corto_name_actionCreateChild(_parent, _id, instance, corto_function(procedure))
#define corto_name_actionCreateChild_auto(_parent, _id, instance, procedure) corto_name_action* _id = corto_name_actionCreateChild(_parent, #_id, instance, procedure); (void)_id
CORTO_EXPORT corto_int16 _corto_name_actionUpdate(corto_name_action* _this, corto_object instance, corto_function procedure);
#define corto_name_actionUpdate(_this, instance, procedure) _corto_name_actionUpdate(corto_name_action(_this), instance, corto_function(procedure))

CORTO_EXPORT corto_name_action* _corto_name_actionDeclare(void);
#define corto_name_actionDeclare() _corto_name_actionDeclare()
#define corto_name_actionDeclare_auto(_id) corto_name_action* _id = corto_name_actionDeclare(); (void)_id
CORTO_EXPORT corto_name_action* _corto_name_actionDeclareChild(corto_object _parent, const char *_id);
#define corto_name_actionDeclareChild(_parent, _id) _corto_name_actionDeclareChild(_parent, _id)
#define corto_name_actionDeclareChild_auto(_parent, _id) corto_name_action* _id = corto_name_actionDeclareChild(_parent, #_id); (void)_id
CORTO_EXPORT corto_int16 _corto_name_actionDefine(corto_name_action* _this, corto_object instance, corto_function procedure);
#define corto_name_actionDefine(_this, instance, procedure) _corto_name_actionDefine(corto_name_action(_this), instance, corto_function(procedure))
CORTO_EXPORT corto_name_action* _corto_name_actionAssign(corto_name_action* _this, corto_object instance, corto_function procedure);
#define corto_name_action__optional_NotSet NULL
#define corto_name_action__optional_Set(instance, procedure) (corto_name_action*)corto_name_actionAssign((corto_name_action*)corto_ptr_new(corto_name_action_o), instance, procedure)
#define corto_name_action__optional_SetCond(cond, instance, procedure) cond ? (corto_name_action*)corto_name_actionAssign((corto_name_action*)corto_ptr_new(corto_name_action_o), instance, procedure) : NULL
#define corto_name_actionUnset(_this) _this ? corto_ptr_free(_this, corto_name_action_o), 0 : 0; _this = NULL;
#define corto_name_actionAssign(_this, instance, procedure) _corto_name_actionAssign(_this, instance, corto_function(procedure))
#define corto_name_actionSet(_this, instance, procedure) _this = _this ? _this : (corto_name_action*)corto_ptr_new(corto_name_action_o); _corto_name_actionAssign(_this, instance, corto_function(procedure))

corto_int16 corto_name_actionCall(corto_name_action *_delegate, corto_string* _result);
#define corto_name_actionInitC_auto(d, callback) corto_name_action d; corto_name_actionInitC(&d, callback)
CORTO_EXPORT corto_int16 corto_name_actionInitC(corto_name_action *d, corto_string ___ (*callback)(void));
#define corto_name_actionInitCInstance_auto(d, instance, callback)corto_name_action d; corto_name_actionInitCInstance(&d, instance, callback)
CORTO_EXPORT corto_int16 corto_name_actionInitCInstance(corto_name_action *d, corto_object instance, corto_string ___ (*callback)(corto_object));
/* object */
...
CORTO_EXPORT corto_object _corto_objectCreateChild(corto_object _parent, const char *_id, corto_object value);
...
CORTO_EXPORT corto_object _corto_objectDeclareChild(corto_object _parent, const char *_id);
...
#define corto_object__optional_Set(value) (corto_object*)corto_objectAssign((corto_object*)corto_ptr_new(corto_object_o), value)
#define corto_object__optional_SetCond(cond, value) cond ? (corto_object*)corto_objectAssign((corto_object*)corto_ptr_new(corto_object_o), value) : NULL
...
CORTO_EXPORT corto_objectlist* _corto_objectlistCreateChild(corto_object _parent, const char *_id, corto_uint32 length, corto_object* elements);
...
CORTO_EXPORT corto_objectlist* _corto_objectlistDeclareChild(corto_object _parent, const char *_id);
...
#define corto_objectlist__optional_Set(length, elements) (corto_objectlist*)corto_objectlistAssign((corto_objectlist*)corto_ptr_new(corto_objectlist_o), length, elements)
#define corto_objectlist__optional_SetCond(cond, length, elements) cond ? (corto_objectlist*)corto_objectlistAssign((corto_objectlist*)corto_ptr_new(corto_objectlist_o), length, elements) : NULL
...
CORTO_EXPORT corto_objectseq* _corto_objectseqCreateChild(corto_object _parent, const char *_id, corto_uint32 length, corto_object* elements);
...
CORTO_EXPORT corto_objectseq* _corto_objectseqDeclareChild(corto_object _parent, const char *_id);
...
#define corto_objectseq__optional_Set(length, elements) (corto_objectseq*)corto_objectseqAssign((corto_objectseq*)corto_ptr_new(corto_objectseq_o), length, elements)
#define corto_objectseq__optional_SetCond(cond, length, elements) cond ? (corto_objectseq*)corto_objectseqAssign((corto_objectseq*)corto_ptr_new(corto_objectseq_o), length, elements) : NULL
...
CORTO_EXPORT uint8_t* _corto_octetCreateChild(corto_object _parent, const char *_id, uint8_t value);
...
CORTO_EXPORT uint8_t* _corto_octetDeclareChild(corto_object _parent, const char *_id);
...
#define corto_octet__optional_Set(value) (corto_octet*)corto_octetAssign((corto_octet*)corto_ptr_new(corto_octet_o), value)
#define corto_octet__optional_SetCond(cond, value) cond ? (corto_octet*)corto_octetAssign((corto_octet*)corto_ptr_new(corto_octet_o), value) : NULL
...
CORTO_EXPORT corto_overridable _corto_overridableCreateChild(corto_object _parent, const char *_id, corto_type returnType, bool returnsReference, void(*_impl)(void));
...
CORTO_EXPORT corto_overridable _corto_overridableDeclareChild(corto_object _parent, const char *_id);
...
#define corto_overridable__optional_Set(returnType, returnsReference, _impl) (corto_overridable*)corto_overridableAssign((corto_overridable*)corto_ptr_new(corto_overridable_o), returnType, returnsReference, _impl)
#define corto_overridable__optional_SetCond(cond, returnType, returnsReference, _impl) cond ? (corto_overridable*)corto_overridableAssign((corto_overridable*)corto_ptr_new(corto_overridable_o), returnType, returnsReference, _impl) : NULL
...
CORTO_EXPORT corto_override _corto_overrideCreateChild(corto_object _parent, const char *_id, corto_type returnType, bool returnsReference, void(*_impl)(void));
...
CORTO_EXPORT corto_override _corto_overrideDeclareChild(corto_object _parent, const char *_id);
...
#define corto_override__optional_Set(returnType, returnsReference, _impl) (corto_override*)corto_overrideAssign((corto_override*)corto_ptr_new(corto_override_o), returnType, returnsReference, _impl)
#define corto_override__optional_SetCond(cond, returnType, returnsReference, _impl) cond ? (corto_override*)corto_overrideAssign((corto_override*)corto_ptr_new(corto_override_o), returnType, returnsReference, _impl) : NULL
...
CORTO_EXPORT corto_package _corto_packageCreateChild(corto_object _parent, const char *_id);
...
CORTO_EXPORT corto_package _corto_packageDeclareChild(corto_object _parent, const char *_id);
...
#define corto_package__optional_Set() (corto_package*)corto_packageAssign((corto_package*)corto_ptr_new(corto_package_o))
#define corto_package__optional_SetCond(cond) cond ? (corto_package*)corto_packageAssign((corto_package*)corto_ptr_new(corto_package_o)) : NULL
#define corto_packageUnset(_this) _this ? corto_ptr_free(_this, corto_package_o), 0 : 0; _this = NULL;
...
/* parameter */
CORTO_EXPORT corto_parameter* _corto_parameterCreate(const char * name, corto_type type, corto_inout inout, bool passByReference);
...
CORTO_EXPORT corto_parameter* _corto_parameterCreateChild(corto_object _parent, const char *_id, const char * name, corto_type type, corto_inout inout, bool passByReference);
...
CORTO_EXPORT corto_int16 _corto_parameterUpdate(corto_parameter* _this, const char * name, corto_type type, corto_inout inout, bool passByReference);
...
CORTO_EXPORT corto_parameter* _corto_parameterDeclareChild(corto_object _parent, const char *_id);
...
CORTO_EXPORT corto_int16 _corto_parameterDefine(corto_parameter* _this, const char * name, corto_type type, corto_inout inout, bool passByReference);
...
CORTO_EXPORT corto_parameter* _corto_parameterAssign(corto_parameter* _this, const char * name, corto_type type, corto_inout inout, bool passByReference);
#define corto_parameter__optional_NotSet NULL
#define corto_parameter__optional_Set(name, type, inout, passByReference) (corto_parameter*)corto_parameterAssign((corto_parameter*)corto_ptr_new(corto_parameter_o), name, type, inout, passByReference)
#define corto_parameter__optional_SetCond(cond, name, type, inout, passByReference) cond ? (corto_parameter*)corto_parameterAssign((corto_parameter*)corto_ptr_new(corto_parameter_o), name, type, inout, passByReference) : NULL
...
CORTO_EXPORT corto_parameterseq* _corto_parameterseqCreateChild(corto_object _parent, const char *_id, corto_uint32 length, corto_parameter* elements);
...
CORTO_EXPORT corto_parameterseq* _corto_parameterseqDeclareChild(corto_object _parent, const char *_id);
...
#define corto_parameterseq__optional_Set(length, elements) (corto_parameterseq*)corto_parameterseqAssign((corto_parameterseq*)corto_ptr_new(corto_parameterseq_o), length, elements)
#define corto_parameterseq__optional_SetCond(cond, length, elements) cond ? (corto_parameterseq*)corto_parameterseqAssign((corto_parameterseq*)corto_ptr_new(corto_parameterseq_o), length, elements) : NULL
...
/* post_action */
CORTO_EXPORT corto_post_action* _corto_post_actionCreate(corto_object instance, corto_function procedure);
#define corto_post_actionCreate(instance, procedure) _corto_post_actionCreate(instance, corto_function(procedure))
#define corto_post_actionCreate_auto(_id, instance, procedure) corto_post_action* _id = corto_post_actionCreate(instance, procedure); (void)_id
CORTO_EXPORT corto_post_action* _corto_post_actionCreateChild(corto_object _parent, const char *_id, corto_object instance, corto_function procedure);
#define corto_post_actionCreateChild(_parent, _id, instance, procedure) _corto_post_actionCreateChild(_parent, _id, instance, corto_function(procedure))
#define corto_post_actionCreateChild_auto(_parent, _id, instance, procedure) corto_post_action* _id = corto_post_actionCreateChild(_parent, #_id, instance, procedure); (void)_id
CORTO_EXPORT corto_int16 _corto_post_actionUpdate(corto_post_action* _this, corto_object instance, corto_function procedure);
#define corto_post_actionUpdate(_this, instance, procedure) _corto_post_actionUpdate(corto_post_action(_this), instance, corto_function(procedure))

CORTO_EXPORT corto_post_action* _corto_post_actionDeclare(void);
#define corto_post_actionDeclare() _corto_post_actionDeclare()
#define corto_post_actionDeclare_auto(_id) corto_post_action* _id = corto_post_actionDeclare(); (void)_id
CORTO_EXPORT corto_post_action* _corto_post_actionDeclareChild(corto_object _parent, const char *_id);
#define corto_post_actionDeclareChild(_parent, _id) _corto_post_actionDeclareChild(_parent, _id)
#define corto_post_actionDeclareChild_auto(_parent, _id) corto_post_action* _id = corto_post_actionDeclareChild(_parent, #_id); (void)_id
CORTO_EXPORT corto_int16 _corto_post_actionDefine(corto_post_action* _this, corto_object instance, corto_function procedure);
#define corto_post_actionDefine(_this, instance, procedure) _corto_post_actionDefine(corto_post_action(_this), instance, corto_function(procedure))
CORTO_EXPORT corto_post_action* _corto_post_actionAssign(corto_post_action* _this, corto_object instance, corto_function procedure);
#define corto_post_action__optional_NotSet NULL
#define corto_post_action__optional_Set(instance, procedure) (corto_post_action*)corto_post_actionAssign((corto_post_action*)corto_ptr_new(corto_post_action_o), instance, procedure)
#define corto_post_action__optional_SetCond(cond, instance, procedure) cond ? (corto_post_action*)corto_post_actionAssign((corto_post_action*)corto_ptr_new(corto_post_action_o), instance, procedure) : NULL
#define corto_post_actionUnset(_this) _this ? corto_ptr_free(_this, corto_post_action_o), 0 : 0; _this = NULL;
#define corto_post_actionAssign(_this, instance, procedure) _corto_post_actionAssign(_this, instance, corto_function(procedure))
#define corto_post_actionSet(_this, instance, procedure) _this = _this ? _this : (corto_post_action*)corto_ptr_new(corto_post_action_o); _corto_post_actionAssign(_this, instance, corto_function(procedure))

corto_int16 corto_post_actionCall(corto_post_action *_delegate);
#define corto_post_actionInitC_auto(d, callback) corto_post_action d; corto_post_actionInitC(&d, callback)
CORTO_EXPORT corto_int16 corto_post_actionInitC(corto_post_action *d, corto_void ___ (*callback)(void));
#define corto_post_actionInitCInstance_auto(d, instance, callback)corto_post_action d; corto_post_actionInitCInstance(&d, instance, callback)
CORTO_EXPORT corto_int16 corto_post_actionInitCInstance(corto_post_action *d, corto_object instance, corto_void ___ (*callback)(corto_object));
/* pre_action */
CORTO_EXPORT corto_pre_action* _corto_pre_actionCreate(corto_object instance, corto_function procedure);
#define corto_pre_actionCreate(instance, procedure) _corto_pre_actionCreate(instance, corto_function(procedure))
#define corto_pre_actionCreate_auto(_id, instance, procedure) corto_pre_action* _id = corto_pre_actionCreate(instance, procedure); (void)_id
CORTO_EXPORT corto_pre_action* _corto_pre_actionCreateChild(corto_object _parent, const char *_id, corto_object instance, corto_function procedure);
#define corto_pre_actionCreateChild(_parent, _id, instance, procedure) _corto_pre_actionCreateChild(_parent, _id, instance, corto_function(procedure))
#define corto_pre_actionCreateChild_auto(_parent, _id, instance, procedure) corto_pre_action* _id = corto_pre_actionCreateChild(_parent, #_id, instance, procedure); (void)_id
CORTO_EXPORT corto_int16 _corto_pre_actionUpdate(corto_pre_action* _this, corto_object instance, corto_function procedure);
#define corto_pre_actionUpdate(_this, instance, procedure) _corto_pre_actionUpdate(corto_pre_action(_this), instance, corto_function(procedure))

CORTO_EXPORT corto_pre_action* _corto_pre_actionDeclare(void);
#define corto_pre_actionDeclare() _corto_pre_actionDeclare()
#define corto_pre_actionDeclare_auto(_id) corto_pre_action* _id = corto_pre_actionDeclare(); (void)_id
CORTO_EXPORT corto_pre_action* _corto_pre_actionDeclareChild(corto_object _parent, const char *_id);
#define corto_pre_actionDeclareChild(_parent, _id) _corto_pre_actionDeclareChild(_parent, _id)
#define corto_pre_actionDeclareChild_auto(_parent, _id) corto_pre_action* _id = corto_pre_actionDeclareChild(_parent, #_id); (void)_id
CORTO_EXPORT corto_int16 _corto_pre_actionDefine(corto_pre_action* _this, corto_object instance, corto_function procedure);
#define corto_pre_actionDefine(_this, instance, procedure) _corto_pre_actionDefine(corto_pre_action(_this), instance, corto_function(procedure))
CORTO_EXPORT corto_pre_action* _corto_pre_actionAssign(corto_pre_action* _this, corto_object instance, corto_function procedure);
#define corto_pre_action__optional_NotSet NULL
#define corto_pre_action__optional_Set(instance, procedure) (corto_pre_action*)corto_pre_actionAssign((corto_pre_action*)corto_ptr_new(corto_pre_action_o), instance, procedure)
#define corto_pre_action__optional_SetCond(cond, instance, procedure) cond ? (corto_pre_action*)corto_pre_actionAssign((corto_pre_action*)corto_ptr_new(corto_pre_action_o), instance, procedure) : NULL
#define corto_pre_actionUnset(_this) _this ? corto_ptr_free(_this, corto_pre_action_o), 0 : 0; _this = NULL;
#define corto_pre_actionAssign(_this, instance, procedure) _corto_pre_actionAssign(_this, instance, corto_function(procedure))
#define corto_pre_actionSet(_this, instance, procedure) _this = _this ? _this : (corto_pre_action*)corto_ptr_new(corto_pre_action_o); _corto_pre_actionAssign(_this, instance, corto_function(procedure))

corto_int16 corto_pre_actionCall(corto_pre_action *_delegate, corto_int16* _result);
#define corto_pre_actionInitC_auto(d, callback) corto_pre_action d; corto_pre_actionInitC(&d, callback)
CORTO_EXPORT corto_int16 corto_pre_actionInitC(corto_pre_action *d, corto_int16 ___ (*callback)(void));
#define corto_pre_actionInitCInstance_auto(d, instance, callback)corto_pre_action d; corto_pre_actionInitCInstance(&d, instance, callback)
CORTO_EXPORT corto_int16 corto_pre_actionInitCInstance(corto_pre_action *d, corto_object instance, corto_int16 ___ (*callback)(corto_object));
/* primitive */
...
CORTO_EXPORT corto_primitive _corto_primitiveCreateChild(corto_object _parent, const char *_id, corto_width width);
...
CORTO_EXPORT corto_primitive _corto_primitiveDeclareChild(corto_object _parent, const char *_id);
...
#define corto_primitive__optional_Set(width) (corto_primitive*)corto_primitiveAssign((corto_primitive*)corto_ptr_new(corto_primitive_o), width)
#define corto_primitive__optional_SetCond(cond, width) cond ? (corto_primitive*)corto_primitiveAssign((corto_primitive*)corto_ptr_new(corto_primitive_o), width) : NULL
...
CORTO_EXPORT corto_primitiveKind* _corto_primitiveKindCreateChild(corto_object _parent, const char *_id, corto_primitiveKind value);
...
CORTO_EXPORT corto_primitiveKind* _corto_primitiveKindDeclareChild(corto_object _parent, const char *_id);
...
#define corto_primitiveKind__optional_Set(value) (corto_primitiveKind*)corto_primitiveKindAssign((corto_primitiveKind*)corto_ptr_new(corto_primitiveKind_o), value)
#define corto_primitiveKind__optional_SetCond(cond, value) cond ? (corto_primitiveKind*)corto_primitiveKindAssign((corto_primitiveKind*)corto_ptr_new(corto_primitiveKind_o), value) : NULL
...
CORTO_EXPORT corto_procedure _corto_procedureCreateChild(corto_object _parent, const char *_id, bool hasThis, corto_type thisType);
...
CORTO_EXPORT corto_procedure _corto_procedureDeclareChild(corto_object _parent, const char *_id);
...
#define corto_procedure__optional_Set(hasThis, thisType) (corto_procedure*)corto_procedureAssign((corto_procedure*)corto_ptr_new(corto_procedure_o), hasThis, thisType)
#define corto_procedure__optional_SetCond(cond, hasThis, thisType) cond ? (corto_procedure*)corto_procedureAssign((corto_procedure*)corto_ptr_new(corto_procedure_o), hasThis, thisType) : NULL
...
CORTO_EXPORT corto_sequence _corto_sequenceCreateChild(corto_object _parent, const char *_id, corto_type elementType, uint32_t max);
...
CORTO_EXPORT corto_sequence _corto_sequenceDeclareChild(corto_object _parent, const char *_id);
...
#define corto_sequence__optional_Set(elementType, max) (corto_sequence*)corto_sequenceAssign((corto_sequence*)corto_ptr_new(corto_sequence_o), elementType, max)
#define corto_sequence__optional_SetCond(cond, elementType, max) cond ? (corto_sequence*)corto_sequenceAssign((corto_sequence*)corto_ptr_new(corto_sequence_o), elementType, max) : NULL
...
CORTO_EXPORT corto_state* _corto_stateCreateChild(corto_object _parent, const char *_id, corto_state value);
...
CORTO_EXPORT corto_state* _corto_stateDeclareChild(corto_object _parent, const char *_id);
...
#define corto_state__optional_Set(value) (corto_state*)corto_stateAssign((corto_state*)corto_ptr_new(corto_state_o), value)
#define corto_state__optional_SetCond(cond, value) cond ? (corto_state*)corto_stateAssign((corto_state*)corto_ptr_new(corto_state_o), value) : NULL
...
CORTO_EXPORT corto_string* _corto_stringCreateChild(corto_object _parent, const char *_id, corto_string value);
...
CORTO_EXPORT corto_string* _corto_stringDeclareChild(corto_object _parent, const char *_id);
...
#define corto_string__optional_Set(value) (corto_string*)corto_stringAssign((corto_string*)corto_ptr_new(corto_string_o), value)
#define corto_string__optional_SetCond(cond, value) cond ? (corto_string*)corto_stringAssign((corto_string*)corto_ptr_new(corto_string_o), value) : NULL
...
CORTO_EXPORT corto_stringlist* _corto_stringlistCreateChild(corto_object _parent, const char *_id, corto_uint32 length, corto_string* elements);
...
CORTO_EXPORT corto_stringlist* _corto_stringlistDeclareChild(corto_object _parent, const char *_id);
...
#define corto_stringlist__optional_Set(length, elements) (corto_stringlist*)corto_stringlistAssign((corto_stringlist*)corto_ptr_new(corto_stringlist_o), length, elements)
#define corto_stringlist__optional_SetCond(cond, length, elements) cond ? (corto_stringlist*)corto_stringlistAssign((corto_stringlist*)corto_ptr_new(corto_stringlist_o), length, elements) : NULL
...
CORTO_EXPORT corto_stringseq* _corto_stringseqCreateChild(corto_object _parent, const char *_id, corto_uint32 length, corto_string* elements);
...
CORTO_EXPORT corto_stringseq* _corto_stringseqDeclareChild(corto_object _parent, const char *_id);
...
#define corto_stringseq__optional_Set(length, elements) (corto_stringseq*)corto_stringseqAssign((corto_stringseq*)corto_ptr_new(corto_stringseq_o), length, elements)
#define corto_stringseq__optional_SetCond(cond, length, elements) cond ? (corto_stringseq*)corto_stringseqAssign((corto_stringseq*)corto_ptr_new(corto_stringseq_o), length, elements) : NULL
...
CORTO_EXPORT corto_struct _corto_structCreateChild(corto_object _parent, const char *_id, corto_interface base, corto_modifier baseAccess);
...
CORTO_EXPORT corto_struct _corto_structDeclareChild(corto_object _parent, const char *_id);
...
#define corto_struct__optional_Set(base, baseAccess) (corto_struct*)corto_structAssign((corto_struct*)corto_ptr_new(corto_struct_o), base, baseAccess)
#define corto_struct__optional_SetCond(cond, base, baseAccess) cond ? (corto_struct*)corto_structAssign((corto_struct*)corto_ptr_new(corto_struct_o), base, baseAccess) : NULL
...
/* table */
CORTO_EXPORT corto_table _corto_tableCreate(corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_EXPORT corto_table _corto_tableCreateChild(corto_object _parent, const char *_id, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_EXPORT corto_int16 _corto_tableUpdate(corto_table _this, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_EXPORT corto_table _corto_tableDeclareChild(corto_object _parent, const char *_id);
...
CORTO_EXPORT corto_int16 _corto_tableDefine(corto_table _this, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_EXPORT corto_table _corto_tableAssign(corto_table _this, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value);
#define corto_table__optional_NotSet NULL
#define corto_table__optional_Set(base, baseAccess, implements, type, value) (corto_table*)corto_tableAssign((corto_table*)corto_ptr_new(corto_table_o), base, baseAccess, implements, type, value)
#define corto_table__optional_SetCond(cond, base, baseAccess, implements, type, value) cond ? (corto_table*)corto_tableAssign((corto_table*)corto_ptr_new(corto_table_o), base, baseAccess, implements, type, value) : NULL
...
CORTO_EXPORT corto_tableinstance _corto_tableinstanceCreateChild(corto_object _parent, const char *_id, corto_struct type);
...
CORTO_EXPORT corto_tableinstance _corto_tableinstanceDeclareChild(corto_object _parent, const char *_id);
...
#define corto_tableinstance__optional_Set(type) (corto_tableinstance*)corto_tableinstanceAssign((corto_tableinstance*)corto_ptr_new(corto_tableinstance_o), type)
#define corto_tableinstance__optional_SetCond(cond, type) cond ? (corto_tableinstance*)corto_tableinstanceAssign((corto_tableinstance*)corto_ptr_new(corto_tableinstance_o), type) : NULL
...
CORTO_EXPORT corto_target _corto_targetCreateChild(corto_object _parent, const char *_id, corto_type type);
...
CORTO_EXPORT corto_target _corto_targetDeclareChild(corto_object _parent, const char *_id);
...
#define corto_target__optional_Set(type) (corto_target*)corto_targetAssign((corto_target*)corto_ptr_new(corto_target_o), type)
#define corto_target__optional_SetCond(cond, type) cond ? (corto_target*)corto_targetAssign((corto_target*)corto_ptr_new(corto_target_o), type) : NULL
...
CORTO_EXPORT corto_text _corto_textCreateChild(corto_object _parent, const char *_id, corto_width charWidth, uint64_t length);
...
CORTO_EXPORT corto_text _corto_textDeclareChild(corto_object _parent, const char *_id);
...
#define corto_text__optional_Set(charWidth, length) (corto_text*)corto_textAssign((corto_text*)corto_ptr_new(corto_text_o), charWidth, length)
#define corto_text__optional_SetCond(cond, charWidth, length) cond ? (corto_text*)corto_textAssign((corto_text*)corto_ptr_new(corto_text_o), charWidth, length) : NULL
...
CORTO_EXPORT corto_tool _corto_toolCreateChild(corto_object _parent, const char *_id);
...
CORTO_EXPORT corto_tool _corto_toolDeclareChild(corto_object _parent, const char *_id);
...
#define corto_tool__optional_Set() (corto_tool*)corto_toolAssign((corto_tool*)corto_ptr_new(corto_tool_o))
#define corto_tool__optional_SetCond(cond) cond ? (corto_tool*)corto_toolAssign((corto_tool*)corto_ptr_new(corto_tool_o)) : NULL
...
CORTO_EXPORT corto_typeKind* _corto_typeKindCreateChild(corto_object _parent, const char *_id, corto_typeKind value);
...
CORTO_EXPORT corto_typeKind* _corto_typeKindDeclareChild(corto_object _parent, const char *_id);
...
#define corto_typeKind__optional_Set(value) (corto_typeKind*)corto_typeKindAssign((corto_typeKind*)corto_ptr_new(corto_typeKind_o), value)
#define corto_typeKind__optional_SetCond(cond, value) cond ? (corto_typeKind*)corto_typeKindAssign((corto_typeKind*)corto_ptr_new(corto_typeKind_o), value) : NULL
...
CORTO_EXPORT corto_typeOptions* _corto_typeOptionsCreateChild(corto_object _parent, const char *_id, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType);
...
CORTO_EXPORT corto_typeOptions* _corto_typeOptionsDeclareChild(corto_object _parent, const char *_id);
...
#define corto_typeOptions__optional_Set(parentType, parentState, defaultType, defaultProcedureType) (corto_typeOptions*)corto_typeOptionsAssign((corto_typeOptions*)corto_ptr_new(corto_typeOptions_o), parentType, parentState, defaultType, defaultProcedureType)
#define corto_typeOptions__optional_SetCond(cond, parentType, parentState, defaultType, defaultProcedureType) cond ? (corto_typeOptions*)corto_typeOptionsAssign((corto_typeOptions*)corto_ptr_new(corto_typeOptions_o), parentType, parentState, defaultType, defaultProcedureType) : NULL
...
CORTO_EXPORT corto_uint _corto_uintCreateChild(corto_object _parent, const char *_id, corto_width width, uint64_t min, uint64_t max);
...
CORTO_EXPORT corto_uint _corto_uintDeclareChild(corto_object _parent, const char *_id);
...
#define corto_uint__optional_Set(width, min, max) (corto_uint*)corto_uintAssign((corto_uint*)corto_ptr_new(corto_uint_o), width, min, max)
#define corto_uint__optional_SetCond(cond, width, min, max) cond ? (corto_uint*)corto_uintAssign((corto_uint*)corto_ptr_new(corto_uint_o), width, min, max) : NULL
...
CORTO_EXPORT uint16_t* _corto_uint16CreateChild(corto_object _parent, const char *_id, uint16_t value);
...
CORTO_EXPORT uint16_t* _corto_uint16DeclareChild(corto_object _parent, const char *_id);
...
#define corto_uint16__optional_Set(value) (corto_uint16*)corto_uint16Assign((corto_uint16*)corto_ptr_new(corto_uint16_o), value)
#define corto_uint16__optional_SetCond(cond, value) cond ? (corto_uint16*)corto_uint16Assign((corto_uint16*)corto_ptr_new(corto_uint16_o), value) : NULL
...
CORTO_EXPORT uint32_t* _corto_uint32CreateChild(corto_object _parent, const char *_id, uint32_t value);
...
CORTO_EXPORT uint32_t* _corto_uint32DeclareChild(corto_object _parent, const char *_id);
...
#define corto_uint32__optional_Set(value) (corto_uint32*)corto_uint32Assign((corto_uint32*)corto_ptr_new(corto_uint32_o), value)
#define corto_uint32__optional_SetCond(cond, value) cond ? (corto_uint32*)corto_uint32Assign((corto_uint32*)corto_ptr_new(corto_uint32_o), value) : NULL
...
CORTO_EXPORT uint64_t* _corto_uint64CreateChild(corto_object _parent, const char *_id, uint64_t value);
...
CORTO_EXPORT uint64_t* _corto_uint64DeclareChild(corto_object _parent, const char *_id);
...
#define corto_uint64__optional_Set(value) (corto_uint64*)corto_uint64Assign((corto_uint64*)corto_ptr_new(corto_uint64_o), value)
#define corto_uint64__optional_SetCond(cond, value) cond ? (corto_uint64*)corto_uint64Assign((corto_uint64*)corto_ptr_new(corto_uint64_o), value) : NULL
...
CORTO_EXPORT uint8_t* _corto_uint8CreateChild(corto_object _parent, const char *_id, uint8_t value);
...
CORTO_EXPORT uint8_t* _corto_uint8DeclareChild(corto_object _parent, const char *_id);
...
#define corto_uint8__optional_Set(value) (corto_uint8*)corto_uint8Assign((corto_uint8*)corto_ptr_new(corto_uint8_o), value)
#define corto_uint8__optional_SetCond(cond, value) cond ? (corto_uint8*)corto_uint8Assign((corto_uint8*)corto_ptr_new(corto_uint8_o), value) : NULL
...
CORTO_EXPORT corto_union _corto_unionCreateChild(corto_object _parent, const char *_id, corto_type discriminator);
...
CORTO_EXPORT corto_union _corto_unionDeclareChild(corto_object _parent, const char *_id);
...
#define corto_union__optional_Set(discriminator) (corto_union*)corto_unionAssign((corto_union*)corto_ptr_new(corto_union_o), discriminator)
#define corto_union__optional_SetCond(cond, discriminator) cond ? (corto_union*)corto_unionAssign((corto_union*)corto_ptr_new(corto_union_o), discriminator) : NULL
...
/* unit */
CORTO_EXPORT corto_unit _corto_unitCreate(corto_quantity quantity, const char * symbol, const char * conversion, corto_type type);
...
CORTO_EXPORT corto_unit _corto_unitCreateChild(corto_object _parent, const char *_id, corto_quantity quantity, const char * symbol, const char * conversion, corto_type type);
...
CORTO_EXPORT corto_int16 _corto_unitUpdate(corto_unit _this, corto_quantity quantity, const char * symbol, const char * conversion, corto_type type);
...
CORTO_EXPORT corto_unit _corto_unitDeclareChild(corto_object _parent, const char *_id);
...
CORTO_EXPORT corto_int16 _corto_unitDefine(corto_unit _this, corto_quantity quantity, const char * symbol, const char * conversion, corto_type type);
...
CORTO_EXPORT corto_unit _corto_unitAssign(corto_unit _this, corto_quantity quantity, const char * symbol, const char * conversion, corto_type type);
#define corto_unit__optional_NotSet NULL
#define corto_unit__optional_Set(quantity, symbol, conversion, type) (corto_unit*)corto_unitAssign((corto_unit*)corto_ptr_new(corto_unit_o), quantity, symbol, conversion, type)
#define corto_unit__optional_SetCond(cond, quantity, symbol, conversion, type) cond ? (corto_unit*)corto_unitAssign((corto_unit*)corto_ptr_new(corto_unit_o), quantity, symbol, conversion, type) : NULL
...
/* unknown */
CORTO_EXPORT void* _corto_unknownCreate(void);
#define corto_unknownCreate() _corto_unknownCreate()
#define corto_unknownCreate_auto(_id) void* _id = corto_unknownCreate(); (void)_id
CORTO_EXPORT void* _corto_unknownCreateChild(corto_object _parent, const char *_id);
#define corto_unknownCreateChild(_parent, _id) _corto_unknownCreateChild(_parent, _id)
#define corto_unknownCreateChild_auto(_parent, _id) void* _id = corto_unknownCreateChild(_parent, #_id); (void)_id
CORTO_EXPORT corto_int16 _corto_unknownUpdate(void* _this);
#define corto_unknownUpdate(_this) _corto_unknownUpdate(corto_unknown(_this))

/* verbatim */
CORTO_EXPORT corto_verbatim _corto_verbatimCreate(const char * contentType);
...
CORTO_EXPORT corto_verbatim _corto_verbatimCreateChild(corto_object _parent, const char *_id, const char * contentType);
...
CORTO_EXPORT corto_int16 _corto_verbatimUpdate(corto_verbatim _this, const char * contentType);
...
CORTO_EXPORT corto_verbatim _corto_verbatimDeclareChild(corto_object _parent, const char *_id);
...
CORTO_EXPORT corto_int16 _corto_verbatimDefine(corto_verbatim _this, const char * contentType);
#define corto_verbatimDefine(_this, contentType) _corto_verbatimDefine(corto_verbatim(_this), contentType)
CORTO_EXPORT corto_verbatim _corto_verbatimAssign(corto_verbatim _this, const char * contentType);
#define corto_verbatim__optional_NotSet NULL
#define corto_verbatim__optional_Set(contentType) (corto_verbatim*)corto_verbatimAssign((corto_verbatim*)corto_ptr_new(corto_verbatim_o), contentType)
#define corto_verbatim__optional_SetCond(cond, contentType) cond ? (corto_verbatim*)corto_verbatimAssign((corto_verbatim*)corto_ptr_new(corto_verbatim_o), contentType) : NULL
...
CORTO_EXPORT void* _corto_voidCreateChild(corto_object _parent, const char *_id);
...
CORTO_EXPORT corto_width* _corto_widthCreateChild(corto_object _parent, const char *_id, corto_width value);
...
CORTO_EXPORT corto_width* _corto_widthDeclareChild(corto_object _parent, const char *_id);
...
#define corto_width__optional_Set(value) (corto_width*)corto_widthAssign((corto_width*)corto_ptr_new(corto_width_o), value)
#define corto_width__optional_SetCond(cond, value) cond ? (corto_width*)corto_widthAssign((corto_width*)corto_ptr_new(corto_width_o), value) : NULL
...
CORTO_EXPORT uintptr_t* _corto_wordCreateChild(corto_object _parent, const char *_id, uintptr_t value);
...
CORTO_EXPORT uintptr_t* _corto_wordDeclareChild(corto_object _parent, const char *_id);
...
#define corto_word__optional_Set(value) (corto_word*)corto_wordAssign((corto_word*)corto_ptr_new(corto_word_o), value)
#define corto_word__optional_SetCond(cond, value) cond ? (corto_word*)corto_wordAssign((corto_word*)corto_ptr_new(corto_word_o), value) : NULL
...
CORTO_EXPORT corto_wordseq* _corto_wordseqCreateChild(corto_object _parent, const char *_id, corto_uint32 length, uintptr_t* elements);
...
CORTO_EXPORT corto_wordseq* _corto_wordseqDeclareChild(corto_object _parent, const char *_id);
...
#define corto_wordseq__optional_Set(length, elements) (corto_wordseq*)corto_wordseqAssign((corto_wordseq*)corto_ptr_new(corto_wordseq_o), length, elements)
#define corto_wordseq__optional_SetCond(cond, length, elements) cond ? (corto_wordseq*)corto_wordseqAssign((corto_wordseq*)corto_ptr_new(corto_wordseq_o), length, elements) : NULL
...
CORTO_EXPORT void corto_int32seqResize(corto_int32seq *seq, corto_uint32 length);
...
CORTO_EXPORT void corto_interfaceseqResize(corto_interfaceseq *seq, corto_uint32 length);
...
CORTO_EXPORT void corto_interfaceVectorseqResize(corto_interfaceVectorseq *seq, corto_uint32 length);
...
CORTO_EXPORT void corto_objectseqResize(corto_objectseq *seq, corto_uint32 length);
...
CORTO_EXPORT void corto_parameterseqResize(corto_parameterseq *seq, corto_uint32 length);
...
CORTO_EXPORT void corto_wordseqResize(corto_wordseq *seq, corto_uint32 length);
