...
CORTO_EXPORT corto_case _corto_caseCreateChild(corto_object _parent, corto_string _id, corto_int32seq discriminator, corto_type type, corto_modifier modifiers);
...
CORTO_EXPORT corto_container _corto_containerCreateChild(corto_object _parent, corto_string _id, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_EXPORT corto_leaf _corto_leafCreateChild(corto_object _parent, corto_string _id, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_EXPORT corto_parameter* _corto_parameterCreateChild(corto_object _parent, corto_string _id, const char * name, corto_type type, corto_inout inout, bool passByReference);
...
CORTO_EXPORT corto_quantity _corto_quantityCreateChild(corto_object _parent, corto_string _id, const char * description);
...
CORTO_EXPORT corto_table _corto_tableCreateChild(corto_object _parent, corto_string _id, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type type, const char * value);
...
CORTO_EXPORT corto_unit _corto_unitCreateChild(corto_object _parent, corto_string _id, corto_quantity quantity, const char * symbol, const char * conversion, corto_type type);
...
CORTO_EXPORT void* _corto_unknownCreateChild(corto_object _parent, corto_string _id);
...
CORTO_EXPORT corto_verbatim _corto_verbatimCreateChild(corto_object _parent, corto_string _id, const char * contentType);
