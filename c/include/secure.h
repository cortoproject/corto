...
/* /corto/secure/lock */
CORTO_EXPORT corto_secure_lock _corto_secure_lock__create(corto_object _parent, const char *_id, corto_query* query, int16_t priority);
...
CORTO_EXPORT corto_int16 _corto_secure_lock__update(corto_secure_lock _this, corto_query* query, int16_t priority);
#define corto_secure_lock__update(_this, query, priority) _corto_secure_lock__update(corto_secure_lock(_this), query, priority)
CORTO_EXPORT corto_secure_lock _corto_secure_lock__assign(corto_secure_lock _this, corto_query* query, int16_t priority);
