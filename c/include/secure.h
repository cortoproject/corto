...
CORTO_EXPORT corto_secure_accessKind* _corto_secure_accessKindCreateChild(corto_object _parent, const char *_id, corto_secure_accessKind value);
...
CORTO_EXPORT corto_secure_accessKind* _corto_secure_accessKindDeclareChild(corto_object _parent, const char *_id);
...
CORTO_EXPORT corto_secure_actionKind* _corto_secure_actionKindCreateChild(corto_object _parent, const char *_id, corto_secure_actionKind value);
...
CORTO_EXPORT corto_secure_actionKind* _corto_secure_actionKindDeclareChild(corto_object _parent, const char *_id);
...
CORTO_EXPORT corto_secure_key _corto_secure_keyCreateChild(corto_object _parent, const char *_id);
...
CORTO_EXPORT corto_secure_key _corto_secure_keyDeclareChild(corto_object _parent, const char *_id);
...
CORTO_EXPORT corto_secure_lock _corto_secure_lockCreateChild(corto_object _parent, const char *_id, const char * mount, const char * expr, int16_t priority);
...
CORTO_EXPORT corto_secure_lock _corto_secure_lockDeclareChild(corto_object _parent, const char *_id);
