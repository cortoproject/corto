...
/* -- Type casting -- */
#define corto_typeKind(o) ((corto_typeKind*)ut_assert_type((corto_type)corto_typeKind_o, o))
#define corto_bool(o) ((bool*)ut_assert_type((corto_type)corto_bool_o, o))
#define corto_attr(o) ((corto_attr*)ut_assert_type((corto_type)corto_attr_o, o))
#define corto_state(o) ((corto_state*)ut_assert_type((corto_type)corto_state_o, o))
#define corto_uint16(o) ((uint16_t*)ut_assert_type((corto_type)corto_uint16_o, o))
#define corto_uint32(o) ((uint32_t*)ut_assert_type((corto_type)corto_uint32_o, o))
#define corto_object(o) ((corto_object)o)
#define corto_objectseq(o) ((corto_objectseq*)ut_assert_type((corto_type)corto_objectseq_o, o))
#define corto_word(o) ((uintptr_t*)ut_assert_type((corto_type)corto_word_o, o))
#define corto_string(o) ((corto_string*)ut_assert_type((corto_type)corto_string_o, o))
#define corto_inout(o) ((corto_inout*)ut_assert_type((corto_type)corto_inout_o, o))
#define corto_parameter(o) ((corto_parameter*)ut_assert_type((corto_type)corto_parameter_o, o))
#define corto_parameterseq(o) ((corto_parameterseq*)ut_assert_type((corto_type)corto_parameterseq_o, o))
#define corto_function(o) ((corto_function)ut_assert_type((corto_type)corto_function_o, o))
#define corto_delegatedata(o) ((corto_delegatedata*)ut_assert_type((corto_type)corto_delegatedata_o, o))
#define corto_pre_action(o) ((corto_pre_action*)ut_assert_type((corto_type)corto_pre_action_o, o))
#define corto_post_action(o) ((corto_post_action*)ut_assert_type((corto_type)corto_post_action_o, o))
#define corto_name_action(o) ((corto_name_action*)ut_assert_type((corto_type)corto_name_action_o, o))
#define corto_type(o) ((corto_type)ut_assert_type((corto_type)corto_type_o, o))
#define corto_modifierMask(o) ((corto_modifierMask*)ut_assert_type((corto_type)corto_modifierMask_o, o))
#define corto_quantity(o) ((corto_quantity)ut_assert_type((corto_type)corto_quantity_o, o))
#define corto_unit(o) ((corto_unit)ut_assert_type((corto_type)corto_unit_o, o))
#define corto_int8(o) ((int8_t*)ut_assert_type((corto_type)corto_int8_o, o))
#define corto_tag(o) ((corto_tag)ut_assert_type((corto_type)corto_tag_o, o))
#define corto_taglist(o) ((corto_taglist*)ut_assert_type((corto_type)corto_taglist_o, o))
#define corto_member(o) ((corto_member)ut_assert_type((corto_type)corto_member_o, o))
#define corto_alias(o) ((corto_alias)ut_assert_type((corto_type)corto_alias_o, o))
#define corto_any(o) ((corto_any*)ut_assert_type((corto_type)corto_any_o, o))
#define corto_stringlist(o) ((corto_stringlist*)ut_assert_type((corto_type)corto_stringlist_o, o))
#define corto_package(o) ((corto_package)ut_assert_type((corto_type)corto_package_o, o))
#define corto_application(o) ((corto_application)ut_assert_type((corto_type)corto_application_o, o))
#define corto_collectionKind(o) ((corto_collectionKind*)ut_assert_type((corto_type)corto_collectionKind_o, o))
#define corto_collection(o) ((corto_collection)ut_assert_type((corto_type)corto_collection_o, o))
#define corto_array(o) ((corto_array)ut_assert_type((corto_type)corto_array_o, o))
#define corto_primitiveKind(o) ((corto_primitiveKind*)ut_assert_type((corto_type)corto_primitiveKind_o, o))
#define corto_width(o) ((corto_width*)ut_assert_type((corto_type)corto_width_o, o))
#define corto_uint8(o) ((uint8_t*)ut_assert_type((corto_type)corto_uint8_o, o))
#define corto_primitive(o) ((corto_primitive)ut_assert_type((corto_type)corto_primitive_o, o))
#define corto_binary(o) ((corto_binary)ut_assert_type((corto_type)corto_binary_o, o))
#define corto_enum(o) ((corto_enum)ut_assert_type((corto_type)corto_enum_o, o))
#define corto_bitmask(o) ((corto_bitmask)ut_assert_type((corto_type)corto_bitmask_o, o))
#define corto_boolean(o) ((corto_boolean)ut_assert_type((corto_type)corto_boolean_o, o))
#define corto_int32(o) ((int32_t*)ut_assert_type((corto_type)corto_int32_o, o))
#define corto_int32seq(o) ((corto_int32seq*)ut_assert_type((corto_type)corto_int32seq_o, o))
#define corto_case(o) ((corto_case)ut_assert_type((corto_type)corto_case_o, o))
#define corto_char(o) ((char*)ut_assert_type((corto_type)corto_char_o, o))
#define corto_character(o) ((corto_character)ut_assert_type((corto_type)corto_character_o, o))
#define corto_compositeKind(o) ((corto_compositeKind*)ut_assert_type((corto_type)corto_compositeKind_o, o))
#define corto_interface(o) ((corto_interface)ut_assert_type((corto_type)corto_interface_o, o))
#define corto_stringseq(o) ((corto_stringseq*)ut_assert_type((corto_type)corto_stringseq_o, o))
#define corto_struct(o) ((corto_struct)ut_assert_type((corto_type)corto_struct_o, o))
#define corto_interfaceseq(o) ((corto_interfaceseq*)ut_assert_type((corto_type)corto_interfaceseq_o, o))
#define corto_interfaceVector(o) ((corto_interfaceVector*)ut_assert_type((corto_type)corto_interfaceVector_o, o))
#define corto_interfaceVectorseq(o) ((corto_interfaceVectorseq*)ut_assert_type((corto_type)corto_interfaceVectorseq_o, o))
#define corto_class(o) ((corto_class)ut_assert_type((corto_type)corto_class_o, o))
#define corto_constant(o) ((int32_t*)ut_assert_type((corto_type)corto_constant_o, o))
#define corto_container(o) ((corto_container)ut_assert_type((corto_type)corto_container_o, o))
#define corto_default(o) ((corto_default)ut_assert_type((corto_type)corto_default_o, o))
#define corto_delegate(o) ((corto_delegate)ut_assert_type((corto_type)corto_delegate_o, o))
#define corto_equalityKind(o) ((corto_equalityKind*)ut_assert_type((corto_type)corto_equalityKind_o, o))
#define corto_float64(o) ((double*)ut_assert_type((corto_type)corto_float64_o, o))
#define corto_float(o) ((corto_float)ut_assert_type((corto_type)corto_float_o, o))
#define corto_float32(o) ((float*)ut_assert_type((corto_type)corto_float32_o, o))
#define corto_int64(o) ((int64_t*)ut_assert_type((corto_type)corto_int64_o, o))
#define corto_int(o) ((corto_int)ut_assert_type((corto_type)corto_int_o, o))
#define corto_int16(o) ((int16_t*)ut_assert_type((corto_type)corto_int16_o, o))
#define corto_iterator(o) ((corto_iterator)ut_assert_type((corto_type)corto_iterator_o, o))
#define corto_leaf(o) ((corto_leaf)ut_assert_type((corto_type)corto_leaf_o, o))
#define corto_list(o) ((corto_list)ut_assert_type((corto_type)corto_list_o, o))
#define corto_map(o) ((corto_map)ut_assert_type((corto_type)corto_map_o, o))
#define corto_metaprocedure(o) ((corto_metaprocedure)ut_assert_type((corto_type)corto_metaprocedure_o, o))
#define corto_method(o) ((corto_method)ut_assert_type((corto_type)corto_method_o, o))
#define corto_objectlist(o) ((corto_objectlist*)ut_assert_type((corto_type)corto_objectlist_o, o))
#define corto_octet(o) ((uint8_t*)ut_assert_type((corto_type)corto_octet_o, o))
#define corto_overridable(o) ((corto_overridable)ut_assert_type((corto_type)corto_overridable_o, o))
#define corto_override(o) ((corto_override)ut_assert_type((corto_type)corto_override_o, o))
#define corto_procedure(o) ((corto_procedure)ut_assert_type((corto_type)corto_procedure_o, o))
#define corto_ref_kind(o) ((corto_ref_kind*)ut_assert_type((corto_type)corto_ref_kind_o, o))
#define corto_sequence(o) ((corto_sequence)ut_assert_type((corto_type)corto_sequence_o, o))
#define corto_table(o) ((corto_table)ut_assert_type((corto_type)corto_table_o, o))
#define corto_tableinstance(o) ((corto_tableinstance)ut_assert_type((corto_type)corto_tableinstance_o, o))
#define corto_target(o) ((corto_target)ut_assert_type((corto_type)corto_target_o, o))
#define corto_uint64(o) ((uint64_t*)ut_assert_type((corto_type)corto_uint64_o, o))
#define corto_text(o) ((corto_text)ut_assert_type((corto_type)corto_text_o, o))
#define corto_tool(o) ((corto_tool)ut_assert_type((corto_type)corto_tool_o, o))
#define corto_uint(o) ((corto_uint)ut_assert_type((corto_type)corto_uint_o, o))
#define corto_union(o) ((corto_union)ut_assert_type((corto_type)corto_union_o, o))
#define corto_unknown(o) ((void*)o)
#define corto_verbatim(o) ((corto_verbatim)ut_assert_type((corto_type)corto_verbatim_o, o))
#define corto_void(o) ((void*)o)
#define corto_wordseq(o) ((corto_wordseq*)ut_assert_type((corto_type)corto_wordseq_o, o))
