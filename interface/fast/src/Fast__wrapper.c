...
void __Fast_isOperatorAssignment(cx_function f, void *result, void *args) {
    CX_UNUSED(f);
    *(cx_bool*)result = Fast_isOperatorAssignment(
        *(cx_operatorKind*)args);
}
...
void __Fast_Block_declare(cx_function f, void *result, void *args) {
    ...
    *(Fast_Local*)result = Fast_Block_declare(
        ...
        *(cx_type*)((intptr_t)args + sizeof(void*) + sizeof(cx_string)),
        *(cx_bool*)((intptr_t)args + sizeof(void*) + sizeof(cx_string) + sizeof(cx_type)),
        *(cx_bool*)((intptr_t)args + sizeof(void*) + sizeof(cx_string) + sizeof(cx_type) + sizeof(cx_bool)));
}
...
void __Fast_Parser_argumentToString(cx_function f, void *result, void *args) {
    ...
    *(cx_string*)result = Fast_Parser_argumentToString(
        *(void**)args,
        *(cx_type*)((intptr_t)args + sizeof(void*)),
        *(cx_string*)((intptr_t)args + sizeof(void*) + sizeof(cx_type)),
        *(cx_bool*)((intptr_t)args + sizeof(void*) + sizeof(cx_type) + sizeof(cx_string)));
}

void __Fast_Parser_binaryExpr(cx_function f, void *result, void *args) {
    CX_UNUSED(f);
    *(Fast_Node*)result = Fast_Parser_binaryExpr(
        *(void**)args,
        *(Fast_Expression*)((intptr_t)args + sizeof(void*)),
...
void __Fast_Parser_bind(cx_function f, void *result, void *args) {
    ...
    *(cx_int16*)result = Fast_Parser_bind(
        *(void**)args,
        *(Fast_Storage*)((intptr_t)args + sizeof(void*)),
        *(Fast_Block*)((intptr_t)args + sizeof(void*) + sizeof(Fast_Storage)));
}
...
void __Fast_Parser_bindOneliner(cx_function f, void *result, void *args) {
    ...
    *(cx_int16*)result = Fast_Parser_bindOneliner(
        ...
        *(Fast_Storage*)((intptr_t)args + sizeof(void*)),
        *(Fast_Block*)((intptr_t)args + sizeof(void*) + sizeof(Fast_Storage)),
        *(Fast_Expression*)((intptr_t)args + sizeof(void*) + sizeof(Fast_Storage) + sizeof(Fast_Block)));
}
...
void __Fast_Parser_castExpr(cx_function f, void *result, void *args) {
    ...
    *(Fast_Expression*)result = Fast_Parser_castExpr(
        *(void**)args,
        *(cx_type*)((intptr_t)args + sizeof(void*)),
        *(Fast_Expression*)((intptr_t)args + sizeof(void*) + sizeof(cx_type)));
}
...
void __Fast_Parser_declaration(cx_function f, void *result, void *args) {
    CX_UNUSED(f);
    *(Fast_Storage*)result = Fast_Parser_declaration(
        *(void**)args,
        *(cx_type*)((intptr_t)args + sizeof(void*)),
        *(cx_string*)((intptr_t)args + sizeof(void*) + sizeof(cx_type)),
        *(cx_bool*)((intptr_t)args + sizeof(void*) + sizeof(cx_type) + sizeof(cx_string)));
...
void __Fast_Parser_declareFunction(cx_function f, void *result, void *args) {
    CX_UNUSED(f);
    *(Fast_Storage*)result = Fast_Parser_declareFunction(
        *(void**)args,
        *(cx_type*)((intptr_t)args + sizeof(void*)),
        *(cx_string*)((intptr_t)args + sizeof(void*) + sizeof(cx_type)),
        *(cx_type*)((intptr_t)args + sizeof(void*) + sizeof(cx_type) + sizeof(cx_string)),
        *(cx_bool*)((intptr_t)args + sizeof(void*) + sizeof(cx_type) + sizeof(cx_string) + sizeof(cx_type)));
}
...
void __Fast_Parser_observerDeclaration(cx_function f, void *result, void *args) {
    CX_UNUSED(f);
    *(Fast_Storage*)result = Fast_Parser_observerDeclaration(
        *(void**)args,
        *(cx_string*)((intptr_t)args + sizeof(void*)),
        *(Fast_Expression*)((intptr_t)args + sizeof(void*) + sizeof(cx_string)),
...
void __Fast_Parser_parseExpression(cx_function f, void *result, void *args) {
    ...
    *(Fast_Expression*)result = Fast_Parser_parseExpression(
        ...
        *(cx_object*)((intptr_t)args + sizeof(void*) + sizeof(cx_string) + sizeof(Fast_Block)),
        *(cx_uint32*)((intptr_t)args + sizeof(void*) + sizeof(cx_string) + sizeof(Fast_Block) + sizeof(cx_object)),
        *(cx_uint32*)((intptr_t)args + sizeof(void*) + sizeof(cx_string) + sizeof(Fast_Block) + sizeof(cx_object) + sizeof(cx_uint32)));
}
...
void __Fast_Parser_pushScope(cx_function f, void *result, void *args) {
    CX_UNUSED(f);
    CX_UNUSED(args);
    *(cx_object*)result = Fast_Parser_pushScope(
        *(void**)args);
}
...
void __Fast_Storage_construct(cx_function f, void *result, void *args) {
    CX_UNUSED(f);
    CX_UNUSED(args);
    *(cx_int16*)result = Fast_Storage_construct(
        *(void**)args);
}
