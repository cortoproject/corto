...
cx_ic Fast_BinaryExpr_toIc(Fast_BinaryExpr _this, cx_icProgram program, cx_icStorage storage, cx_bool stored) {
    ...
    /* Determine methodId once, then cache it for subsequent calls. */
    if (!_methodId) {
        _methodId = cx_interface_resolveMethodId(_abstract, "toIc(lang::alias{\"cx_icProgram\"} program,lang::alias{\"cx_icStorage\"} storage,lang::bool stored)");
    }
    cx_assert(_methodId, "virtual method 'toIc(lang::alias{\"cx_icProgram\"} program,lang::alias{\"cx_icStorage\"} storage,lang::bool stored)' not found in abstract '%s'", cx_nameof(_abstract));

    /* Lookup method-object. */
    _method = cx_interface_resolveMethodById(_abstract, _methodId);
    cx_assert(_method != NULL, "unresolved method '%s::toIc(lang::alias{\"cx_icProgram\"} program,lang::alias{\"cx_icStorage\"} storage,lang::bool stored)@%d'", cx_nameof(_this), _methodId);
...
void __Fast_BinaryExpr_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_BinaryExpr_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_BinaryExpr) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_BinaryExpr) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
void __Fast_Block_declare(cx_function f, void *result, void *args) {
    ...
    *(Fast_Local*)result = Fast_Block_declare(
        ...
        *(Fast_Variable*)((intptr_t)args + sizeof(Fast_Block) + sizeof(cx_string)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_Block) + sizeof(cx_string) + sizeof(Fast_Variable)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_Block) + sizeof(cx_string) + sizeof(Fast_Variable) + sizeof(cx_bool)));
}
...
void __Fast_Block_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_Block_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_Block) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_Block) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
cx_ic Fast_Block_toIcBody(Fast_Block _this, cx_icProgram program, cx_icStorage storage, cx_bool stored) {
    ...
    /* Determine methodId once, then cache it for subsequent calls. */
    if (!_methodId) {
        _methodId = cx_interface_resolveMethodId(_abstract, "toIcBody(lang::alias{\"cx_icProgram\"} program,lang::alias{\"cx_icStorage\"} storage,lang::bool stored)");
    }
    cx_assert(_methodId, "virtual method 'toIcBody(lang::alias{\"cx_icProgram\"} program,lang::alias{\"cx_icStorage\"} storage,lang::bool stored)' not found in abstract '%s'", cx_nameof(_abstract));

    /* Lookup method-object. */
    _method = cx_interface_resolveMethodById(_abstract, _methodId);
    cx_assert(_method != NULL, "unresolved method '%s::toIcBody(lang::alias{\"cx_icProgram\"} program,lang::alias{\"cx_icStorage\"} storage,lang::bool stored)@%d'", cx_nameof(_this), _methodId);
...
void __Fast_Boolean_serialize(cx_function f, void *result, void *args) {
    ...
    *(cx_int16*)result = Fast_Boolean_serialize(
        ...
        *(cx_word*)((intptr_t)args + sizeof(Fast_Boolean) + sizeof(cx_type)));
}
...
void __Fast_Boolean_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_Boolean_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_Boolean) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_Boolean) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
void __Fast_Call_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_Call_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_Call) + sizeof(cx_icProgram)),
...
void __Fast_CastExpr_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_CastExpr_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_CastExpr) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_CastExpr) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
void __Fast_Character_serialize(cx_function f, void *result, void *args) {
    ...
    *(cx_int16*)result = Fast_Character_serialize(
        ...
        *(cx_word*)((intptr_t)args + sizeof(Fast_Character) + sizeof(cx_type)));
}
...
void __Fast_Character_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_Character_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_Character) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_Character) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
void __Fast_CommaExpr_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_CommaExpr_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_CommaExpr) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_CommaExpr) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
void __Fast_Define_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_Define_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_Define) + sizeof(cx_icProgram)),
...
void __Fast_ElementExpr_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_ElementExpr_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_ElementExpr) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_ElementExpr) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
cx_int16 Fast_Expression_serialize(Fast_Expression _this, cx_type dstType, cx_word dst) {
    ...
    /* Determine methodId once, then cache it for subsequent calls. */
    if (!_methodId) {
        _methodId = cx_interface_resolveMethodId(_abstract, "serialize(lang::type dstType,lang::word dst)");
    }
    cx_assert(_methodId, "virtual method 'serialize(lang::type dstType,lang::word dst)' not found in abstract '%s'", cx_nameof(_abstract));

    /* Lookup method-object. */
    _method = cx_interface_resolveMethodById(_abstract, _methodId);
    cx_assert(_method != NULL, "unresolved method '%s::serialize(lang::type dstType,lang::word dst)@%d'", cx_nameof(_this), _methodId);
...
void __Fast_Expression_serialize_v(cx_function f, void *result, void *args) {
    ...
    *(cx_int16*)result = Fast_Expression_serialize_v(
        *(Fast_Expression*)args,
        *(cx_type*)((intptr_t)args + sizeof(Fast_Expression)),
        *(cx_word*)((intptr_t)args + sizeof(Fast_Expression) + sizeof(cx_type)));
}
...
void __Fast_FloatingPoint_serialize(cx_function f, void *result, void *args) {
    ...
    *(cx_int16*)result = Fast_FloatingPoint_serialize(
        ...
        *(cx_word*)((intptr_t)args + sizeof(Fast_FloatingPoint) + sizeof(cx_type)));
}
...
void __Fast_FloatingPoint_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_FloatingPoint_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_FloatingPoint) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_FloatingPoint) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
void __Fast_If_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_If_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_If) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_If) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
cx_int32 Fast_Initializer_member(Fast_Initializer _this, cx_string name) {
    ...
    /* Determine methodId once, then cache it for subsequent calls. */
    if (!_methodId) {
        _methodId = cx_interface_resolveMethodId(_abstract, "member(lang::string name)");
    }
    cx_assert(_methodId, "virtual method 'member(lang::string name)' not found in abstract '%s'", cx_nameof(_abstract));

    /* Lookup method-object. */
    _method = cx_interface_resolveMethodById(_abstract, _methodId);
    cx_assert(_method != NULL, "unresolved method '%s::member(lang::string name)@%d'", cx_nameof(_this), _methodId);
...
void __Fast_Integer_serialize(cx_function f, void *result, void *args) {
    ...
    *(cx_int16*)result = Fast_Integer_serialize(
        ...
        *(cx_word*)((intptr_t)args + sizeof(Fast_Integer) + sizeof(cx_type)));
}
...
void __Fast_Integer_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_Integer_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_Integer) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_Integer) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
/* virtual ::cortex::Fast::Local::toIc(lang::alias{"cx_icProgram"} program,lang::alias{"cx_icStorage"} storage,lang::bool stored) */
...
void __Fast_Local_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_Local_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_Local) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_Local) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
void __Fast_MemberExpr_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_MemberExpr_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_MemberExpr) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_MemberExpr) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
void __Fast_NewExpr_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_NewExpr_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_NewExpr) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_NewExpr) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
void __Fast_Node_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_Node_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_Node) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_Node) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
void __Fast_Null_serialize(cx_function f, void *result, void *args) {
    ...
    *(cx_int16*)result = Fast_Null_serialize(
        ...
        *(cx_word*)((intptr_t)args + sizeof(Fast_Null) + sizeof(cx_type)));
}
...
void __Fast_Null_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_Null_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_Null) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_Null) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
void __Fast_Object_serialize(cx_function f, void *result, void *args) {
    ...
    *(cx_int16*)result = Fast_Object_serialize(
        ...
        *(cx_word*)((intptr_t)args + sizeof(Fast_Object) + sizeof(cx_type)));
}
...
void __Fast_Object_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_Object_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_Object) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_Object) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
void __Fast_Parser_argumentToString(cx_function f, void *result, void *args) {
    ...
    *(cx_string*)result = Fast_Parser_argumentToString(
        ...
        *(cx_string*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(Fast_Variable)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(Fast_Variable) + sizeof(cx_string)));
}
...
void __Fast_Parser_binaryExpr(cx_function f, void *result, void *args) {
    ...
    *(Fast_Expression*)result = Fast_Parser_binaryExpr(
        ...
        *(cx_operatorKind*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(Fast_Expression) + sizeof(Fast_Expression)));
}
...
void __Fast_Parser_declareFunction(cx_function f, void *result, void *args) {
    ...
    *(Fast_Variable*)result = Fast_Parser_declareFunction(
        ...
        *(Fast_Variable*)((intptr_t)args + sizeof(Fast_Parser)),
        *(cx_string*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(Fast_Variable)),
        *(cx_type*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(Fast_Variable) + sizeof(cx_string)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(Fast_Variable) + sizeof(cx_string) + sizeof(cx_type)));
}
...
void __Fast_Parser_foreach(cx_function f, void *result, void *args) {
    ...
    *(cx_int16*)result = Fast_Parser_foreach(
        ...
        *(Fast_Expression*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(cx_string)));
}
...
void __Fast_Parser_initStage(cx_function f, void *result, void *args) {
    ...
    Fast_Parser_initStage(
        *(Fast_Parser*)args,
        *(cx_string*)((intptr_t)args + sizeof(Fast_Parser)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(cx_string)));
}
...
void __Fast_Parser_lookup(cx_function f, void *result, void *args) {
    ...
    *(Fast_Expression*)result = Fast_Parser_lookup(
        *(Fast_Parser*)args,
        *(cx_string*)((intptr_t)args + sizeof(Fast_Parser)),
        *(cx_object*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(cx_string)));
}
...
void __Fast_Parser_observerDeclaration(cx_function f, void *result, void *args) {
    ...
    *(Fast_Variable*)result = Fast_Parser_observerDeclaration(
        ...
        *(cx_string*)((intptr_t)args + sizeof(Fast_Parser)),
        *(Fast_Expression*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(cx_string)),
        *(cx_eventMask*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(cx_string) + sizeof(Fast_Expression)),
        *(Fast_Object*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(cx_string) + sizeof(Fast_Expression) + sizeof(cx_eventMask)));
}
...
void __Fast_Parser_parseExpression(cx_function f, void *result, void *args) {
    ...
    *(Fast_Expression*)result = Fast_Parser_parseExpression(
        *(Fast_Parser*)args,
        *(cx_string*)((intptr_t)args + sizeof(Fast_Parser)),
        *(Fast_Block*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(cx_string)),
        *(Fast_Variable*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(cx_string) + sizeof(Fast_Block)),
        *(cx_uint32*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(cx_string) + sizeof(Fast_Block) + sizeof(Fast_Variable)),
        *(cx_uint32*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(cx_string) + sizeof(Fast_Block) + sizeof(Fast_Variable) + sizeof(cx_uint32)));
}
...
void __Fast_Parser_postfixExpr(cx_function f, void *result, void *args) {
    ...
    *(Fast_Expression*)result = Fast_Parser_postfixExpr(
        *(Fast_Parser*)args,
        *(Fast_Expression*)((intptr_t)args + sizeof(Fast_Parser)),
        *(cx_operatorKind*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(Fast_Expression)));
}
...
void __Fast_Parser_pushLvalue(cx_function f, void *result, void *args) {
    ...
    Fast_Parser_pushLvalue(
        *(Fast_Parser*)args,
        *(Fast_Expression*)((intptr_t)args + sizeof(Fast_Parser)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(Fast_Expression)));
}
...
void __Fast_Parser_whileStatement(cx_function f, void *result, void *args) {
    ...
    *(Fast_Node*)result = Fast_Parser_whileStatement(
        ...
        *(Fast_Expression*)((intptr_t)args + sizeof(Fast_Parser)),
        *(Fast_Block*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(Fast_Expression)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_Parser) + sizeof(Fast_Expression) + sizeof(Fast_Block)));
}
...
void __Fast_PostfixExpr_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_PostfixExpr_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_PostfixExpr) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_PostfixExpr) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
void __Fast_SignedInteger_serialize(cx_function f, void *result, void *args) {
    ...
    *(cx_int16*)result = Fast_SignedInteger_serialize(
        ...
        *(cx_word*)((intptr_t)args + sizeof(Fast_SignedInteger) + sizeof(cx_type)));
}
...
void __Fast_SignedInteger_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_SignedInteger_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_SignedInteger) + sizeof(cx_icProgram)),
...
void __Fast_String_serialize(cx_function f, void *result, void *args) {
    ...
    *(cx_int16*)result = Fast_String_serialize(
        ...
        *(cx_word*)((intptr_t)args + sizeof(Fast_String) + sizeof(cx_type)));
}
...
void __Fast_String_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_String_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_String) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_String) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
/* virtual ::cortex::Fast::TernaryExpr::toIc(lang::alias{"cx_icProgram"} program,lang::alias{"cx_icStorage"} storage,lang::bool stored) */
...
void __Fast_TernaryExpr_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_TernaryExpr_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_TernaryExpr) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_TernaryExpr) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
void __Fast_UnaryExpr_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_UnaryExpr_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_UnaryExpr) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_UnaryExpr) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
void __Fast_Update_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_Update_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_Update) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_Update) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
void __Fast_Wait_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_Wait_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_Wait) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_Wait) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
...
void __Fast_While_toIc_v(cx_function f, void *result, void *args) {
    ...
    *(cx_ic*)result = Fast_While_toIc_v(
        ...
        *(cx_icStorage*)((intptr_t)args + sizeof(Fast_While) + sizeof(cx_icProgram)),
        *(cx_bool*)((intptr_t)args + sizeof(Fast_While) + sizeof(cx_icProgram) + sizeof(cx_icStorage)));
}
