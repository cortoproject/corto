...
cx_method Fast_Expression_init_o;
...
int Fast_load(void) {
    ...
    Fast_Node_init_o = cx_declare(Fast_Node_o, "init()", cx_typedef(cx_method_o));
    if (!Fast_Node_init_o) {
    ...
    Fast_Parser_blockPush_o = cx_declare(Fast_Parser_o, "blockPush(bool presetBlock)", cx_typedef(cx_method_o));
    ...
    Fast_Parser_collect_o = cx_declare(Fast_Parser_o, "collect(object o)", cx_typedef(cx_method_o));
    ...
    Fast_Parser_construct_o = cx_declare(Fast_Parser_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_Parser_destruct_o = cx_declare(Fast_Parser_o, "destruct()", cx_typedef(cx_method_o));
    ...
    Fast_Parser_getLvalue_o = cx_declare(Fast_Parser_o, "getLvalue(bool assignment)", cx_typedef(cx_method_o));
    ...
    Fast_Parser_getLvalueType_o = cx_declare(Fast_Parser_o, "getLvalueType(bool assignment)", cx_typedef(cx_method_o));
    ...
    Fast_Parser_initMember_o = cx_declare(Fast_Parser_o, "initMember(string member)", cx_typedef(cx_method_o));
    ...
    Fast_Parser_initStage_o = cx_declare(Fast_Parser_o, "initStage(string id,bool found)", cx_typedef(cx_method_o));
    ...
    Fast_Parser_lookup_o = cx_declare(Fast_Parser_o, "lookup(string id,object source)", cx_typedef(cx_method_o));
    ...
    Fast_Parser_pushReturnAsLvalue_o = cx_declare(Fast_Parser_o, "pushReturnAsLvalue(function function)", cx_typedef(cx_method_o));
    ...
    Fast_Parser_repl_o = cx_declare(Fast_Parser_o, "repl", cx_typedef(cx_member_o));
    ...
    Fast_report_o = cx_declare(Fast_o, "report(string kind,string filename,uint32 line,uint32 column,string error,string token)", cx_typedef(cx_function_o));
    if (!Fast_report_o) {
    ...
    Fast_reportError_o = cx_declare(Fast_o, "reportError(string filename,uint32 line,uint32 column,string error,string token)", cx_typedef(cx_function_o));
    ...
    Fast_reportWarning_o = cx_declare(Fast_o, "reportWarning(string filename,uint32 line,uint32 column,string error,string token)", cx_typedef(cx_function_o));
    ...
    Fast_Node_toIc_o = cx_declare(Fast_Node_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    if (!Fast_Node_toIc_o) {
    ...
    Fast_Block_declareReturnVariable_o = cx_declare(Fast_Block_o, "declareReturnVariable(function function)", cx_typedef(cx_method_o));
    ...
    Fast_Block_lookup_o = cx_declare(Fast_Block_o, "lookup(string id)", cx_typedef(cx_method_o));
    ...
    Fast_Block_lookupLocal_o = cx_declare(Fast_Block_o, "lookupLocal(string id)", cx_typedef(cx_method_o));
    ...
    Fast_Block_resolve_o = cx_declare(Fast_Block_o, "resolve(string id)", cx_typedef(cx_method_o));
    ...
    Fast_Block_resolveLocal_o = cx_declare(Fast_Block_o, "resolveLocal(string id)", cx_typedef(cx_method_o));
    ...
    Fast_Block_setFunction_o = cx_declare(Fast_Block_o, "setFunction(function function", cx_typedef(cx_method_o));
    ...
    Fast_Block_toIc_o = cx_declare(Fast_Block_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_Block_toIcBody_o = cx_declare(Fast_Block_o, "toIcBody(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_Define_construct_o = cx_declare(Fast_Define_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_Define_toIc_o = cx_declare(Fast_Define_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_Expression_cast_o = cx_declare(Fast_Expression_o, "cast(type type,bool isReference)", cx_typedef(cx_method_o));
    ...
    Fast_Expression_getType_type_o = cx_declare(Fast_Expression_o, "getType_type(type target)", cx_typedef(cx_method_o));
    ...
    /* Declare ::cortex::Fast::Expression::init() */
    Fast_Expression_init_o = cx_declare(Fast_Expression_o, "init()", cx_typedef(cx_method_o));
    if (!Fast_Expression_init_o) {
        cx_error("Fast_load: failed to declare object '::cortex::Fast::Expression::init()'.");
        goto error;
    }

    /* Define ::cortex::Fast::Expression::init() */
    if (!cx_checkState(Fast_Expression_init_o, CX_DEFINED)) {
        cx_function(Fast_Expression_init_o)->returnType = cx_resolve_ext(Fast_Expression_init_o, NULL, "::cortex::lang::int16", FALSE, "element ::cortex::Fast::Expression::init().returnType");
        cx_function(Fast_Expression_init_o)->returnsReference = FALSE;
        Fast_Expression_init_o->virtual = FALSE;
        
        /* Bind ::cortex::Fast::Expression::init() with C-function */
        ...
        if (cx_define(Fast_Expression_init_o)) {
            cx_error("Fast_load: failed to define object '::cortex::Fast::Expression::init()'.");
            goto error;
        }
    }

    /* Declare ::cortex::Fast::Expression::serialize(type dstType,word dst) */
    Fast_Expression_serialize_o = cx_declare(Fast_Expression_o, "serialize(type dstType,word dst)", cx_typedef(cx_virtual_o));
    ...
    Fast_If_construct_o = cx_declare(Fast_If_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_If_toIc_o = cx_declare(Fast_If_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    if (!Fast_If_toIc_o) {
    ...
    Fast_Update_construct_o = cx_declare(Fast_Update_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_While_construct_o = cx_declare(Fast_While_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_Parser_parseLine_o = cx_declare(Fast_Parser_o, "parseLine(string expr,object scope,alias{\"cx_value*\"} value)", cx_typedef(cx_function_o));
    ...
    Fast_Update_toIc_o = cx_declare(Fast_Update_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_While_toIc_o = cx_declare(Fast_While_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_BinaryExpr_construct_o = cx_declare(Fast_BinaryExpr_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_BinaryExpr_setOperator_o = cx_declare(Fast_BinaryExpr_o, "setOperator(operatorKind kind)", cx_typedef(cx_method_o));
    ...
    Fast_BinaryExpr_toIc_o = cx_declare(Fast_BinaryExpr_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_Call_construct_o = cx_declare(Fast_Call_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_Call_setParameters_o = cx_declare(Fast_Call_o, "setParameters(function function)", cx_typedef(cx_method_o));
    ...
    Fast_Call_toIc_o = cx_declare(Fast_Call_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    if (!Fast_Call_toIc_o) {
    ...
    Fast_DelegateCall_construct_o = cx_declare(Fast_DelegateCall_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_StaticCall_construct_o = cx_declare(Fast_StaticCall_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_CastExpr_construct_o = cx_declare(Fast_CastExpr_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_CastExpr_toIc_o = cx_declare(Fast_CastExpr_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_CommaExpr_construct_o = cx_declare(Fast_CommaExpr_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_CommaExpr_init_o = cx_declare(Fast_CommaExpr_o, "init()", cx_typedef(cx_method_o));
    ...
    Fast_CommaExpr_toIc_o = cx_declare(Fast_CommaExpr_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_ElementExpr_construct_o = cx_declare(Fast_ElementExpr_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_ElementExpr_toIc_o = cx_declare(Fast_ElementExpr_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_Initializer_construct_o = cx_declare(Fast_Initializer_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_Initializer_member_o = cx_declare(Fast_Initializer_o, "member(string name)", cx_typedef(cx_virtual_o));
    ...
    Fast_DynamicInitializer_construct_o = cx_declare(Fast_DynamicInitializer_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_InitializerExpr_construct_o = cx_declare(Fast_InitializerExpr_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_InitializerExpr_member_o = cx_declare(Fast_InitializerExpr_o, "member(string name)", cx_typedef(cx_method_o));
    ...
    Fast_StaticInitializer_construct_o = cx_declare(Fast_StaticInitializer_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_Literal_init_o = cx_declare(Fast_Literal_o, "init()", cx_typedef(cx_method_o));
    ...
    Fast_Boolean_init_o = cx_declare(Fast_Boolean_o, "init()", cx_typedef(cx_method_o));
    ...
    Fast_Boolean_serialize_o = cx_declare(Fast_Boolean_o, "serialize(type dstType,word dst)", cx_typedef(cx_method_o));
    ...
    Fast_Boolean_toIc_o = cx_declare(Fast_Boolean_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_Character_init_o = cx_declare(Fast_Character_o, "init()", cx_typedef(cx_method_o));
    ...
    Fast_Character_serialize_o = cx_declare(Fast_Character_o, "serialize(type dstType,word dst)", cx_typedef(cx_method_o));
    ...
    Fast_Character_toIc_o = cx_declare(Fast_Character_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_FloatingPoint_init_o = cx_declare(Fast_FloatingPoint_o, "init()", cx_typedef(cx_method_o));
    ...
    Fast_FloatingPoint_serialize_o = cx_declare(Fast_FloatingPoint_o, "serialize(type dstType,word dst)", cx_typedef(cx_method_o));
    ...
    Fast_FloatingPoint_toIc_o = cx_declare(Fast_FloatingPoint_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_Integer_init_o = cx_declare(Fast_Integer_o, "init()", cx_typedef(cx_method_o));
    ...
    Fast_Integer_serialize_o = cx_declare(Fast_Integer_o, "serialize(type dstType,word dst)", cx_typedef(cx_method_o));
    ...
    Fast_Integer_toIc_o = cx_declare(Fast_Integer_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_Null_init_o = cx_declare(Fast_Null_o, "init()", cx_typedef(cx_method_o));
    if (!Fast_Null_init_o) {
    ...
    Fast_Null_serialize_o = cx_declare(Fast_Null_o, "serialize(type dstType,word dst)", cx_typedef(cx_method_o));
    ...
    Fast_Null_toIc_o = cx_declare(Fast_Null_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    if (!Fast_Null_toIc_o) {
    ...
    Fast_SignedInteger_init_o = cx_declare(Fast_SignedInteger_o, "init()", cx_typedef(cx_method_o));
    ...
    Fast_SignedInteger_serialize_o = cx_declare(Fast_SignedInteger_o, "serialize(type dstType,word dst)", cx_typedef(cx_method_o));
    ...
    Fast_SignedInteger_toIc_o = cx_declare(Fast_SignedInteger_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_String_construct_o = cx_declare(Fast_String_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_String_init_o = cx_declare(Fast_String_o, "init()", cx_typedef(cx_method_o));
    ...
    Fast_String_serialize_o = cx_declare(Fast_String_o, "serialize(type dstType,word dst)", cx_typedef(cx_method_o));
    ...
    Fast_String_toIc_o = cx_declare(Fast_String_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_MemberExpr_construct_o = cx_declare(Fast_MemberExpr_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_MemberExpr_toIc_o = cx_declare(Fast_MemberExpr_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_NewExpr_construct_o = cx_declare(Fast_NewExpr_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_NewExpr_toIc_o = cx_declare(Fast_NewExpr_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_Parser_binaryExpr_o = cx_declare(Fast_Parser_o, "binaryExpr(Fast::Expression lvalues,Fast::Expression rvalues,operatorKind operator)", cx_typedef(cx_method_o));
    ...
    Fast_Parser_foreach_o = cx_declare(Fast_Parser_o, "foreach(string loopId,Fast::Expression collection)", cx_typedef(cx_method_o));
    ...
    Fast_Parser_postfixExpr_o = cx_declare(Fast_Parser_o, "postfixExpr(Fast::Expression lvalue,operatorKind operator)", cx_typedef(cx_method_o));
    ...
    Fast_Parser_pushLvalue_o = cx_declare(Fast_Parser_o, "pushLvalue(Fast::Expression lvalue,bool isAssignment)", cx_typedef(cx_method_o));
    ...
    Fast_Parser_unaryExpr_o = cx_declare(Fast_Parser_o, "unaryExpr(Fast::Expression lvalue,operatorKind operator)", cx_typedef(cx_method_o));
    ...
    Fast_PostfixExpr_construct_o = cx_declare(Fast_PostfixExpr_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_PostfixExpr_toIc_o = cx_declare(Fast_PostfixExpr_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_TernaryExpr_construct_o = cx_declare(Fast_TernaryExpr_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_TernaryExpr_setOperator_o = cx_declare(Fast_TernaryExpr_o, "setOperator(operatorKind kind)", cx_typedef(cx_method_o));
    ...
    Fast_TernaryExpr_toIc_o = cx_declare(Fast_TernaryExpr_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_UnaryExpr_construct_o = cx_declare(Fast_UnaryExpr_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_UnaryExpr_toIc_o = cx_declare(Fast_UnaryExpr_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_Variable_construct_o = cx_declare(Fast_Variable_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_Block_declare_o = cx_declare(Fast_Block_o, "declare(string id,Fast::Variable type,bool isParameter,bool isReference)", cx_typedef(cx_method_o));
    ...
    Fast_Block_declareTemplate_o = cx_declare(Fast_Block_o, "declareTemplate(string id,Fast::Variable type,bool isParameter,bool isReference)", cx_typedef(cx_method_o));
    ...
    Fast_Local_construct_o = cx_declare(Fast_Local_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_Local_toIc_o = cx_declare(Fast_Local_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_Template_construct_o = cx_declare(Fast_Template_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_Parser_parseExpression_o = cx_declare(Fast_Parser_o, "parseExpression(string expr,Fast::Block block,Fast::Variable scope,uint32 line,uint32 column)", cx_typedef(cx_method_o));
    ...
    Fast_Parser_whileStatement_o = cx_declare(Fast_Parser_o, "whileStatement(Fast::Expression condition,Fast::Block trueBranch,bool isUntil)", cx_typedef(cx_method_o));
    ...
    Fast_ObjectBase_construct_o = cx_declare(Fast_ObjectBase_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_Object_construct_o = cx_declare(Fast_Object_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_Object_serialize_o = cx_declare(Fast_Object_o, "serialize(type dstType,word dst)", cx_typedef(cx_method_o));
    ...
    Fast_Object_toIc_o = cx_declare(Fast_Object_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    ...
    Fast_Parser_observerDeclaration_o = cx_declare(Fast_Parser_o, "observerDeclaration(string id,Fast::Expression object,eventMask mask,Fast::Object dispatcher)", cx_typedef(cx_method_o));
    ...
    Fast_Parser_argumentToString_o = cx_declare(Fast_Parser_o, "argumentToString(Fast::Variable type,string id,bool reference)", cx_typedef(cx_method_o));
    ...
    Fast_Parser_declaration_o = cx_declare(Fast_Parser_o, "declaration(Variable type,string id,bool isReference)", cx_typedef(cx_method_o));
    ...
    Fast_Parser_declareFunction_o = cx_declare(Fast_Parser_o, "declareFunction(Variable returnType,string id,type kind,bool returnsReference)", cx_typedef(cx_method_o));
    ...
    Fast_Wait_construct_o = cx_declare(Fast_Wait_o, "construct()", cx_typedef(cx_method_o));
    ...
    Fast_Wait_toIc_o = cx_declare(Fast_Wait_o, "toIc(alias{\"cx_icProgram\"} program,alias{\"cx_icStorage\"} storage,bool stored)", cx_typedef(cx_virtual_o));
    if (!Fast_Wait_toIc_o) {
