...
int Fast_BinaryExpr__define(Fast_BinaryExpr _this, Fast_Expression lvalue, Fast_Expression rvalue, db_operatorKind operator) {
    lvalue ? db_keep_ext(_this, lvalue, "element <0x896c988>.lvalue") : 0; _this->lvalue = lvalue;
    rvalue ? db_keep_ext(_this, rvalue, "element <0x896c988>.rvalue") : 0; _this->rvalue = rvalue;
...
int Fast_Block__define(Fast_Block _this, Fast_Block parent) {
    parent ? db_keep_ext(_this, parent, "element <0x896c988>.parent") : 0; _this->parent = parent;
    return db_define(_this);
}
...
int Fast_Call__define(Fast_Call _this, Fast_Expression function, Fast_Expression arguments) {
    function ? db_keep_ext(_this, function, "element <0x896c988>.function") : 0; _this->function = function;
    arguments ? db_keep_ext(_this, arguments, "element <0x896c988>.arguments") : 0; _this->arguments = arguments;
    return db_define(_this);
}
...
int Fast_CastExpr__define(Fast_CastExpr _this, Fast_Expression lvalue, Fast_Expression rvalue) {
    lvalue ? db_keep_ext(_this, lvalue, "element <0x8912890>.lvalue") : 0; _this->lvalue = lvalue;
    rvalue ? db_keep_ext(_this, rvalue, "element <0x8912890>.rvalue") : 0; _this->rvalue = rvalue;
    return db_define(_this);
}
...
int Fast_Define__define(Fast_Define _this, Fast_Expression object) {
    object ? db_keep_ext(_this, object, "element <0x8920b08>.object") : 0; _this->object = object;
    return db_define(_this);
}
...
int Fast_ElementExpr__define(Fast_ElementExpr _this, Fast_Expression lvalue, Fast_Expression rvalue) {
    lvalue ? db_keep_ext(_this, lvalue, "element <0x8921750>.lvalue") : 0; _this->lvalue = lvalue;
    rvalue ? db_keep_ext(_this, rvalue, "element <0x8921750>.rvalue") : 0; _this->rvalue = rvalue;
    return db_define(_this);
}
...
int Fast_If__define(Fast_If _this, Fast_Expression condition, Fast_Block trueBranch, Fast_If falseBranch) {
    condition ? db_keep_ext(_this, condition, "element <0x8921750>.condition") : 0; _this->condition = condition;
    trueBranch ? db_keep_ext(_this, trueBranch, "element <0x8921750>.trueBranch") : 0; _this->trueBranch = trueBranch;
    falseBranch ? db_keep_ext(_this, falseBranch, "element <0x8921750>.falseBranch") : 0; _this->falseBranch = falseBranch;
    return db_define(_this);
}
...
int Fast_Local__define(Fast_Local _this, db_string name, Fast_Variable type_1, Fast_LocalKind kind_2, db_bool isReference_1) {
    ...
    type_1 ? db_keep_ext(_this, type_1, "element <0x8903a18>.type") : 0; _this->type = type_1;
    _this->kind = kind_2;
...
int Fast_MemberExpr__define(Fast_MemberExpr _this, Fast_Expression lvalue, Fast_Expression rvalue) {
    lvalue ? db_keep_ext(_this, lvalue, "element <0x8924b18>.lvalue") : 0; _this->lvalue = lvalue;
    rvalue ? db_keep_ext(_this, rvalue, "element <0x8924b18>.rvalue") : 0; _this->rvalue = rvalue;
    return db_define(_this);
}
...
int Fast_NewExpr__define(Fast_NewExpr _this, Fast_Expression type_1, Fast_Expression attributes) {
    type_1 ? db_keep_ext(_this, type_1, "element <0x89213f0>.type") : 0; _this->type = type_1;
    attributes ? db_keep_ext(_this, attributes, "element <0x89213f0>.attributes") : 0; _this->attributes = attributes;
    return db_define(_this);
}
...
int Fast_Object__define(Fast_Object _this, db_object value) {
    value ? db_keep_ext(_this, value, "element <0x89213f0>.value") : 0; Fast_ObjectBase(_this)->value = value;
    return db_define(_this);
}
...
int Fast_ObjectBase__define(Fast_ObjectBase _this, db_object value) {
    value ? db_keep_ext(_this, value, "element <0x89213f0>.value") : 0; _this->value = value;
    return db_define(_this);
}
...
int Fast_PostfixExpr__define(Fast_PostfixExpr _this, Fast_Expression lvalue, db_operatorKind operator) {
    lvalue ? db_keep_ext(_this, lvalue, "element <0x8912ee8>.lvalue") : 0; _this->lvalue = lvalue;
    _this->operator = operator;
    return db_define(_this);
}
...
int Fast_Template__define(Fast_Template _this, db_string name, Fast_Variable type_1, Fast_LocalKind kind_2, db_bool isReference_1) {
    ...
    type_1 ? db_keep_ext(_this, type_1, "element <0x891e850>.type") : 0; Fast_Local(_this)->type = type_1;
...
int Fast_TernaryExpr__define(Fast_TernaryExpr _this, Fast_Expression condition, Fast_Expression ifTrue, Fast_Expression ifFalse, Fast_Expression result) {
    condition ? db_keep_ext(_this, condition, "element <0x8923aa8>.condition") : 0; _this->condition = condition;
    ifTrue ? db_keep_ext(_this, ifTrue, "element <0x8923aa8>.ifTrue") : 0; _this->ifTrue = ifTrue;
    ifFalse ? db_keep_ext(_this, ifFalse, "element <0x8923aa8>.ifFalse") : 0; _this->ifFalse = ifFalse;
    result ? db_keep_ext(_this, result, "element <0x8923aa8>.result") : 0; _this->result = result;
    return db_define(_this);
}
...
Fast_TernaryExpr Fast_TernaryExpr__create(Fast_Expression condition, Fast_Expression ifTrue, Fast_Expression ifFalse, Fast_Expression result) {
    ...
    condition ? db_keep_ext(_this, condition, "element <0x890ed88>.condition") : 0; _this->condition = condition;
    ifTrue ? db_keep_ext(_this, ifTrue, "element <0x890ed88>.ifTrue") : 0; _this->ifTrue = ifTrue;
    ifFalse ? db_keep_ext(_this, ifFalse, "element <0x890ed88>.ifFalse") : 0; _this->ifFalse = ifFalse;
    result ? db_keep_ext(_this, result, "element <0x890ed88>.result") : 0; _this->result = result;
    if (db_define(_this)) {
        db_free(_this);
        _this = NULL;
    }
...
int Fast_UnaryExpr__define(Fast_UnaryExpr _this, Fast_Expression lvalue, db_operatorKind operator) {
    lvalue ? db_keep_ext(_this, lvalue, "element <0x8959a20>.lvalue") : 0; _this->lvalue = lvalue;
    _this->operator = operator;
    return db_define(_this);
}
...
int Fast_Update__define(Fast_Update _this, Fast_Expression_list exprList, Fast_Block block, Fast_Expression from) {
    ...
    block ? db_keep_ext(_this, block, "element <0x8959a20>.block") : 0; _this->block = block;
    from ? db_keep_ext(_this, from, "element <0x8959a20>.from") : 0; _this->from = from;
    return db_define(_this);
}
...
int Fast_Wait__define(Fast_Wait _this, Fast_Expression_list exprList, Fast_Expression timeout) {
    _this->exprList = exprList;
    timeout ? db_keep_ext(_this, timeout, "element <0x8959a20>.timeout") : 0; _this->timeout = timeout;
    return db_define(_this);
}
...
int Fast_While__define(Fast_While _this, Fast_Expression condition, Fast_Block trueBranch, db_bool isUntil) {
    condition ? db_keep_ext(_this, condition, "element <0x8959a20>.condition") : 0; _this->condition = condition;
    trueBranch ? db_keep_ext(_this, trueBranch, "element <0x8959a20>.trueBranch") : 0; _this->trueBranch = trueBranch;
