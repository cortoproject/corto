...
int Fast_Binary__define(Fast_Binary _this, Fast_Expression lvalue, Fast_Expression rvalue, cx_operatorKind operator) {
    lvalue ? cx_keep_ext(_this, lvalue, "element <0x7f8f51f008d8>.lvalue") : 0; _this->lvalue = Fast_Expression(lvalue);
    rvalue ? cx_keep_ext(_this, rvalue, "element <0x7f8f51f008d8>.rvalue") : 0; _this->rvalue = Fast_Expression(rvalue);
...
void Fast_Binding__init(Fast_Binding *_this, cx_function function, Fast_Block impl) {
    ...
    cx_initValue(&v);
    function ? cx_keep_ext(_this, function, "element <0x7f8f51f00768>.function") : 0; _this->function = cx_function(function);
    impl ? cx_keep_ext(_this, impl, "element <0x7f8f51f00768>.impl") : 0; _this->impl = Fast_Block(impl);
}
...
int Fast_Block__define(Fast_Block _this, Fast_Block parent) {
    parent ? cx_keep_ext(_this, parent, "element <0x7f8f51f00888>.parent") : 0; _this->parent = Fast_Block(parent);
    return cx_define(_this);
}
...
int Fast_Call__define(Fast_Call _this, Fast_Expression instanceExpr, Fast_Expression arguments) {
    instanceExpr ? cx_keep_ext(_this, instanceExpr, "element <0x7f8f51f009f8>.instanceExpr") : 0; _this->instanceExpr = Fast_Expression(instanceExpr);
    arguments ? cx_keep_ext(_this, arguments, "element <0x7f8f51f009f8>.arguments") : 0; _this->arguments = Fast_Expression(arguments);
    return cx_define(_this);
}
...
void Fast_CallBuilder__init(Fast_CallBuilder *_this, cx_string name, Fast_Expression arguments, Fast_Expression instance, cx_object scope, Fast_Block block) {
    ...
    arguments ? cx_keep_ext(_this, arguments, "element <0x7f8f51f00718>.arguments") : 0; _this->arguments = Fast_Expression(arguments);
    instance ? cx_keep_ext(_this, instance, "element <0x7f8f51f00718>.instance") : 0; _this->instance = Fast_Expression(instance);
    scope ? cx_keep_ext(_this, scope, "element <0x7f8f51f00718>.scope") : 0; _this->scope = scope;
    block ? cx_keep_ext(_this, block, "element <0x7f8f51f00718>.block") : 0; _this->block = Fast_Block(block);
}
...
int Fast_Cast__define(Fast_Cast _this, cx_type lvalue, Fast_Expression rvalue) {
    lvalue ? cx_keep_ext(_this, lvalue, "element <0x7f8f51f008a8>.lvalue") : 0; _this->lvalue = cx_type(lvalue);
    rvalue ? cx_keep_ext(_this, rvalue, "element <0x7f8f51f008a8>.rvalue") : 0; _this->rvalue = Fast_Expression(rvalue);
    return cx_define(_this);
}

Fast_Cast Fast_Cast__create(cx_type lvalue, Fast_Expression rvalue) {
    Fast_Cast _this;
    _this = cx_new(cx_type(Fast_Cast_o));
    lvalue ? cx_keep_ext(_this, lvalue, "element <0x7f8f51f006e8>.lvalue") : 0; _this->lvalue = cx_type(lvalue);
    rvalue ? cx_keep_ext(_this, rvalue, "element <0x7f8f51f006e8>.rvalue") : 0; _this->rvalue = Fast_Expression(rvalue);
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
    }
...
int Fast_Define__define(Fast_Define _this, Fast_Expression object) {
    object ? cx_keep_ext(_this, object, "element <0x7f8f51f007c8>.object") : 0; _this->object = Fast_Expression(object);
    return cx_define(_this);
}
...
int Fast_DelegateCall__define(Fast_DelegateCall _this, Fast_Expression instanceExpr, Fast_Expression arguments, Fast_Expression expr) {
    instanceExpr ? cx_keep_ext(_this, instanceExpr, "element <0x7f8f51f00718>.instanceExpr") : 0; Fast_Call(_this)->instanceExpr = Fast_Expression(instanceExpr);
    arguments ? cx_keep_ext(_this, arguments, "element <0x7f8f51f00718>.arguments") : 0; Fast_Call(_this)->arguments = Fast_Expression(arguments);
    expr ? cx_keep_ext(_this, expr, "element <0x7f8f51f00718>.expr") : 0; _this->expr = Fast_Expression(expr);
    return cx_define(_this);
}
...
Fast_DelegateCall Fast_DelegateCall__create(Fast_Expression instanceExpr, Fast_Expression arguments, Fast_Expression expr) {
    ...
    instanceExpr ? cx_keep_ext(_this, instanceExpr, "element <0x7f8f51f00a68>.instanceExpr") : 0; Fast_Call(_this)->instanceExpr = Fast_Expression(instanceExpr);
    arguments ? cx_keep_ext(_this, arguments, "element <0x7f8f51f00a68>.arguments") : 0; Fast_Call(_this)->arguments = Fast_Expression(arguments);
    expr ? cx_keep_ext(_this, expr, "element <0x7f8f51f00a68>.expr") : 0; _this->expr = Fast_Expression(expr);
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
    }
...
void Fast_DynamicInitializerFrame__init(Fast_DynamicInitializerFrame *_this, Fast_Expression_array64 expr, Fast_Expression_array64 keyExpr, Fast_Integer sequenceSize) {
    ...
    sequenceSize ? cx_keep_ext(_this, sequenceSize, "element <0x7f8f53802018>.sequenceSize") : 0; _this->sequenceSize = Fast_Integer(sequenceSize);
}
...
int Fast_If__define(Fast_If _this, Fast_Expression condition, Fast_Block trueBranch, Fast_If falseBranch) {
    condition ? cx_keep_ext(_this, condition, "element <0x7f8f51f00848>.condition") : 0; _this->condition = Fast_Expression(condition);
    trueBranch ? cx_keep_ext(_this, trueBranch, "element <0x7f8f51f00848>.trueBranch") : 0; _this->trueBranch = Fast_Block(trueBranch);
    falseBranch ? cx_keep_ext(_this, falseBranch, "element <0x7f8f51f00848>.falseBranch") : 0; _this->falseBranch = Fast_If(falseBranch);
    return cx_define(_this);
}
...
void Fast_InitializerFrame__init(Fast_InitializerFrame *_this, cx_uint32 location, cx_type type, cx_bool isKey, cx_member member) {
    ...
    type ? cx_keep_ext(_this, type, "element <0x7f8f51f00718>.type") : 0; _this->type = cx_type(type);
    _this->isKey = isKey;
    member ? cx_keep_ext(_this, member, "element <0x7f8f51f00718>.member") : 0; _this->member = cx_member(member);
}
...
void Fast_InitializerVariable__init(Fast_InitializerVariable *_this, cx_word offset, Fast_Expression object, cx_word key) {
    ...
    cx_initValue(&v);
    _this->offset = offset;
    object ? cx_keep_ext(_this, object, "element <0x7f8f51f00798>.object") : 0; _this->object = Fast_Expression(object);
    _this->key = key;
}
...
void Fast_InitOper__init(Fast_InitOper *_this, Fast_InitOperKind kind, Fast_Expression expr, cx_string name) {
    ...
    cx_initValue(&v);
    _this->kind = kind;
    expr ? cx_keep_ext(_this, expr, "element <0x7f8f51f00798>.expr") : 0; _this->expr = Fast_Expression(expr);
    _this->name = (name ? cx_strdup(name) : NULL);
}
...
int Fast_Local__define(Fast_Local _this, cx_string name, cx_type type_1, Fast_LocalKind kind_2, cx_bool reference) {
    _this->name = (name ? cx_strdup(name) : NULL);
    type_1 ? cx_keep_ext(_this, type_1, "element <0x7f8f51f00948>.type") : 0; _this->type = cx_type(type_1);
    _this->kind = kind_2;
...
void Fast_Lvalue__init(Fast_Lvalue *_this, Fast_Expression expr, cx_bool isAssignment) {
    ...
    cx_initValue(&v);
    expr ? cx_keep_ext(_this, expr, "element <0x7f8f51f00768>.expr") : 0; _this->expr = Fast_Expression(expr);
...
int Fast_Member__define(Fast_Member _this, Fast_Expression lvalue, Fast_Expression rvalue) {
    lvalue ? cx_keep_ext(_this, lvalue, "element <0x7f8f51f00918>.lvalue") : 0; _this->lvalue = Fast_Expression(lvalue);
    rvalue ? cx_keep_ext(_this, rvalue, "element <0x7f8f51f00918>.rvalue") : 0; _this->rvalue = Fast_Expression(rvalue);
    return cx_define(_this);
}
...
int Fast_New__define(Fast_New _this, cx_type type_1, Fast_Expression attributes) {
    type_1 ? cx_keep_ext(_this, type_1, "element <0x7f8f51f008a8>.type") : 0; _this->type = cx_type(type_1);
    attributes ? cx_keep_ext(_this, attributes, "element <0x7f8f51f008a8>.attributes") : 0; _this->attributes = Fast_Expression(attributes);
    return cx_define(_this);
}
...
Fast_New Fast_New__create(cx_type type_1, Fast_Expression attributes) {
    ...
    type_1 ? cx_keep_ext(_this, type_1, "element <0x7f8f51f006e8>.type") : 0; _this->type = cx_type(type_1);
    attributes ? cx_keep_ext(_this, attributes, "element <0x7f8f51f006e8>.attributes") : 0; _this->attributes = Fast_Expression(attributes);
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
    }
...
int Fast_Object__define(Fast_Object _this, cx_object value) {
    value ? cx_keep_ext(_this, value, "element <0x7f8f51f008a8>.value") : 0; _this->value = value;
    return cx_define(_this);
}
...
void Fast_ParserDeclaration__init(Fast_ParserDeclaration *_this, cx_string name, Fast_Storage storage) {
    cx_value v;
    memset(_this, 0, sizeof(*_this));
    cx_valueValueInit(&v, NULL, cx_type(Fast_ParserDeclaration_o), _this);
    cx_initValue(&v);
    _this->name = (name ? cx_strdup(name) : NULL);
    storage ? cx_keep_ext(_this, storage, "element <0x7f8f51f00768>.storage") : 0; _this->storage = Fast_Storage(storage);
}
...
void Fast_ParserNew__init(Fast_ParserNew *_this, Fast_nodeKind kind, Fast_Expression parent, Fast_Expression name, Fast_Expression attr) {
    ...
    cx_initValue(&v);
    _this->kind = kind;
    parent ? cx_keep_ext(_this, parent, "element <0x7f8f51f00718>.parent") : 0; _this->parent = Fast_Expression(parent);
    name ? cx_keep_ext(_this, name, "element <0x7f8f51f00718>.name") : 0; _this->name = Fast_Expression(name);
    attr ? cx_keep_ext(_this, attr, "element <0x7f8f51f00718>.attr") : 0; _this->attr = Fast_Expression(attr);
}
...
int Fast_PostFix__define(Fast_PostFix _this, Fast_Expression lvalue, cx_operatorKind operator) {
    lvalue ? cx_keep_ext(_this, lvalue, "element <0x7f8f51f008a8>.lvalue") : 0; _this->lvalue = Fast_Expression(lvalue);
    _this->operator = operator;
    return cx_define(_this);
}
...
int Fast_StaticCall__define(Fast_StaticCall _this, Fast_Expression instanceExpr, Fast_Expression arguments, cx_function function) {
    instanceExpr ? cx_keep_ext(_this, instanceExpr, "element <0x7f8f51f00718>.instanceExpr") : 0; Fast_Call(_this)->instanceExpr = Fast_Expression(instanceExpr);
    arguments ? cx_keep_ext(_this, arguments, "element <0x7f8f51f00718>.arguments") : 0; Fast_Call(_this)->arguments = Fast_Expression(arguments);
    function ? cx_keep_ext(_this, function, "element <0x7f8f51f00718>.function") : 0; _this->function = cx_function(function);
    return cx_define(_this);
}
...
Fast_StaticCall Fast_StaticCall__create(Fast_Expression instanceExpr, Fast_Expression arguments, cx_function function) {
    ...
    instanceExpr ? cx_keep_ext(_this, instanceExpr, "element <0x7f8f51f00a68>.instanceExpr") : 0; Fast_Call(_this)->instanceExpr = Fast_Expression(instanceExpr);
    arguments ? cx_keep_ext(_this, arguments, "element <0x7f8f51f00a68>.arguments") : 0; Fast_Call(_this)->arguments = Fast_Expression(arguments);
    function ? cx_keep_ext(_this, function, "element <0x7f8f51f00a68>.function") : 0; _this->function = cx_function(function);
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
    }
...
Fast_Storage Fast_Storage__new(void) {
    return cx_new(cx_type(Fast_Storage_o));
}

Fast_Storage Fast_Storage__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_type(Fast_Storage_o));
}

int Fast_Storage__define(Fast_Storage _this, Fast_storageKind kind_1) {
    _this->kind = kind_1;
    return cx_define(_this);
}
...
Fast_Storage Fast_Storage__create(Fast_storageKind kind_1) {
    Fast_Storage _this;
    _this = cx_new(cx_type(Fast_Storage_o));
    _this->kind = kind_1;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
...
int Fast_Template__define(Fast_Template _this, cx_string name, cx_type type_1, Fast_LocalKind kind_2, cx_bool reference) {
    Fast_Local(_this)->name = (name ? cx_strdup(name) : NULL);
    type_1 ? cx_keep_ext(_this, type_1, "element <0x7f8f51f00948>.type") : 0; Fast_Local(_this)->type = cx_type(type_1);
...
int Fast_Ternary__define(Fast_Ternary _this, Fast_Expression condition, Fast_Expression ifTrue, Fast_Expression ifFalse, Fast_Expression result) {
    condition ? cx_keep_ext(_this, condition, "element <0x7f8f51f00928>.condition") : 0; _this->condition = Fast_Expression(condition);
    ifTrue ? cx_keep_ext(_this, ifTrue, "element <0x7f8f51f00928>.ifTrue") : 0; _this->ifTrue = Fast_Expression(ifTrue);
    ifFalse ? cx_keep_ext(_this, ifFalse, "element <0x7f8f51f00928>.ifFalse") : 0; _this->ifFalse = Fast_Expression(ifFalse);
    result ? cx_keep_ext(_this, result, "element <0x7f8f51f00928>.result") : 0; _this->result = Fast_Expression(result);
    return cx_define(_this);
}
...
Fast_Unary Fast_Unary__create(Fast_Expression lvalue, cx_operatorKind operator) {
    ...
    lvalue ? cx_keep_ext(_this, lvalue, "element <0x7f8f51f006e8>.lvalue") : 0; _this->lvalue = Fast_Expression(lvalue);
    _this->operator = operator;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
...
int Fast_Update__define(Fast_Update _this, Fast_Expression_list exprList, Fast_Block block, Fast_Expression from, Fast_UpdateKind kind_1) {
    ...
    block ? cx_keep_ext(_this, block, "element <0x7f8f51f00878>.block") : 0; _this->block = Fast_Block(block);
    from ? cx_keep_ext(_this, from, "element <0x7f8f51f00878>.from") : 0; _this->from = Fast_Expression(from);
    _this->kind = kind_1;
    return cx_define(_this);
}
...
int Fast_Wait__define(Fast_Wait _this, Fast_Expression_list exprList, Fast_Expression timeout) {
    _this->exprList = exprList;
    timeout ? cx_keep_ext(_this, timeout, "element <0x7f8f51f008a8>.timeout") : 0; _this->timeout = Fast_Expression(timeout);
    return cx_define(_this);
}
...
Fast_Wait Fast_Wait__create(Fast_Expression_list exprList, Fast_Expression timeout) {
    ...
    _this->exprList = exprList;
    timeout ? cx_keep_ext(_this, timeout, "element <0x7f8f51f006e8>.timeout") : 0; _this->timeout = Fast_Expression(timeout);
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
    }
...
int Fast_While__define(Fast_While _this, Fast_Expression condition, Fast_Block trueBranch, cx_bool isUntil) {
    condition ? cx_keep_ext(_this, condition, "element <0x7f8f51f00838>.condition") : 0; _this->condition = Fast_Expression(condition);
    trueBranch ? cx_keep_ext(_this, trueBranch, "element <0x7f8f51f00838>.trueBranch") : 0; _this->trueBranch = Fast_Block(trueBranch);
...
Fast_While Fast_While__create(Fast_Expression condition, Fast_Block trueBranch, cx_bool isUntil) {
    ...
    condition ? cx_keep_ext(_this, condition, "element <0x7f8f51f006e8>.condition") : 0; _this->condition = Fast_Expression(condition);
    trueBranch ? cx_keep_ext(_this, trueBranch, "element <0x7f8f51f006e8>.trueBranch") : 0; _this->trueBranch = Fast_Block(trueBranch);
    _this->isUntil = isUntil;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
