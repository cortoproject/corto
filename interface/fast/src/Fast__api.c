...
int Fast_BinaryExpr__define(Fast_BinaryExpr _this, Fast_Expression lvalue, Fast_Expression rvalue, cx_operatorKind operator) {
    lvalue ? cx_keep_ext(_this, lvalue, "element <0x988a9d0>.lvalue") : 0; _this->lvalue = lvalue;
    rvalue ? cx_keep_ext(_this, rvalue, "element <0x988a9d0>.rvalue") : 0; _this->rvalue = rvalue;
...
void Fast_Binding__init(Fast_Binding *_this, cx_function function, Fast_Block impl) {
    ...
    cx_initValue(&v);
    function ? cx_keep_ext(_this, function, "element <0x98898c8>.function") : 0; _this->function = function;
    impl ? cx_keep_ext(_this, impl, "element <0x98898c8>.impl") : 0; _this->impl = impl;
}
...
int Fast_Block__define(Fast_Block _this, Fast_Block parent) {
    parent ? cx_keep_ext(_this, parent, "element <0x988a9d0>.parent") : 0; _this->parent = parent;
    return cx_define(_this);
}
...
int Fast_Call__define(Fast_Call _this, Fast_Expression instanceExpr, Fast_Expression arguments) {
    instanceExpr ? cx_keep_ext(_this, instanceExpr, "element <0x98ca888>.instanceExpr") : 0; _this->instanceExpr = instanceExpr;
    arguments ? cx_keep_ext(_this, arguments, "element <0x98ca888>.arguments") : 0; _this->arguments = arguments;
    return cx_define(_this);
}
...
Fast_Call Fast_Call__create(Fast_Expression instanceExpr, Fast_Expression arguments) {
    ...
    instanceExpr ? cx_keep_ext(_this, instanceExpr, "element <0x989bba8>.instanceExpr") : 0; _this->instanceExpr = instanceExpr;
    arguments ? cx_keep_ext(_this, arguments, "element <0x989bba8>.arguments") : 0; _this->arguments = arguments;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
    }
...
void Fast_CallBuilder__init(Fast_CallBuilder *_this, cx_string name, Fast_Expression arguments, Fast_Expression instance, cx_object scope, Fast_Block block) {
    ...
    arguments ? cx_keep_ext(_this, arguments, "element <0x987a3f8>.arguments") : 0; _this->arguments = arguments;
    instance ? cx_keep_ext(_this, instance, "element <0x987a3f8>.instance") : 0; _this->instance = instance;
    scope ? cx_keep_ext(_this, scope, "element <0x987a3f8>.scope") : 0; _this->scope = scope;
    block ? cx_keep_ext(_this, block, "element <0x987a3f8>.block") : 0; _this->block = block;
}
...
int Fast_CastExpr__define(Fast_CastExpr _this, Fast_Expression lvalue, Fast_Expression rvalue) {
    lvalue ? cx_keep_ext(_this, lvalue, "element <0x987a3f8>.lvalue") : 0; _this->lvalue = lvalue;
    rvalue ? cx_keep_ext(_this, rvalue, "element <0x987a3f8>.rvalue") : 0; _this->rvalue = rvalue;
    return cx_define(_this);
}
...
int Fast_Define__define(Fast_Define _this, Fast_Expression object) {
    object ? cx_keep_ext(_this, object, "element <0x98ca458>.object") : 0; _this->object = object;
    return cx_define(_this);
}
...
int Fast_DelegateCall__define(Fast_DelegateCall _this, Fast_Expression instanceExpr, Fast_Expression arguments, Fast_Expression expr) {
    instanceExpr ? cx_keep_ext(_this, instanceExpr, "element <0x98913c0>.instanceExpr") : 0; Fast_Call(_this)->instanceExpr = instanceExpr;
    arguments ? cx_keep_ext(_this, arguments, "element <0x98913c0>.arguments") : 0; Fast_Call(_this)->arguments = arguments;
    expr ? cx_keep_ext(_this, expr, "element <0x98913c0>.expr") : 0; _this->expr = expr;
    return cx_define(_this);
}
...
Fast_DelegateCall Fast_DelegateCall__create(Fast_Expression instanceExpr, Fast_Expression arguments, Fast_Expression expr) {
    ...
    instanceExpr ? cx_keep_ext(_this, instanceExpr, "element <0x987a440>.instanceExpr") : 0; Fast_Call(_this)->instanceExpr = instanceExpr;
    arguments ? cx_keep_ext(_this, arguments, "element <0x987a440>.arguments") : 0; Fast_Call(_this)->arguments = arguments;
    expr ? cx_keep_ext(_this, expr, "element <0x987a440>.expr") : 0; _this->expr = expr;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
    }
...
void Fast_DynamicInitializerFrame__init(Fast_DynamicInitializerFrame *_this, Fast_Expression_array64 expr, Fast_Expression_array64 keyExpr, Fast_Integer sequenceSize) {
    ...
    sequenceSize ? cx_keep_ext(_this, sequenceSize, "element <0x9879d60>.sequenceSize") : 0; _this->sequenceSize = sequenceSize;
}
...
int Fast_ElementExpr__define(Fast_ElementExpr _this, Fast_Expression lvalue, Fast_Expression rvalue) {
    lvalue ? cx_keep_ext(_this, lvalue, "element <0x98e5b00>.lvalue") : 0; _this->lvalue = lvalue;
    rvalue ? cx_keep_ext(_this, rvalue, "element <0x98e5b00>.rvalue") : 0; _this->rvalue = rvalue;
    return cx_define(_this);
}
...
int Fast_If__define(Fast_If _this, Fast_Expression condition, Fast_Block trueBranch, Fast_If falseBranch) {
    condition ? cx_keep_ext(_this, condition, "element <0x98e5b00>.condition") : 0; _this->condition = condition;
    trueBranch ? cx_keep_ext(_this, trueBranch, "element <0x98e5b00>.trueBranch") : 0; _this->trueBranch = trueBranch;
    falseBranch ? cx_keep_ext(_this, falseBranch, "element <0x98e5b00>.falseBranch") : 0; _this->falseBranch = falseBranch;
    return cx_define(_this);
}
...
void Fast_InitializerFrame__init(Fast_InitializerFrame *_this, cx_uint32 location, cx_type type, cx_bool isKey, cx_member member) {
    ...
    type ? cx_keep_ext(_this, type, "element <0x98c9088>.type") : 0; _this->type = type;
    _this->isKey = isKey;
    member ? cx_keep_ext(_this, member, "element <0x98c9088>.member") : 0; _this->member = member;
}
...
void Fast_InitializerVariable__init(Fast_InitializerVariable *_this, cx_word offset, Fast_Expression object, cx_word key) {
    ...
    cx_initValue(&v);
    _this->offset = offset;
    object ? cx_keep_ext(_this, object, "element <0x98c7a28>.object") : 0; _this->object = object;
    _this->key = key;
}
...
void Fast_InitOper__init(Fast_InitOper *_this, Fast_InitOperKind kind, Fast_Expression expr, cx_string name) {
    ...
    cx_initValue(&v);
    _this->kind = kind;
    expr ? cx_keep_ext(_this, expr, "element <0x98c7a28>.expr") : 0; _this->expr = expr;
    _this->name = (name ? cx_strdup(name) : NULL);
}
...
int Fast_Local__define(Fast_Local _this, cx_string name, Fast_Variable type_1, Fast_LocalKind kind_2, cx_bool isReference_1) {
    _this->name = (name ? cx_strdup(name) : NULL);
    type_1 ? cx_keep_ext(_this, type_1, "element <0x98a9148>.type") : 0; _this->type = type_1;
    _this->kind = kind_2;
...
int Fast_MemberExpr__define(Fast_MemberExpr _this, Fast_Expression lvalue, Fast_Expression rvalue) {
    lvalue ? cx_keep_ext(_this, lvalue, "element <0x987fdc8>.lvalue") : 0; _this->lvalue = lvalue;
    rvalue ? cx_keep_ext(_this, rvalue, "element <0x987fdc8>.rvalue") : 0; _this->rvalue = rvalue;
    return cx_define(_this);
}
...
int Fast_NewExpr__define(Fast_NewExpr _this, Fast_Expression type_1, Fast_Expression attributes) {
    type_1 ? cx_keep_ext(_this, type_1, "element <0x98c4710>.type") : 0; _this->type = type_1;
    attributes ? cx_keep_ext(_this, attributes, "element <0x98c4710>.attributes") : 0; _this->attributes = attributes;
    return cx_define(_this);
}
...
int Fast_Object__define(Fast_Object _this, cx_object value) {
    value ? cx_keep_ext(_this, value, "element <0x98c4710>.value") : 0; Fast_ObjectBase(_this)->value = value;
    return cx_define(_this);
}
...
int Fast_ObjectBase__define(Fast_ObjectBase _this, cx_object value) {
    value ? cx_keep_ext(_this, value, "element <0x98c4710>.value") : 0; _this->value = value;
    return cx_define(_this);
}
...
void Fast_ParserDeclaration__init(Fast_ParserDeclaration *_this, cx_string name, Fast_Variable variable) {
    ...
    cx_initValue(&v);
    _this->name = (name ? cx_strdup(name) : NULL);
    variable ? cx_keep_ext(_this, variable, "element <0x98cb670>.variable") : 0; _this->variable = variable;
}
...
void Fast_ParserNew__init(Fast_ParserNew *_this, Fast_nodeKind kind, Fast_Expression parent, Fast_Expression name, Fast_Expression attr) {
    ...
    cx_initValue(&v);
    _this->kind = kind;
    parent ? cx_keep_ext(_this, parent, "element <0x98c9088>.parent") : 0; _this->parent = parent;
    name ? cx_keep_ext(_this, name, "element <0x98c9088>.name") : 0; _this->name = name;
    attr ? cx_keep_ext(_this, attr, "element <0x98c9088>.attr") : 0; _this->attr = attr;
}
...
int Fast_PostfixExpr__define(Fast_PostfixExpr _this, Fast_Expression lvalue, cx_operatorKind operator) {
    lvalue ? cx_keep_ext(_this, lvalue, "element <0x986cfc0>.lvalue") : 0; _this->lvalue = lvalue;
    _this->operator = operator;
    return cx_define(_this);
}
...
int Fast_StaticCall__define(Fast_StaticCall _this, Fast_Expression instanceExpr, Fast_Expression arguments, cx_function function) {
    instanceExpr ? cx_keep_ext(_this, instanceExpr, "element <0x98c61a8>.instanceExpr") : 0; Fast_Call(_this)->instanceExpr = instanceExpr;
    arguments ? cx_keep_ext(_this, arguments, "element <0x98c61a8>.arguments") : 0; Fast_Call(_this)->arguments = arguments;
    function ? cx_keep_ext(_this, function, "element <0x98c61a8>.function") : 0; _this->function = function;
    return cx_define(_this);
}
...
Fast_StaticCall Fast_StaticCall__create(Fast_Expression instanceExpr, Fast_Expression arguments, cx_function function) {
    ...
    instanceExpr ? cx_keep_ext(_this, instanceExpr, "element <0x98e3f78>.instanceExpr") : 0; Fast_Call(_this)->instanceExpr = instanceExpr;
    arguments ? cx_keep_ext(_this, arguments, "element <0x98e3f78>.arguments") : 0; Fast_Call(_this)->arguments = arguments;
    function ? cx_keep_ext(_this, function, "element <0x98e3f78>.function") : 0; _this->function = function;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
    }
...
int Fast_Template__define(Fast_Template _this, cx_string name, Fast_Variable type_1, Fast_LocalKind kind_2, cx_bool isReference_1) {
    ...
    type_1 ? cx_keep_ext(_this, type_1, "element <0x98c7b88>.type") : 0; Fast_Local(_this)->type = type_1;
...
int Fast_TernaryExpr__define(Fast_TernaryExpr _this, Fast_Expression condition, Fast_Expression ifTrue, Fast_Expression ifFalse, Fast_Expression result) {
    condition ? cx_keep_ext(_this, condition, "element <0x988c218>.condition") : 0; _this->condition = condition;
    ifTrue ? cx_keep_ext(_this, ifTrue, "element <0x988c218>.ifTrue") : 0; _this->ifTrue = ifTrue;
    ifFalse ? cx_keep_ext(_this, ifFalse, "element <0x988c218>.ifFalse") : 0; _this->ifFalse = ifFalse;
    result ? cx_keep_ext(_this, result, "element <0x988c218>.result") : 0; _this->result = result;
    return cx_define(_this);
}
...
Fast_TernaryExpr Fast_TernaryExpr__create(Fast_Expression condition, Fast_Expression ifTrue, Fast_Expression ifFalse, Fast_Expression result) {
    ...
    condition ? cx_keep_ext(_this, condition, "element <0x988d698>.condition") : 0; _this->condition = condition;
    ifTrue ? cx_keep_ext(_this, ifTrue, "element <0x988d698>.ifTrue") : 0; _this->ifTrue = ifTrue;
    ifFalse ? cx_keep_ext(_this, ifFalse, "element <0x988d698>.ifFalse") : 0; _this->ifFalse = ifFalse;
    result ? cx_keep_ext(_this, result, "element <0x988d698>.result") : 0; _this->result = result;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
    }
...
int Fast_UnaryExpr__define(Fast_UnaryExpr _this, Fast_Expression lvalue, cx_operatorKind operator) {
    lvalue ? cx_keep_ext(_this, lvalue, "element <0x98689e8>.lvalue") : 0; _this->lvalue = lvalue;
    _this->operator = operator;
    return cx_define(_this);
}
...
int Fast_Update__define(Fast_Update _this, Fast_Expression_list exprList, Fast_Block block, Fast_Expression from) {
    ...
    block ? cx_keep_ext(_this, block, "element <0x98689e8>.block") : 0; _this->block = block;
    from ? cx_keep_ext(_this, from, "element <0x98689e8>.from") : 0; _this->from = from;
    return cx_define(_this);
}
...
int Fast_Wait__define(Fast_Wait _this, Fast_Expression_list exprList, Fast_Expression timeout) {
    _this->exprList = exprList;
    timeout ? cx_keep_ext(_this, timeout, "element <0x98689e8>.timeout") : 0; _this->timeout = timeout;
    return cx_define(_this);
}
...
int Fast_While__define(Fast_While _this, Fast_Expression condition, Fast_Block trueBranch, cx_bool isUntil) {
    condition ? cx_keep_ext(_this, condition, "element <0x98689e8>.condition") : 0; _this->condition = condition;
    trueBranch ? cx_keep_ext(_this, trueBranch, "element <0x98689e8>.trueBranch") : 0; _this->trueBranch = trueBranch;
