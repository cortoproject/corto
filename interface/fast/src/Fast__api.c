...
Fast_BinaryExpr Fast_BinaryExpr__new(void) {
    return cx_new(cx_typedef(Fast_BinaryExpr_o));
}

Fast_BinaryExpr Fast_BinaryExpr__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_BinaryExpr_o));
}

int Fast_BinaryExpr__define(Fast_BinaryExpr _this, Fast_Expression lvalue, Fast_Expression rvalue, cx_operatorKind operator) {
    lvalue ? cx_keep_ext(_this, lvalue, "element <0x8aa7780>.lvalue") : 0; _this->lvalue = lvalue;
    rvalue ? cx_keep_ext(_this, rvalue, "element <0x8aa7780>.rvalue") : 0; _this->rvalue = rvalue;
...
void Fast_Binding__init(Fast_Binding *_this, cx_function function, Fast_Block impl) {
    ...
    cx_initValue(&v);
    function ? cx_keep_ext(_this, function, "element <0x8a96e60>.function") : 0; _this->function = function;
    impl ? cx_keep_ext(_this, impl, "element <0x8a96e60>.impl") : 0; _this->impl = impl;
}
...
Fast_Block Fast_Block__new(void) {
    return cx_new(cx_typedef(Fast_Block_o));
}

Fast_Block Fast_Block__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_Block_o));
}

int Fast_Block__define(Fast_Block _this, Fast_Block parent) {
    parent ? cx_keep_ext(_this, parent, "element <0x8aa7780>.parent") : 0; _this->parent = parent;
    return cx_define(_this);
}
...
Fast_Boolean Fast_Boolean__new(void) {
    return cx_new(cx_typedef(Fast_Boolean_o));
}

Fast_Boolean Fast_Boolean__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_Boolean_o));
}
...
Fast_Boolean Fast_Boolean__create(cx_bool value) {
    Fast_Boolean _this;
    _this = cx_new(cx_typedef(Fast_Boolean_o));
    _this->value = value;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
...
Fast_Call Fast_Call__new(void) {
    return cx_new(cx_typedef(Fast_Call_o));
}
...
int Fast_Call__define(Fast_Call _this, Fast_Expression instanceExpr, Fast_Expression arguments) {
    instanceExpr ? cx_keep_ext(_this, instanceExpr, "element <0x8a920b0>.instanceExpr") : 0; _this->instanceExpr = instanceExpr;
    arguments ? cx_keep_ext(_this, arguments, "element <0x8a920b0>.arguments") : 0; _this->arguments = arguments;
    return cx_define(_this);
}
...
Fast_Call Fast_Call__create(Fast_Expression instanceExpr, Fast_Expression arguments) {
    ...
    instanceExpr ? cx_keep_ext(_this, instanceExpr, "element <0x8aa7700>.instanceExpr") : 0; _this->instanceExpr = instanceExpr;
    arguments ? cx_keep_ext(_this, arguments, "element <0x8aa7700>.arguments") : 0; _this->arguments = arguments;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
    }
...
void Fast_CallBuilder__init(Fast_CallBuilder *_this, cx_string name, Fast_Expression arguments, Fast_Expression instance, cx_object scope, Fast_Block block) {
    ...
    arguments ? cx_keep_ext(_this, arguments, "element <0x8ae19d8>.arguments") : 0; _this->arguments = arguments;
    instance ? cx_keep_ext(_this, instance, "element <0x8ae19d8>.instance") : 0; _this->instance = instance;
    scope ? cx_keep_ext(_this, scope, "element <0x8ae19d8>.scope") : 0; _this->scope = scope;
    block ? cx_keep_ext(_this, block, "element <0x8ae19d8>.block") : 0; _this->block = block;
}
...
Fast_CastExpr Fast_CastExpr__new(void) {
    return cx_new(cx_typedef(Fast_CastExpr_o));
}

Fast_CastExpr Fast_CastExpr__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_CastExpr_o));
}

int Fast_CastExpr__define(Fast_CastExpr _this, Fast_Expression lvalue, Fast_Expression rvalue) {
    lvalue ? cx_keep_ext(_this, lvalue, "element <0x8adfde0>.lvalue") : 0; _this->lvalue = lvalue;
    rvalue ? cx_keep_ext(_this, rvalue, "element <0x8adfde0>.rvalue") : 0; _this->rvalue = rvalue;
    return cx_define(_this);
}
...
Fast_Character Fast_Character__new(void) {
    return cx_new(cx_typedef(Fast_Character_o));
}

Fast_Character Fast_Character__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_Character_o));
}
...
Fast_Character Fast_Character__create(cx_char value) {
    ...
    _this = cx_new(cx_typedef(Fast_Character_o));
    _this->value = value;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
...
Fast_CommaExpr Fast_CommaExpr__new(void) {
    return cx_new(cx_typedef(Fast_CommaExpr_o));
}

Fast_CommaExpr Fast_CommaExpr__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_CommaExpr_o));
}
...
Fast_CommaExpr Fast_CommaExpr__create(void) {
    ...
    _this = cx_new(cx_typedef(Fast_CommaExpr_o));
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
    }
...
Fast_Define Fast_Define__new(void) {
    return cx_new(cx_typedef(Fast_Define_o));
}

Fast_Define Fast_Define__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_Define_o));
}

int Fast_Define__define(Fast_Define _this, Fast_Expression object) {
    object ? cx_keep_ext(_this, object, "element <0x8a8ffb8>.object") : 0; _this->object = object;
    return cx_define(_this);
}
...
int Fast_DelegateCall__define(Fast_DelegateCall _this, Fast_Expression instanceExpr, Fast_Expression arguments, Fast_Expression expr) {
    instanceExpr ? cx_keep_ext(_this, instanceExpr, "element <0x8a920b0>.instanceExpr") : 0; Fast_Call(_this)->instanceExpr = instanceExpr;
    arguments ? cx_keep_ext(_this, arguments, "element <0x8a920b0>.arguments") : 0; Fast_Call(_this)->arguments = arguments;
    expr ? cx_keep_ext(_this, expr, "element <0x8a920b0>.expr") : 0; _this->expr = expr;
    return cx_define(_this);
}
...
Fast_DelegateCall Fast_DelegateCall__create(Fast_Expression instanceExpr, Fast_Expression arguments, Fast_Expression expr) {
    ...
    instanceExpr ? cx_keep_ext(_this, instanceExpr, "element <0x8aa7700>.instanceExpr") : 0; Fast_Call(_this)->instanceExpr = instanceExpr;
    arguments ? cx_keep_ext(_this, arguments, "element <0x8aa7700>.arguments") : 0; Fast_Call(_this)->arguments = arguments;
    expr ? cx_keep_ext(_this, expr, "element <0x8aa7700>.expr") : 0; _this->expr = expr;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
    }
...
Fast_DynamicInitializer Fast_DynamicInitializer__new(void) {
    return cx_new(cx_typedef(Fast_DynamicInitializer_o));
}

Fast_DynamicInitializer Fast_DynamicInitializer__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_DynamicInitializer_o));
}
...
Fast_DynamicInitializer Fast_DynamicInitializer__create(Fast_InitializerVariable_array64 variables, cx_uint8 variableCount, cx_bool assignValue) {
    ...
    _this = cx_new(cx_typedef(Fast_DynamicInitializer_o));
    memcpy(Fast_Initializer(_this)->variables, variables, sizeof(Fast_InitializerVariable_array64));
    Fast_Initializer(_this)->variableCount = variableCount;
    _this->assignValue = assignValue;
    if (cx_define(_this)) {
...
void Fast_DynamicInitializerFrame__init(Fast_DynamicInitializerFrame *_this, Fast_Expression_array64 expr, Fast_Expression_array64 keyExpr, Fast_Integer sequenceSize) {
    ...
    sequenceSize ? cx_keep_ext(_this, sequenceSize, "element <0x8aa0198>.sequenceSize") : 0; _this->sequenceSize = sequenceSize;
}
...
Fast_ElementExpr Fast_ElementExpr__new(void) {
    return cx_new(cx_typedef(Fast_ElementExpr_o));
}

Fast_ElementExpr Fast_ElementExpr__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_ElementExpr_o));
}

int Fast_ElementExpr__define(Fast_ElementExpr _this, Fast_Expression lvalue, Fast_Expression rvalue) {
    lvalue ? cx_keep_ext(_this, lvalue, "element <0x8add9f8>.lvalue") : 0; _this->lvalue = lvalue;
    rvalue ? cx_keep_ext(_this, rvalue, "element <0x8add9f8>.rvalue") : 0; _this->rvalue = rvalue;
    return cx_define(_this);
}
...
Fast_Expression Fast_Expression__new(void) {
    return cx_new(cx_typedef(Fast_Expression_o));
}

Fast_Expression Fast_Expression__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_Expression_o));
}
...
Fast_Expression Fast_Expression__create(Fast_nodeKind kind) {
    ...
    _this = cx_new(cx_typedef(Fast_Expression_o));
    Fast_Node(_this)->kind = kind;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
...
Fast_FloatingPoint Fast_FloatingPoint__new(void) {
    return cx_new(cx_typedef(Fast_FloatingPoint_o));
}

Fast_FloatingPoint Fast_FloatingPoint__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_FloatingPoint_o));
}
...
Fast_FloatingPoint Fast_FloatingPoint__create(cx_float64 value) {
    ...
    _this = cx_new(cx_typedef(Fast_FloatingPoint_o));
    _this->value = value;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
...
Fast_If Fast_If__new(void) {
    return cx_new(cx_typedef(Fast_If_o));
}

Fast_If Fast_If__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_If_o));
}

int Fast_If__define(Fast_If _this, Fast_Expression condition, Fast_Block trueBranch, Fast_If falseBranch) {
    condition ? cx_keep_ext(_this, condition, "element <0x8aa3bf0>.condition") : 0; _this->condition = condition;
    trueBranch ? cx_keep_ext(_this, trueBranch, "element <0x8aa3bf0>.trueBranch") : 0; _this->trueBranch = trueBranch;
    falseBranch ? cx_keep_ext(_this, falseBranch, "element <0x8aa3bf0>.falseBranch") : 0; _this->falseBranch = falseBranch;
    return cx_define(_this);
}
...
Fast_Initializer Fast_Initializer__new(void) {
    return cx_new(cx_typedef(Fast_Initializer_o));
}

Fast_Initializer Fast_Initializer__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_Initializer_o));
}
...
Fast_Initializer Fast_Initializer__create(Fast_InitializerVariable_array64 variables, cx_uint8 variableCount) {
    ...
    _this = cx_new(cx_typedef(Fast_Initializer_o));
    memcpy(_this->variables, variables, sizeof(Fast_InitializerVariable_array64));
    _this->variableCount = variableCount;
    if (cx_define(_this)) {
        cx_free(_this);
...
Fast_InitializerExpr Fast_InitializerExpr__new(void) {
    return cx_new(cx_typedef(Fast_InitializerExpr_o));
}

Fast_InitializerExpr Fast_InitializerExpr__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_InitializerExpr_o));
}
...
Fast_InitializerExpr Fast_InitializerExpr__create(Fast_InitializerVariable_array64 variables, cx_uint8 variableCount, cx_bool assignValue) {
    ...
    _this = cx_new(cx_typedef(Fast_InitializerExpr_o));
    memcpy(Fast_Initializer(_this)->variables, variables, sizeof(Fast_InitializerVariable_array64));
    Fast_Initializer(_this)->variableCount = variableCount;
    _this->assignValue = assignValue;
    if (cx_define(_this)) {
...
void Fast_InitializerFrame__init(Fast_InitializerFrame *_this, cx_uint32 location, cx_type type, cx_bool isKey, cx_member member) {
    ...
    type ? cx_keep_ext(_this, type, "element <0x8a81fd8>.type") : 0; _this->type = type;
    _this->isKey = isKey;
    member ? cx_keep_ext(_this, member, "element <0x8a81fd8>.member") : 0; _this->member = member;
}
...
void Fast_InitializerVariable__init(Fast_InitializerVariable *_this, cx_word offset, Fast_Expression object, cx_word key) {
    ...
    cx_initValue(&v);
    _this->offset = offset;
    object ? cx_keep_ext(_this, object, "element <0x8a85068>.object") : 0; _this->object = object;
    _this->key = key;
}
...
void Fast_InitOper__init(Fast_InitOper *_this, Fast_InitOperKind kind, Fast_Expression expr, cx_string name) {
    ...
    cx_initValue(&v);
    _this->kind = kind;
    expr ? cx_keep_ext(_this, expr, "element <0x8a85068>.expr") : 0; _this->expr = expr;
    _this->name = (name ? cx_strdup(name) : NULL);
}
...
Fast_Integer Fast_Integer__new(void) {
    return cx_new(cx_typedef(Fast_Integer_o));
}

Fast_Integer Fast_Integer__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_Integer_o));
}
...
Fast_Integer Fast_Integer__create(cx_uint64 value) {
    Fast_Integer _this;
    _this = cx_new(cx_typedef(Fast_Integer_o));
    _this->value = value;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
...
Fast_Literal Fast_Literal__new(void) {
    return cx_new(cx_typedef(Fast_Literal_o));
}

Fast_Literal Fast_Literal__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_Literal_o));
}
...
Fast_Literal Fast_Literal__create(Fast_valueKind kind_1) {
    Fast_Literal _this;
    _this = cx_new(cx_typedef(Fast_Literal_o));
    _this->kind = kind_1;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
...
Fast_MemberExpr Fast_MemberExpr__new(void) {
    return cx_new(cx_typedef(Fast_MemberExpr_o));
}

Fast_MemberExpr Fast_MemberExpr__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_MemberExpr_o));
}

int Fast_MemberExpr__define(Fast_MemberExpr _this, Fast_Expression lvalue, Fast_Expression rvalue) {
    lvalue ? cx_keep_ext(_this, lvalue, "element <0x8ab6d70>.lvalue") : 0; _this->lvalue = lvalue;
    rvalue ? cx_keep_ext(_this, rvalue, "element <0x8ab6d70>.rvalue") : 0; _this->rvalue = rvalue;
    return cx_define(_this);
}
...
Fast_NewExpr Fast_NewExpr__new(void) {
    return cx_new(cx_typedef(Fast_NewExpr_o));
}

Fast_NewExpr Fast_NewExpr__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_NewExpr_o));
}

int Fast_NewExpr__define(Fast_NewExpr _this, Fast_Expression type_1, Fast_Expression attributes) {
    type_1 ? cx_keep_ext(_this, type_1, "element <0x8a8fce0>.type") : 0; _this->type = type_1;
    attributes ? cx_keep_ext(_this, attributes, "element <0x8a8fce0>.attributes") : 0; _this->attributes = attributes;
    return cx_define(_this);
}
...
Fast_NewExpr Fast_NewExpr__create(Fast_Expression type_1, Fast_Expression attributes) {
    ...
    type_1 ? cx_keep_ext(_this, type_1, "element <0x8abfc38>.type") : 0; _this->type = type_1;
    attributes ? cx_keep_ext(_this, attributes, "element <0x8abfc38>.attributes") : 0; _this->attributes = attributes;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
    }
...
Fast_Node Fast_Node__new(void) {
    return cx_new(cx_typedef(Fast_Node_o));
}

Fast_Node Fast_Node__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_Node_o));
}
...
Fast_Node Fast_Node__create(Fast_nodeKind kind) {
    Fast_Node _this;
    _this = cx_new(cx_typedef(Fast_Node_o));
    _this->kind = kind;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
...
Fast_Null Fast_Null__new(void) {
    return cx_new(cx_typedef(Fast_Null_o));
}

Fast_Null Fast_Null__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_Null_o));
}
...
Fast_Null Fast_Null__create(void) {
    Fast_Null _this;
    _this = cx_new(cx_typedef(Fast_Null_o));
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
    }
...
Fast_Object Fast_Object__new(void) {
    return cx_new(cx_typedef(Fast_Object_o));
}

Fast_Object Fast_Object__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_Object_o));
}

int Fast_Object__define(Fast_Object _this, cx_object value) {
    value ? cx_keep_ext(_this, value, "element <0x8abfc38>.value") : 0; Fast_ObjectBase(_this)->value = value;
    return cx_define(_this);
}
...
Fast_ObjectBase Fast_ObjectBase__new(void) {
    return cx_new(cx_typedef(Fast_ObjectBase_o));
}

Fast_ObjectBase Fast_ObjectBase__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_ObjectBase_o));
}

int Fast_ObjectBase__define(Fast_ObjectBase _this, cx_object value) {
    value ? cx_keep_ext(_this, value, "element <0x8abfc38>.value") : 0; _this->value = value;
    return cx_define(_this);
}
...
Fast_Parser Fast_Parser__new(void) {
    return cx_new(cx_typedef(Fast_Parser_o));
}

Fast_Parser Fast_Parser__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_Parser_o));
}
...
Fast_Parser Fast_Parser__create(cx_string source, cx_string filename) {
    Fast_Parser _this;
    _this = cx_new(cx_typedef(Fast_Parser_o));
    _this->source = (source ? cx_strdup(source) : NULL);
    _this->filename = (filename ? cx_strdup(filename) : NULL);
    if (cx_define(_this)) {
        cx_free(_this);
...
void Fast_ParserDeclaration__init(Fast_ParserDeclaration *_this, cx_string name, Fast_Variable variable) {
    ...
    cx_initValue(&v);
    _this->name = (name ? cx_strdup(name) : NULL);
    variable ? cx_keep_ext(_this, variable, "element <0x8ae2230>.variable") : 0; _this->variable = variable;
}
...
void Fast_ParserNew__init(Fast_ParserNew *_this, Fast_nodeKind kind, Fast_Expression parent, Fast_Expression name, Fast_Expression attr) {
    ...
    cx_initValue(&v);
    _this->kind = kind;
    parent ? cx_keep_ext(_this, parent, "element <0x8ae5aa0>.parent") : 0; _this->parent = parent;
    name ? cx_keep_ext(_this, name, "element <0x8ae5aa0>.name") : 0; _this->name = name;
    attr ? cx_keep_ext(_this, attr, "element <0x8ae5aa0>.attr") : 0; _this->attr = attr;
}
...
Fast_PostfixExpr Fast_PostfixExpr__new(void) {
    return cx_new(cx_typedef(Fast_PostfixExpr_o));
}

Fast_PostfixExpr Fast_PostfixExpr__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_PostfixExpr_o));
}

int Fast_PostfixExpr__define(Fast_PostfixExpr _this, Fast_Expression lvalue, cx_operatorKind operator) {
    lvalue ? cx_keep_ext(_this, lvalue, "element <0x8ae3210>.lvalue") : 0; _this->lvalue = lvalue;
    _this->operator = operator;
    return cx_define(_this);
}
...
Fast_SignedInteger Fast_SignedInteger__new(void) {
    return cx_new(cx_typedef(Fast_SignedInteger_o));
}

Fast_SignedInteger Fast_SignedInteger__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_SignedInteger_o));
}
...
int Fast_StaticCall__define(Fast_StaticCall _this, Fast_Expression instanceExpr, Fast_Expression arguments, cx_function function) {
    instanceExpr ? cx_keep_ext(_this, instanceExpr, "element <0x8addfb8>.instanceExpr") : 0; Fast_Call(_this)->instanceExpr = instanceExpr;
    arguments ? cx_keep_ext(_this, arguments, "element <0x8addfb8>.arguments") : 0; Fast_Call(_this)->arguments = arguments;
    function ? cx_keep_ext(_this, function, "element <0x8addfb8>.function") : 0; _this->function = function;
    return cx_define(_this);
}
...
Fast_StaticCall Fast_StaticCall__create(Fast_Expression instanceExpr, Fast_Expression arguments, cx_function function) {
    ...
    instanceExpr ? cx_keep_ext(_this, instanceExpr, "element <0x8a9acd8>.instanceExpr") : 0; Fast_Call(_this)->instanceExpr = instanceExpr;
    arguments ? cx_keep_ext(_this, arguments, "element <0x8a9acd8>.arguments") : 0; Fast_Call(_this)->arguments = arguments;
    function ? cx_keep_ext(_this, function, "element <0x8a9acd8>.function") : 0; _this->function = function;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
    }
...
Fast_StaticInitializer Fast_StaticInitializer__new(void) {
    return cx_new(cx_typedef(Fast_StaticInitializer_o));
}

Fast_StaticInitializer Fast_StaticInitializer__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_StaticInitializer_o));
}
...
Fast_StaticInitializer Fast_StaticInitializer__create(Fast_InitializerVariable_array64 variables, cx_uint8 variableCount) {
    ...
    _this = cx_new(cx_typedef(Fast_StaticInitializer_o));
    memcpy(Fast_Initializer(_this)->variables, variables, sizeof(Fast_InitializerVariable_array64));
    Fast_Initializer(_this)->variableCount = variableCount;
    if (cx_define(_this)) {
        cx_free(_this);
...
Fast_String Fast_String__new(void) {
    return cx_new(cx_typedef(Fast_String_o));
}

Fast_String Fast_String__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_String_o));
}
...
Fast_String Fast_String__create(cx_string value) {
    Fast_String _this;
    _this = cx_new(cx_typedef(Fast_String_o));
    _this->value = (value ? cx_strdup(value) : NULL);
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
...
Fast_Template Fast_Template__new(void) {
    return cx_new(cx_typedef(Fast_Template_o));
}

Fast_Template Fast_Template__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_Template_o));
}
...
int Fast_Template__define(Fast_Template _this, cx_string name, Fast_Variable type_1, Fast_LocalKind kind_2, cx_bool isReference_1) {
    ...
    type_1 ? cx_keep_ext(_this, type_1, "element <0x8a8b118>.type") : 0; Fast_Local(_this)->type = type_1;
...
Fast_TernaryExpr Fast_TernaryExpr__new(void) {
    return cx_new(cx_typedef(Fast_TernaryExpr_o));
}

Fast_TernaryExpr Fast_TernaryExpr__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_TernaryExpr_o));
}
...
int Fast_TernaryExpr__define(Fast_TernaryExpr _this, Fast_Expression condition, Fast_Expression ifTrue, Fast_Expression ifFalse, Fast_Expression result) {
    condition ? cx_keep_ext(_this, condition, "element <0x8a90680>.condition") : 0; _this->condition = condition;
    ifTrue ? cx_keep_ext(_this, ifTrue, "element <0x8a90680>.ifTrue") : 0; _this->ifTrue = ifTrue;
    ifFalse ? cx_keep_ext(_this, ifFalse, "element <0x8a90680>.ifFalse") : 0; _this->ifFalse = ifFalse;
    result ? cx_keep_ext(_this, result, "element <0x8a90680>.result") : 0; _this->result = result;
    return cx_define(_this);
}
...
Fast_TernaryExpr Fast_TernaryExpr__create(Fast_Expression condition, Fast_Expression ifTrue, Fast_Expression ifFalse, Fast_Expression result) {
    ...
    condition ? cx_keep_ext(_this, condition, "element <0x8ae52d8>.condition") : 0; _this->condition = condition;
    ifTrue ? cx_keep_ext(_this, ifTrue, "element <0x8ae52d8>.ifTrue") : 0; _this->ifTrue = ifTrue;
    ifFalse ? cx_keep_ext(_this, ifFalse, "element <0x8ae52d8>.ifFalse") : 0; _this->ifFalse = ifFalse;
    result ? cx_keep_ext(_this, result, "element <0x8ae52d8>.result") : 0; _this->result = result;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
    }
...
Fast_UnaryExpr Fast_UnaryExpr__new(void) {
    return cx_new(cx_typedef(Fast_UnaryExpr_o));
}

Fast_UnaryExpr Fast_UnaryExpr__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_UnaryExpr_o));
}

int Fast_UnaryExpr__define(Fast_UnaryExpr _this, Fast_Expression lvalue, cx_operatorKind operator) {
    lvalue ? cx_keep_ext(_this, lvalue, "element <0x8ab6d30>.lvalue") : 0; _this->lvalue = lvalue;
    _this->operator = operator;
    return cx_define(_this);
}
...
Fast_Update Fast_Update__new(void) {
    return cx_new(cx_typedef(Fast_Update_o));
}

Fast_Update Fast_Update__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_Update_o));
}
...
int Fast_Update__define(Fast_Update _this, Fast_Expression_list exprList, Fast_Block block, Fast_Expression from) {
    ...
    block ? cx_keep_ext(_this, block, "element <0x8a92d68>.block") : 0; _this->block = block;
    from ? cx_keep_ext(_this, from, "element <0x8a92d68>.from") : 0; _this->from = from;
    return cx_define(_this);
}
...
Fast_Update Fast_Update__create(Fast_Expression_list exprList, Fast_Block block, Fast_Expression from) {
    ...
    _this->exprList = exprList;
    block ? cx_keep_ext(_this, block, "element <0x8ae0bc0>.block") : 0; _this->block = block;
    from ? cx_keep_ext(_this, from, "element <0x8ae0bc0>.from") : 0; _this->from = from;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
    }
...
Fast_Variable Fast_Variable__new(void) {
    return cx_new(cx_typedef(Fast_Variable_o));
}

Fast_Variable Fast_Variable__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_Variable_o));
}
...
Fast_Variable Fast_Variable__create(Fast_variableKind kind_1) {
    Fast_Variable _this;
    _this = cx_new(cx_typedef(Fast_Variable_o));
    _this->kind = kind_1;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
...
Fast_Wait Fast_Wait__new(void) {
    return cx_new(cx_typedef(Fast_Wait_o));
}

Fast_Wait Fast_Wait__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_Wait_o));
}

int Fast_Wait__define(Fast_Wait _this, Fast_Expression_list exprList, Fast_Expression timeout) {
    _this->exprList = exprList;
    timeout ? cx_keep_ext(_this, timeout, "element <0x8a82e48>.timeout") : 0; _this->timeout = timeout;
    return cx_define(_this);
}
...
Fast_Wait Fast_Wait__create(Fast_Expression_list exprList, Fast_Expression timeout) {
    ...
    _this->exprList = exprList;
    timeout ? cx_keep_ext(_this, timeout, "element <0x8ae19d8>.timeout") : 0; _this->timeout = timeout;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
    }
...
Fast_While Fast_While__new(void) {
    return cx_new(cx_typedef(Fast_While_o));
}

Fast_While Fast_While__declare(cx_object _parent, cx_string _name) {
    return cx_declare(_parent, _name, cx_typedef(Fast_While_o));
}

int Fast_While__define(Fast_While _this, Fast_Expression condition, Fast_Block trueBranch, cx_bool isUntil) {
    condition ? cx_keep_ext(_this, condition, "element <0x8aa5188>.condition") : 0; _this->condition = condition;
    trueBranch ? cx_keep_ext(_this, trueBranch, "element <0x8aa5188>.trueBranch") : 0; _this->trueBranch = trueBranch;
...
Fast_Binding* Fast_Binding_list__insert(Fast_Binding_list list) {
    ...
    {
        cx_value v;
        cx_valueValueInit(&v, NULL, cx_typedef(Fast_Binding_o), result);
        cx_initValue(&v);
    }
...
void Fast_Binding_list__clear(Fast_Binding_list list) {
    ...
    while((element = cx_llTakeFirst(list))) {
        {
            cx_value v;
            cx_valueValueInit(&v, NULL, cx_typedef(Fast_Binding_o), element);
            cx_deinitValue(&v);
        }
        cx_dealloc(element);
    }
...
Fast_InitOper* Fast_InitOper_list__insert(Fast_InitOper_list list) {
    ...
    {
        cx_value v;
        cx_valueValueInit(&v, NULL, cx_typedef(Fast_InitOper_o), result);
        cx_initValue(&v);
    }
    cx_llInsert(list, result);
    return result;
...
void Fast_InitOper_list__clear(Fast_InitOper_list list) {
    ...
    while((element = cx_llTakeFirst(list))) {
        {
            cx_value v;
            cx_valueValueInit(&v, NULL, cx_typedef(Fast_InitOper_o), element);
            cx_deinitValue(&v);
        }
        cx_dealloc(element);
    }
...
Fast_Object Fast_Object_list__takeFirst(Fast_Object_list list) {
    return (Fast_Object)cx_llTakeFirst(list);
}

Fast_Object Fast_Object_list__last(Fast_Object_list list) {
    return (Fast_Object)cx_llLast(list);
}
...
Fast_Object Fast_Object_list__get(Fast_Object_list list, cx_uint32 index) {
    return (Fast_Object)cx_llGet(list, index);
}
...
Fast_ParserDeclaration* Fast_ParserDeclaration_seq256__append(Fast_ParserDeclaration_seq256 *seq) {
    ...
    {
        cx_value v;
        cx_valueValueInit(&v, NULL, cx_typedef(Fast_ParserDeclaration_o), &seq->buffer[seq->length-1]);
        cx_initValue(&v);
    }
...
void Fast_ParserDeclaration_seq256__size(Fast_ParserDeclaration_seq256 *seq, cx_uint32 length) {
    ...
    if (length < seq->length) {
        ...
        for(i=length; i<seq->length; i++) {
            {
                cx_value v;
                cx_valueValueInit(&v, NULL, cx_typedef(Fast_ParserDeclaration_o), &seq->buffer[i]);
                cx_deinitValue(&v);
            }
        }
    }
