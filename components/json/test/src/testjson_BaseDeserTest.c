...
cx_bool _testjson_BaseDeserTest_testName(testjson_BaseDeserTest this, cx_object o, cx_string name) {
...
cx_bool _testjson_BaseDeserTest_testNameParentType(testjson_BaseDeserTest this, cx_object o, cx_string name, cx_object parent, cx_type type) {
/* $begin(::testjson::BaseDeserTest::testNameParentType) */
    if (test_Suite_assert_bool_string(test_Suite(this), o != NULL, "object not initialized")) {
        goto error;
    }
    if (name && testjson_BaseDeserTest_testName(this, o, name)) {
        goto error;
    }
    if (parent && testjson_BaseDeserTest_testParent(this, o, parent)) {
        goto error;
    }
    if (type && testjson_BaseDeserTest_testType(this, o, type)) {
        goto error;
    }
    return FALSE;
error:
...
cx_bool _testjson_BaseDeserTest_testParent(testjson_BaseDeserTest this, cx_object o, cx_object parent) {
...
cx_bool _testjson_BaseDeserTest_testType(testjson_BaseDeserTest this, cx_object o, cx_type type) {
