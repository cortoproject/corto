...
cx_void _testjson_DeserPrimitiveTest_testSimpleString(testjson_DeserPrimitiveTest this) {
/* $begin(::testjson::DeserPrimitiveTest::testSimpleString) */
    cx_object o = cx_json_deser(
        "{\"meta\": {\"name\": \"b\", \"parent\": \"::\", \"type\": \"string\"},"
        "\"value\": \"Hello, World!\"}");
    testjson_BaseDeserTest _this = testjson_BaseDeserTest(this);
    if (testjson_BaseDeserTest_testNameParentType(_this, o, "b", root_o, cx_type(cx_string_o))) {
        goto error;
    }
    ...
    if (test_Suite_assertEqual_any_any(test_Suite(this), _actual, _expected)) {
        goto error;
    }
error:;
/* $end */
...
cx_void _testjson_DeserPrimitiveTest_testStruct_1L(testjson_DeserPrimitiveTest this) {
/* $begin(::testjson::DeserPrimitiveTest::testStruct_1L) */
    cx_object o = cx_json_deser(
        "{\"meta\": {\"name\": \"c\", \"parent\": \"::\", \"type\": \"::testjson::Point\"},"
        "\"value\": {\"x\": 45, \"y\": 3}}");
    testjson_BaseDeserTest _this = testjson_BaseDeserTest(this);
    if (testjson_BaseDeserTest_testNameParentType(_this, o, "c", root_o, cx_type(testjson_Point_o))) {
        goto error;
    }
...
cx_void _testjson_DeserPrimitiveTest_testStruct_2L(testjson_DeserPrimitiveTest this) {
/* $begin(::testjson::DeserPrimitiveTest::testStruct_2L) */
    cx_object o = cx_json_deser(
        "{\"meta\": {\"name\": \"d\", \"parent\": \"::\", \"type\": \"::testjson::Line\"},"
        "\"value\": {\"sense\": true, \"a\": {\"x\": 1, \"y\": 2}, \"b\": {\"x\": 3, \"y\": 4}}}");
    testjson_BaseDeserTest _this = testjson_BaseDeserTest(this);
    if (testjson_BaseDeserTest_testNameParentType(_this, o, "d", root_o, cx_type(testjson_Line_o))) {
        goto error;
    }
...
cx_void _testjson_DeserPrimitiveTest_testStruct_3L(testjson_DeserPrimitiveTest this) {
/* $begin(::testjson::DeserPrimitiveTest::testStruct_3L) */
    cx_object o = cx_json_deser(
        "{\"meta\": {\"name\": \"e\", \"parent\": \"::\", \"type\": \"::testjson::Triangle\"},"
            ...
            "}}");
    testjson_BaseDeserTest _this = testjson_BaseDeserTest(this);
    if (testjson_BaseDeserTest_testNameParentType(_this, o, "e", root_o, cx_type(testjson_Triangle_o))) {
        goto error;
    }
...
cx_void _testjson_DeserPrimitiveTest_testStructRef(testjson_DeserPrimitiveTest this) {
/* $begin(::testjson::DeserPrimitiveTest::testStructRef) */
    ...
    testjson_BaseDeserTest _this = testjson_BaseDeserTest(this);
    if (testjson_BaseDeserTest_testNameParentType(_this, o, "f", root_o, cx_type(testjson_Team_o))) {
        goto error;
    }
...
cx_void _testjson_DeserPrimitiveTest_testUint8(testjson_DeserPrimitiveTest this) {
/* $begin(::testjson::DeserPrimitiveTest::testUint8) */
    cx_object o = cx_json_deser(
        "{\"meta\": {\"name\": \"a\", \"parent\": \"::\", \"type\": \"int8\"},"
        " \"value\": 78}");
    testjson_BaseDeserTest _this = testjson_BaseDeserTest(this);
    if (testjson_BaseDeserTest_testNameParentType(_this, o, "a", root_o, cx_type(cx_int8_o))) {
        goto error;
    }
    cx_int8 expected = 78;
