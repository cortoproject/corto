...
#endif
/* ::MyApp::RedPanda */
MyApp_RedPanda MyApp_RedPanda__create(void);
MyApp_RedPanda MyApp_RedPanda__createChild(cx_object _parent, cx_string _name);

MyApp_RedPanda MyApp_RedPanda__declare(void);
MyApp_RedPanda MyApp_RedPanda__declareChild(cx_object _parent, cx_string _name);
cx_int16 MyApp_RedPanda__define(MyApp_RedPanda _this);
void MyApp_RedPanda__update(MyApp_RedPanda _this);
void MyApp_RedPanda__set(MyApp_RedPanda _this);
