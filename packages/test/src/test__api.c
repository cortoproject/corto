...
int test_suite__define(test_suite _this, cx_object package, cx_bool silent) {
    package ? cx_keep_ext(_this, package, "element <0x96e81f8>.package") : 0; _this->package = package;
    _this->silent = silent;
...
int test_test__define(test_test _this, cx_type returnType, cx_bool returnsReference) {
    returnType ? cx_keep_ext(_this, returnType, "element <0x96a7bb0>.returnType") : 0; cx_function(_this)->returnType = returnType;
