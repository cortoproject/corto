...
int test_suite__define(test_suite _this, cx_object package, cx_bool silent) {
    package ? cx_keep_ext(_this, package, "element <0x7fc1518069a8>.package") : 0; _this->package = package;
    _this->silent = silent;
...
test_suite test_suite__create(cx_object package, cx_bool silent) {
    ...
    package ? cx_keep_ext(_this, package, "element <0x7fc1518068e8>.package") : 0; _this->package = package;
    _this->silent = silent;
    if (cx_define(_this)) {
        cx_free(_this);
        _this = NULL;
...
int test_test__define(test_test _this, cx_type returnType, cx_bool returnsReference) {
    returnType ? cx_keep_ext(_this, returnType, "element <0x7fc151806998>.returnType") : 0; cx_function(_this)->returnType = returnType;
