...
CORTO_EXPORT corto_int16 _corto_replicator_construct(corto_replicator _this);
#define corto_replicator_construct(_this) _corto_replicator_construct(corto_replicator(_this))

CORTO_EXPORT corto_void _corto_replicator_destruct(corto_replicator _this);
#define corto_replicator_destruct(_this) _corto_replicator_destruct(corto_replicator(_this))

CORTO_EXPORT corto_void _corto_replicator_invoke(corto_replicator _this, corto_object instance, corto_function proc, corto_octetseq args);
...
CORTO_EXPORT corto_void _corto_replicator_on_declare(corto_replicator _this, corto_object observable);
#define corto_replicator_on_declare(_this, observable) _corto_replicator_on_declare(corto_replicator(_this), observable)

CORTO_EXPORT corto_void _corto_replicator_on_delete(corto_replicator _this, corto_object observable);
#define corto_replicator_on_delete(_this, observable) _corto_replicator_on_delete(corto_replicator(_this), observable)

CORTO_EXPORT corto_void _corto_replicator_on_update(corto_replicator _this, corto_object observable);
#define corto_replicator_on_update(_this, observable) _corto_replicator_on_update(corto_replicator(_this), observable)

CORTO_EXPORT void _corto_replicator_onDeclare(corto_replicator _this, corto_object observable);
#define corto_replicator_onDeclare(_this, observable) _corto_replicator_onDeclare(corto_replicator(_this), observable)

CORTO_EXPORT corto_void _corto_replicator_onDeclare_v(corto_replicator _this, corto_object observable);
#define corto_replicator_onDeclare_v(_this, observable) _corto_replicator_onDeclare_v(corto_replicator(_this), observable)

CORTO_EXPORT void _corto_replicator_onDelete(corto_replicator _this, corto_object observable);
#define corto_replicator_onDelete(_this, observable) _corto_replicator_onDelete(corto_replicator(_this), observable)

CORTO_EXPORT corto_void _corto_replicator_onDelete_v(corto_replicator _this, corto_object observable);
#define corto_replicator_onDelete_v(_this, observable) _corto_replicator_onDelete_v(corto_replicator(_this), observable)

CORTO_EXPORT void _corto_replicator_onInvoke(corto_replicator _this, corto_object instance, corto_function proc, corto_octetseq args);
...
CORTO_EXPORT corto_void _corto_replicator_onUpdate_v(corto_replicator _this, corto_object observable);
