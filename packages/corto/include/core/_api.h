...
#define corto_attrCreate_auto(_name, value) corto_attr* _name##_o = corto_attrCreate(value); (void)_name##_o
...
#define corto_attrCreateChild_auto(_parent, _name, value) corto_attr* _name##_o = corto_attrCreateChild(_parent, #_name, value); (void)_name##_o
...
#define corto_attrDeclare_auto(_name) corto_attr* _name##_o = corto_attrDeclare(); (void)_name##_o
...
#define corto_attrDeclareChild_auto(_parent, _name) corto_attr* _name##_o = corto_attrDeclareChild(_parent, #_name); (void)_name##_o
...
#define corto_dispatcherCreate_auto(_name) corto_dispatcher _name##_o = corto_dispatcherCreate(); (void)_name##_o
...
#define corto_dispatcherCreateChild_auto(_parent, _name) corto_dispatcher _name##_o = corto_dispatcherCreateChild(_parent, #_name); (void)_name##_o
...
#define corto_dispatcherDeclare_auto(_name) corto_dispatcher _name##_o = corto_dispatcherDeclare(); (void)_name##_o
...
#define corto_dispatcherDeclareChild_auto(_parent, _name) corto_dispatcher _name##_o = corto_dispatcherDeclareChild(_parent, #_name); (void)_name##_o
...
#define corto_equalityKindCreate_auto(_name, value) corto_equalityKind* _name##_o = corto_equalityKindCreate(value); (void)_name##_o
...
#define corto_equalityKindCreateChild_auto(_parent, _name, value) corto_equalityKind* _name##_o = corto_equalityKindCreateChild(_parent, #_name, value); (void)_name##_o
...
#define corto_equalityKindDeclare_auto(_name) corto_equalityKind* _name##_o = corto_equalityKindDeclare(); (void)_name##_o
...
#define corto_equalityKindDeclareChild_auto(_parent, _name) corto_equalityKind* _name##_o = corto_equalityKindDeclareChild(_parent, #_name); (void)_name##_o
...
#define corto_eventCreate_auto(_name, kind) corto_event _name##_o = corto_eventCreate(kind); (void)_name##_o
...
#define corto_eventCreateChild_auto(_parent, _name, kind) corto_event _name##_o = corto_eventCreateChild(_parent, #_name, kind); (void)_name##_o
...
#define corto_eventDeclare_auto(_name) corto_event _name##_o = corto_eventDeclare(); (void)_name##_o
...
#define corto_eventDeclareChild_auto(_parent, _name) corto_event _name##_o = corto_eventDeclareChild(_parent, #_name); (void)_name##_o
...
#define corto_eventMaskCreate_auto(_name, value) corto_eventMask* _name##_o = corto_eventMaskCreate(value); (void)_name##_o
...
#define corto_eventMaskCreateChild_auto(_parent, _name, value) corto_eventMask* _name##_o = corto_eventMaskCreateChild(_parent, #_name, value); (void)_name##_o
...
#define corto_eventMaskDeclare_auto(_name) corto_eventMask* _name##_o = corto_eventMaskDeclare(); (void)_name##_o
...
#define corto_eventMaskDeclareChild_auto(_parent, _name) corto_eventMask* _name##_o = corto_eventMaskDeclareChild(_parent, #_name); (void)_name##_o
...
#define corto_invokeEventCreate_auto(_name, replicator, instance, function, args) corto_invokeEvent _name##_o = corto_invokeEventCreate(replicator, instance, function, args); (void)_name##_o
...
#define corto_invokeEventCreateChild_auto(_parent, _name, replicator, instance, function, args) corto_invokeEvent _name##_o = corto_invokeEventCreateChild(_parent, #_name, replicator, instance, function, args); (void)_name##_o
...
#define corto_invokeEventDeclare_auto(_name) corto_invokeEvent _name##_o = corto_invokeEventDeclare(); (void)_name##_o
...
#define corto_invokeEventDeclareChild_auto(_parent, _name) corto_invokeEvent _name##_o = corto_invokeEventDeclareChild(_parent, #_name); (void)_name##_o
...
#define corto_notifyActionCreate_auto(_name, instance, procedure) corto_notifyAction* _name##_o = corto_notifyActionCreate(instance, procedure); (void)_name##_o
...
#define corto_notifyActionCreateChild_auto(_parent, _name, instance, procedure) corto_notifyAction* _name##_o = corto_notifyActionCreateChild(_parent, #_name, instance, procedure); (void)_name##_o
...
#define corto_notifyActionDeclare_auto(_name) corto_notifyAction* _name##_o = corto_notifyActionDeclare(); (void)_name##_o
...
#define corto_notifyActionDeclareChild_auto(_parent, _name) corto_notifyAction* _name##_o = corto_notifyActionDeclareChild(_parent, #_name); (void)_name##_o
...
#define corto_observableEventCreate_auto(_name, observer, me, source, observable, mask, thread) corto_observableEvent _name##_o = corto_observableEventCreate(observer, me, source, observable, mask, thread); (void)_name##_o
...
#define corto_observableEventCreateChild_auto(_parent, _name, observer, me, source, observable, mask, thread) corto_observableEvent _name##_o = corto_observableEventCreateChild(_parent, #_name, observer, me, source, observable, mask, thread); (void)_name##_o
...
#define corto_observableEventDeclare_auto(_name) corto_observableEvent _name##_o = corto_observableEventDeclare(); (void)_name##_o
...
#define corto_observableEventDeclareChild_auto(_parent, _name) corto_observableEvent _name##_o = corto_observableEventDeclareChild(_parent, #_name); (void)_name##_o
...
#define corto_observerCreate_auto(_name, mask, observable, _impl) corto_observer _name##_o = corto_observerCreate(mask, observable, _impl); (void)_name##_o
...
#define corto_observerCreateChild_auto(_parent, _name, mask, observable, _impl) corto_observer _name##_o = corto_observerCreateChild(_parent, #_name, mask, observable, _impl); (void)_name##_o
...
#define corto_observerDeclare_auto(_name) corto_observer _name##_o = corto_observerDeclare(); (void)_name##_o
...
#define corto_observerDeclareChild_auto(_parent, _name) corto_observer _name##_o = corto_observerDeclareChild(_parent, #_name); (void)_name##_o
...
#define corto_observerseqCreate_auto(_name) corto_observerseq* _name##_o = corto_observerseqCreate(); (void)_name##_o
...
#define corto_observerseqCreateChild_auto(_parent, _name) corto_observerseq* _name##_o = corto_observerseqCreateChild(_parent, #_name); (void)_name##_o
...
#define corto_observerseqDeclare_auto(_name) corto_observerseq* _name##_o = corto_observerseqDeclare(); (void)_name##_o
...
#define corto_observerseqDeclareChild_auto(_parent, _name) corto_observerseq* _name##_o = corto_observerseqDeclareChild(_parent, #_name); (void)_name##_o
...
#define corto_operatorKindCreate_auto(_name, value) corto_operatorKind* _name##_o = corto_operatorKindCreate(value); (void)_name##_o
...
#define corto_operatorKindCreateChild_auto(_parent, _name, value) corto_operatorKind* _name##_o = corto_operatorKindCreateChild(_parent, #_name, value); (void)_name##_o
...
#define corto_operatorKindDeclare_auto(_name) corto_operatorKind* _name##_o = corto_operatorKindDeclare(); (void)_name##_o
...
#define corto_operatorKindDeclareChild_auto(_parent, _name) corto_operatorKind* _name##_o = corto_operatorKindDeclareChild(_parent, #_name); (void)_name##_o
...
#define corto_packageCreate_auto(_name, url) corto_package _name##_o = corto_packageCreate(url); (void)_name##_o
...
#define corto_packageCreateChild_auto(_parent, _name, url) corto_package _name##_o = corto_packageCreateChild(_parent, #_name, url); (void)_name##_o
...
#define corto_packageDeclare_auto(_name) corto_package _name##_o = corto_packageDeclare(); (void)_name##_o
...
#define corto_packageDeclareChild_auto(_parent, _name) corto_package _name##_o = corto_packageDeclareChild(_parent, #_name); (void)_name##_o
...
#define corto_queryCreate_auto(_name, from, mask) corto_query _name##_o = corto_queryCreate(from, mask); (void)_name##_o
...
#define corto_queryCreateChild_auto(_parent, _name, from, mask) corto_query _name##_o = corto_queryCreateChild(_parent, #_name, from, mask); (void)_name##_o
...
#define corto_queryDeclare_auto(_name) corto_query _name##_o = corto_queryDeclare(); (void)_name##_o
...
#define corto_queryDeclareChild_auto(_parent, _name) corto_query _name##_o = corto_queryDeclareChild(_parent, #_name); (void)_name##_o
...
#define corto_replicatorCreate_auto(_name, mount, query, contentType) corto_replicator _name##_o = corto_replicatorCreate(mount, query, contentType); (void)_name##_o
...
#define corto_replicatorCreateChild_auto(_parent, _name, mount, query, contentType) corto_replicator _name##_o = corto_replicatorCreateChild(_parent, #_name, mount, query, contentType); (void)_name##_o
...
#define corto_replicatorDeclare_auto(_name) corto_replicator _name##_o = corto_replicatorDeclare(); (void)_name##_o
...
#define corto_replicatorDeclareChild_auto(_parent, _name) corto_replicator _name##_o = corto_replicatorDeclareChild(_parent, #_name); (void)_name##_o
...
#define corto_resultCreate_auto(_name, name, parent, type, value) corto_result* _name##_o = corto_resultCreate(name, parent, type, value); (void)_name##_o
...
#define corto_resultCreateChild_auto(_parent, _name, name, parent, type, value) corto_result* _name##_o = corto_resultCreateChild(_parent, #_name, name, parent, type, value); (void)_name##_o
...
#define corto_resultDeclare_auto(_name) corto_result* _name##_o = corto_resultDeclare(); (void)_name##_o
...
#define corto_resultDeclareChild_auto(_parent, _name) corto_result* _name##_o = corto_resultDeclareChild(_parent, #_name); (void)_name##_o
...
#define corto_resultIterCreate_auto(_name, value) corto_resultIter* _name##_o = corto_resultIterCreate(value); (void)_name##_o
...
#define corto_resultIterCreateChild_auto(_parent, _name, value) corto_resultIter* _name##_o = corto_resultIterCreateChild(_parent, #_name, value); (void)_name##_o
...
#define corto_resultIterDeclare_auto(_name) corto_resultIter* _name##_o = corto_resultIterDeclare(); (void)_name##_o
...
#define corto_resultIterDeclareChild_auto(_parent, _name) corto_resultIter* _name##_o = corto_resultIterDeclareChild(_parent, #_name); (void)_name##_o
...
#define corto_resultListCreate_auto(_name) corto_resultList* _name##_o = corto_resultListCreate(); (void)_name##_o
...
#define corto_resultListCreateChild_auto(_parent, _name) corto_resultList* _name##_o = corto_resultListCreateChild(_parent, #_name); (void)_name##_o
...
#define corto_resultListDeclare_auto(_name) corto_resultList* _name##_o = corto_resultListDeclare(); (void)_name##_o
...
#define corto_resultListDeclareChild_auto(_parent, _name) corto_resultList* _name##_o = corto_resultListDeclareChild(_parent, #_name); (void)_name##_o
...
#define corto_timeCreate_auto(_name, sec, nanosec) corto_time* _name##_o = corto_timeCreate(sec, nanosec); (void)_name##_o
...
#define corto_timeCreateChild_auto(_parent, _name, sec, nanosec) corto_time* _name##_o = corto_timeCreateChild(_parent, #_name, sec, nanosec); (void)_name##_o
...
#define corto_timeDeclare_auto(_name) corto_time* _name##_o = corto_timeDeclare(); (void)_name##_o
...
#define corto_timeDeclareChild_auto(_parent, _name) corto_time* _name##_o = corto_timeDeclareChild(_parent, #_name); (void)_name##_o
...
CORTO_EXPORT corto_int16 _corto_timeCopy(corto_time* *dst, corto_time* src);
#define corto_timeCopy(dst, src) _corto_timeCopy(dst, src)
CORTO_EXPORT corto_int16 _corto_timeCompare(corto_time* dst, corto_time* src);
#define corto_timeCompare(dst, src) _corto_timeCompare(dst, src)
