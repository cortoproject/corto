...
CORTO_EXPORT corto_void _corto_list_append_any(corto_any _this, corto_any element);
...
CORTO_EXPORT corto_int16 _corto_list_construct(corto_list _this);
#define corto_list_construct(_this) _corto_list_construct(corto_list(_this))

CORTO_EXPORT corto_int16 _corto_list_init(corto_list _this);
...
CORTO_EXPORT corto_void _corto_list_insert_any(corto_any _this, corto_any element);
