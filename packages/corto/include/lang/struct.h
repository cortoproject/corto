...
CORTO_EXPORT corto_bool _corto_struct_castable_v(
    corto_struct this,
    corto_type type);
...
CORTO_EXPORT corto_member _corto_struct_resolveMember_v(
    corto_struct this,
    corto_string name);
