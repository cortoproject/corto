...
CORTO_EXPORT corto_int16 _corto_sequence_construct(corto_sequence _this);
#define corto_sequence_construct(_this) _corto_sequence_construct(corto_sequence(_this))

CORTO_EXPORT corto_int16 _corto_sequence_init(corto_sequence _this);
#define corto_sequence_init(_this) _corto_sequence_init(corto_sequence(_this))

CORTO_EXPORT corto_void _corto_sequence_size(corto_any _this, corto_uint32 size);
