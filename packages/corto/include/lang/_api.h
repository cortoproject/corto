...
#define corto_alias__optional_Set(member) corto_aliasAssign(corto_alloc(sizeof(corto_alias)), member)
...
#define corto_aliasSet(_this, member) _this = _this ? _this : corto_alloc(sizeof(corto_alias_o)); _corto_aliasAssign(corto_alias(_this), corto_member(member))
...
#define corto_any__optional_Set(type, value) corto_anyAssign(corto_alloc(sizeof(corto_any)), type, value)
...
#define corto_anySet(_this, type, value) _this = _this ? _this : corto_alloc(sizeof(corto_any_o)); _corto_anyAssign(_this, corto_type(type), value)
...
#define corto_array__optional_Set(elementType, max) corto_arrayAssign(corto_alloc(sizeof(corto_array)), elementType, max)
...
#define corto_arraySet(_this, elementType, max) _this = _this ? _this : corto_alloc(sizeof(corto_array_o)); _corto_arrayAssign(corto_array(_this), corto_type(elementType), max)
...
#define corto_binary__optional_Set(width) corto_binaryAssign(corto_alloc(sizeof(corto_binary)), width)
...
#define corto_binarySet(_this, width) _this = _this ? _this : corto_alloc(sizeof(corto_binary_o)); _corto_binaryAssign(corto_binary(_this), width)
...
#define corto_bitmask__optional_Set() corto_bitmaskAssign(corto_alloc(sizeof(corto_bitmask)))
...
#define corto_bitmaskSet(_this) _this = _this ? _this : corto_alloc(sizeof(corto_bitmask_o)); _corto_bitmaskAssign(corto_bitmask(_this))
...
#define corto_bool__optional_Set(value) corto_boolAssign(corto_alloc(sizeof(corto_bool)), value)
...
#define corto_boolSet(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_bool_o)); _corto_boolAssign(_this, value)
...
#define corto_boolean__optional_Set() corto_booleanAssign(corto_alloc(sizeof(corto_boolean)))
...
#define corto_booleanSet(_this) _this = _this ? _this : corto_alloc(sizeof(corto_boolean_o)); _corto_booleanAssign(corto_boolean(_this))
...
#define corto_case__optional_Set(discriminator, type) corto_caseAssign(corto_alloc(sizeof(corto_case)), discriminator, type)
...
#define corto_caseSet(_this, discriminator, type) _this = _this ? _this : corto_alloc(sizeof(corto_case_o)); _corto_caseAssign(corto_case(_this), discriminator, corto_type(type))
...
#define corto_char__optional_Set(value) corto_charAssign(corto_alloc(sizeof(corto_char)), value)
...
#define corto_charSet(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_char_o)); _corto_charAssign(_this, value)
...
#define corto_character__optional_Set(width) corto_characterAssign(corto_alloc(sizeof(corto_character)), width)
...
#define corto_characterSet(_this, width) _this = _this ? _this : corto_alloc(sizeof(corto_character_o)); _corto_characterAssign(corto_character(_this), width)
...
#define corto_class__optional_Set(base, baseAccess, implements) corto_classAssign(corto_alloc(sizeof(corto_class)), base, baseAccess, implements)
...
#define corto_classSet(_this, base, baseAccess, implements) _this = _this ? _this : corto_alloc(sizeof(corto_class_o)); _corto_classAssign(corto_class(_this), corto_interface(base), baseAccess, implements)
...
#define corto_collection__optional_Set(elementType, max) corto_collectionAssign(corto_alloc(sizeof(corto_collection)), elementType, max)
...
#define corto_collectionSet(_this, elementType, max) _this = _this ? _this : corto_alloc(sizeof(corto_collection_o)); _corto_collectionAssign(corto_collection(_this), corto_type(elementType), max)
...
#define corto_collectionKind__optional_Set(value) corto_collectionKindAssign(corto_alloc(sizeof(corto_collectionKind)), value)
...
#define corto_collectionKindSet(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_collectionKind_o)); _corto_collectionKindAssign(_this, value)
...
#define corto_compositeKind__optional_Set(value) corto_compositeKindAssign(corto_alloc(sizeof(corto_compositeKind)), value)
...
#define corto_compositeKindSet(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_compositeKind_o)); _corto_compositeKindAssign(_this, value)
...
#define corto_constant__optional_Set(value) corto_constantAssign(corto_alloc(sizeof(corto_constant)), value)
...
#define corto_constantSet(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_constant_o)); _corto_constantAssign(_this, value)
...
#define corto_default__optional_Set(type) corto_defaultAssign(corto_alloc(sizeof(corto_default)), type)
...
#define corto_defaultSet(_this, type) _this = _this ? _this : corto_alloc(sizeof(corto_default_o)); _corto_defaultAssign(corto_default(_this), corto_type(type))
...
#define corto_delegate__optional_Set(returnType, returnsReference, parameters) corto_delegateAssign(corto_alloc(sizeof(corto_delegate)), returnType, returnsReference, parameters)
...
#define corto_delegateSet(_this, returnType, returnsReference, parameters) _this = _this ? _this : corto_alloc(sizeof(corto_delegate_o)); _corto_delegateAssign(corto_delegate(_this), corto_type(returnType), returnsReference, parameters)
...
#define corto_delegatedata__optional_Set(instance, procedure) corto_delegatedataAssign(corto_alloc(sizeof(corto_delegatedata)), instance, procedure)
...
#define corto_delegatedataSet(_this, instance, procedure) _this = _this ? _this : corto_alloc(sizeof(corto_delegatedata_o)); _corto_delegatedataAssign(_this, instance, corto_function(procedure))
...
#define corto_destructAction__optional_Set(instance, procedure) corto_destructActionAssign(corto_alloc(sizeof(corto_destructAction)), instance, procedure)
...
#define corto_destructActionSet(_this, instance, procedure) _this = _this ? _this : corto_alloc(sizeof(corto_destructAction_o)); _corto_destructActionAssign(_this, instance, corto_function(procedure))
...
#define corto_enum__optional_Set() corto_enumAssign(corto_alloc(sizeof(corto_enum)))
...
#define corto_enumSet(_this) _this = _this ? _this : corto_alloc(sizeof(corto_enum_o)); _corto_enumAssign(corto_enum(_this))
...
#define corto_equalityKind__optional_Set(value) corto_equalityKindAssign(corto_alloc(sizeof(corto_equalityKind)), value)
...
#define corto_equalityKindSet(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_equalityKind_o)); _corto_equalityKindAssign(_this, value)
...
#define corto_float__optional_Set(width, min, max) corto_floatAssign(corto_alloc(sizeof(corto_float)), width, min, max)
...
#define corto_floatSet(_this, width, min, max) _this = _this ? _this : corto_alloc(sizeof(corto_float_o)); _corto_floatAssign(corto_float(_this), width, min, max)
...
#define corto_float32__optional_Set(value) corto_float32Assign(corto_alloc(sizeof(corto_float32)), value)
...
#define corto_float32Set(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_float32_o)); _corto_float32Assign(_this, value)
...
#define corto_float64__optional_Set(value) corto_float64Assign(corto_alloc(sizeof(corto_float64)), value)
...
#define corto_float64Set(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_float64_o)); _corto_float64Assign(_this, value)
...
#define corto_function__optional_Set(returnType, returnsReference, _impl) corto_functionAssign(corto_alloc(sizeof(corto_function)), returnType, returnsReference, _impl)
...
#define corto_functionSet(_this, returnType, returnsReference, _impl) _this = _this ? _this : corto_alloc(sizeof(corto_function_o)); _corto_functionAssign(corto_function(_this), corto_type(returnType), returnsReference, (void(*)(void))_impl)
...
#define corto_initAction__optional_Set(instance, procedure) corto_initActionAssign(corto_alloc(sizeof(corto_initAction)), instance, procedure)
...
#define corto_initActionSet(_this, instance, procedure) _this = _this ? _this : corto_alloc(sizeof(corto_initAction_o)); _corto_initActionAssign(_this, instance, corto_function(procedure))
...
#define corto_int__optional_Set(width, min, max) corto_intAssign(corto_alloc(sizeof(corto_int)), width, min, max)
...
#define corto_intSet(_this, width, min, max) _this = _this ? _this : corto_alloc(sizeof(corto_int_o)); _corto_intAssign(corto_int(_this), width, min, max)
...
#define corto_int16__optional_Set(value) corto_int16Assign(corto_alloc(sizeof(corto_int16)), value)
...
#define corto_int16Set(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_int16_o)); _corto_int16Assign(_this, value)
...
#define corto_int32__optional_Set(value) corto_int32Assign(corto_alloc(sizeof(corto_int32)), value)
...
#define corto_int32Set(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_int32_o)); _corto_int32Assign(_this, value)
...
#define corto_int32seq__optional_Set(length, elements) corto_int32seqAssign(corto_alloc(sizeof(corto_int32seq)), length, elements)
...
#define corto_int32seqSet(_this, length, elements) _this = _this ? _this : corto_alloc(sizeof(corto_int32seq_o)); _corto_int32seqAssign(_this, length, elements)
...
#define corto_int64__optional_Set(value) corto_int64Assign(corto_alloc(sizeof(corto_int64)), value)
...
#define corto_int64Set(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_int64_o)); _corto_int64Assign(_this, value)
...
#define corto_int8__optional_Set(value) corto_int8Assign(corto_alloc(sizeof(corto_int8)), value)
...
#define corto_int8Set(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_int8_o)); _corto_int8Assign(_this, value)
...
#define corto_interface__optional_Set(base) corto_interfaceAssign(corto_alloc(sizeof(corto_interface)), base)
...
#define corto_interfaceSet(_this, base) _this = _this ? _this : corto_alloc(sizeof(corto_interface_o)); _corto_interfaceAssign(corto_interface(_this), corto_interface(base))
...
#define corto_interfaceseq__optional_Set(length, elements) corto_interfaceseqAssign(corto_alloc(sizeof(corto_interfaceseq)), length, elements)
...
#define corto_interfaceseqSet(_this, length, elements) _this = _this ? _this : corto_alloc(sizeof(corto_interfaceseq_o)); _corto_interfaceseqAssign(_this, length, elements)
...
#define corto_interfaceVector__optional_Set(interface, vector) corto_interfaceVectorAssign(corto_alloc(sizeof(corto_interfaceVector)), interface, vector)
...
#define corto_interfaceVectorSet(_this, interface, vector) _this = _this ? _this : corto_alloc(sizeof(corto_interfaceVector_o)); _corto_interfaceVectorAssign(_this, corto_interface(interface), vector)
...
#define corto_interfaceVectorseq__optional_Set(length, elements) corto_interfaceVectorseqAssign(corto_alloc(sizeof(corto_interfaceVectorseq)), length, elements)
...
#define corto_interfaceVectorseqSet(_this, length, elements) _this = _this ? _this : corto_alloc(sizeof(corto_interfaceVectorseq_o)); _corto_interfaceVectorseqAssign(_this, length, elements)
...
#define corto_iterator__optional_Set(elementType) corto_iteratorAssign(corto_alloc(sizeof(corto_iterator)), elementType)
...
#define corto_iteratorSet(_this, elementType) _this = _this ? _this : corto_alloc(sizeof(corto_iterator_o)); _corto_iteratorAssign(corto_iterator(_this), corto_type(elementType))
...
#define corto_list__optional_Set(elementType, max) corto_listAssign(corto_alloc(sizeof(corto_list)), elementType, max)
...
#define corto_listSet(_this, elementType, max) _this = _this ? _this : corto_alloc(sizeof(corto_list_o)); _corto_listAssign(corto_list(_this), corto_type(elementType), max)
...
#define corto_map__optional_Set(elementType, keyType, max) corto_mapAssign(corto_alloc(sizeof(corto_map)), elementType, keyType, max)
...
#define corto_mapSet(_this, elementType, keyType, max) _this = _this ? _this : corto_alloc(sizeof(corto_map_o)); _corto_mapAssign(corto_map(_this), corto_type(elementType), corto_type(keyType), max)
...
#define corto_member__optional_Set(type, modifiers) corto_memberAssign(corto_alloc(sizeof(corto_member)), type, modifiers)
...
#define corto_memberSet(_this, type, modifiers) _this = _this ? _this : corto_alloc(sizeof(corto_member_o)); _corto_memberAssign(corto_member(_this), corto_type(type), modifiers)
...
#define corto_memberseq__optional_Set(length, elements) corto_memberseqAssign(corto_alloc(sizeof(corto_memberseq)), length, elements)
...
#define corto_memberseqSet(_this, length, elements) _this = _this ? _this : corto_alloc(sizeof(corto_memberseq_o)); _corto_memberseqAssign(_this, length, elements)
...
#define corto_metaprocedure__optional_Set(returnType, returnsReference, referenceOnly, _impl) corto_metaprocedureAssign(corto_alloc(sizeof(corto_metaprocedure)), returnType, returnsReference, referenceOnly, _impl)
...
#define corto_metaprocedureSet(_this, returnType, returnsReference, referenceOnly, _impl) _this = _this ? _this : corto_alloc(sizeof(corto_metaprocedure_o)); _corto_metaprocedureAssign(corto_metaprocedure(_this), corto_type(returnType), returnsReference, referenceOnly, (void(*)(void))_impl)
...
#define corto_method__optional_Set(returnType, returnsReference, _virtual, _impl) corto_methodAssign(corto_alloc(sizeof(corto_method)), returnType, returnsReference, _virtual, _impl)
...
#define corto_methodSet(_this, returnType, returnsReference, _virtual, _impl) _this = _this ? _this : corto_alloc(sizeof(corto_method_o)); _corto_methodAssign(corto_method(_this), corto_type(returnType), returnsReference, _virtual, (void(*)(void))_impl)
...
#define corto_modifier__optional_Set(value) corto_modifierAssign(corto_alloc(sizeof(corto_modifier)), value)
...
#define corto_modifierSet(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_modifier_o)); _corto_modifierAssign(_this, value)
...
#define corto_nameAction__optional_Set(instance, procedure) corto_nameActionAssign(corto_alloc(sizeof(corto_nameAction)), instance, procedure)
...
#define corto_nameActionSet(_this, instance, procedure) _this = _this ? _this : corto_alloc(sizeof(corto_nameAction_o)); _corto_nameActionAssign(_this, instance, corto_function(procedure))
...
#define corto_objectseq__optional_Set(length, elements) corto_objectseqAssign(corto_alloc(sizeof(corto_objectseq)), length, elements)
...
#define corto_objectseqSet(_this, length, elements) _this = _this ? _this : corto_alloc(sizeof(corto_objectseq_o)); _corto_objectseqAssign(_this, length, elements)
...
#define corto_octet__optional_Set(value) corto_octetAssign(corto_alloc(sizeof(corto_octet)), value)
...
#define corto_octetSet(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_octet_o)); _corto_octetAssign(_this, value)
...
#define corto_octetseq__optional_Set(length, elements) corto_octetseqAssign(corto_alloc(sizeof(corto_octetseq)), length, elements)
...
#define corto_octetseqSet(_this, length, elements) _this = _this ? _this : corto_alloc(sizeof(corto_octetseq_o)); _corto_octetseqAssign(_this, length, elements)
...
#define corto_parameter__optional_Set(name, type, passByReference) corto_parameterAssign(corto_alloc(sizeof(corto_parameter)), name, type, passByReference)
...
#define corto_parameterSet(_this, name, type, passByReference) _this = _this ? _this : corto_alloc(sizeof(corto_parameter_o)); _corto_parameterAssign(_this, name, corto_type(type), passByReference)
...
#define corto_parameterseq__optional_Set(length, elements) corto_parameterseqAssign(corto_alloc(sizeof(corto_parameterseq)), length, elements)
...
#define corto_parameterseqSet(_this, length, elements) _this = _this ? _this : corto_alloc(sizeof(corto_parameterseq_o)); _corto_parameterseqAssign(_this, length, elements)
...
#define corto_primitive__optional_Set(width) corto_primitiveAssign(corto_alloc(sizeof(corto_primitive)), width)
...
#define corto_primitiveSet(_this, width) _this = _this ? _this : corto_alloc(sizeof(corto_primitive_o)); _corto_primitiveAssign(corto_primitive(_this), width)
...
#define corto_primitiveKind__optional_Set(value) corto_primitiveKindAssign(corto_alloc(sizeof(corto_primitiveKind)), value)
...
#define corto_primitiveKindSet(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_primitiveKind_o)); _corto_primitiveKindAssign(_this, value)
...
#define corto_procedure__optional_Set(kind_1) corto_procedureAssign(corto_alloc(sizeof(corto_procedure)), kind_1)
...
#define corto_procedureSet(_this, kind_1) _this = _this ? _this : corto_alloc(sizeof(corto_procedure_o)); _corto_procedureAssign(corto_procedure(_this), kind_1)
...
#define corto_procedureKind__optional_Set(value) corto_procedureKindAssign(corto_alloc(sizeof(corto_procedureKind)), value)
...
#define corto_procedureKindSet(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_procedureKind_o)); _corto_procedureKindAssign(_this, value)
...
#define corto_sequence__optional_Set(elementType, max) corto_sequenceAssign(corto_alloc(sizeof(corto_sequence)), elementType, max)
...
#define corto_sequenceSet(_this, elementType, max) _this = _this ? _this : corto_alloc(sizeof(corto_sequence_o)); _corto_sequenceAssign(corto_sequence(_this), corto_type(elementType), max)
...
#define corto_state__optional_Set(value) corto_stateAssign(corto_alloc(sizeof(corto_state)), value)
...
#define corto_stateSet(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_state_o)); _corto_stateAssign(_this, value)
...
#define corto_string__optional_Set(value) corto_stringAssign(corto_alloc(sizeof(corto_string)), value)
...
#define corto_stringSet(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_string_o)); _corto_stringAssign(_this, value)
...
#define corto_struct__optional_Set(base, baseAccess) corto_structAssign(corto_alloc(sizeof(corto_struct)), base, baseAccess)
...
#define corto_structSet(_this, base, baseAccess) _this = _this ? _this : corto_alloc(sizeof(corto_struct_o)); _corto_structAssign(corto_struct(_this), corto_interface(base), baseAccess)
...
#define corto_text__optional_Set(charWidth, length) corto_textAssign(corto_alloc(sizeof(corto_text)), charWidth, length)
...
#define corto_textSet(_this, charWidth, length) _this = _this ? _this : corto_alloc(sizeof(corto_text_o)); _corto_textAssign(corto_text(_this), charWidth, length)
...
#define corto_type__optional_Set(kind, reference) corto_typeAssign(corto_alloc(sizeof(corto_type)), kind, reference)
...
#define corto_typeSet(_this, kind, reference) _this = _this ? _this : corto_alloc(sizeof(corto_type_o)); _corto_typeAssign(corto_type(_this), kind, reference)
...
#define corto_typeKind__optional_Set(value) corto_typeKindAssign(corto_alloc(sizeof(corto_typeKind)), value)
...
#define corto_typeKindSet(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_typeKind_o)); _corto_typeKindAssign(_this, value)
...
#define corto_typespec__optional_Set(type, reference) corto_typespecAssign(corto_alloc(sizeof(corto_typespec)), type, reference)
...
#define corto_typespecSet(_this, type, reference) _this = _this ? _this : corto_alloc(sizeof(corto_typespec_o)); _corto_typespecAssign(_this, corto_type(type), reference)
...
#define corto_uint__optional_Set(width, min, max) corto_uintAssign(corto_alloc(sizeof(corto_uint)), width, min, max)
...
#define corto_uintSet(_this, width, min, max) _this = _this ? _this : corto_alloc(sizeof(corto_uint_o)); _corto_uintAssign(corto_uint(_this), width, min, max)
...
#define corto_uint16__optional_Set(value) corto_uint16Assign(corto_alloc(sizeof(corto_uint16)), value)
...
#define corto_uint16Set(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_uint16_o)); _corto_uint16Assign(_this, value)
...
#define corto_uint32__optional_Set(value) corto_uint32Assign(corto_alloc(sizeof(corto_uint32)), value)
...
#define corto_uint32Set(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_uint32_o)); _corto_uint32Assign(_this, value)
...
#define corto_uint64__optional_Set(value) corto_uint64Assign(corto_alloc(sizeof(corto_uint64)), value)
...
#define corto_uint64Set(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_uint64_o)); _corto_uint64Assign(_this, value)
...
#define corto_uint8__optional_Set(value) corto_uint8Assign(corto_alloc(sizeof(corto_uint8)), value)
...
#define corto_uint8Set(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_uint8_o)); _corto_uint8Assign(_this, value)
...
#define corto_union__optional_Set(discriminator) corto_unionAssign(corto_alloc(sizeof(corto_union)), discriminator)
...
#define corto_unionSet(_this, discriminator) _this = _this ? _this : corto_alloc(sizeof(corto_union_o)); _corto_unionAssign(corto_union(_this), corto_type(discriminator))
...
#define corto_virtual__optional_Set(returnType, returnsReference, _virtual, _impl) corto_virtualAssign(corto_alloc(sizeof(corto_virtual)), returnType, returnsReference, _virtual, _impl)
...
#define corto_virtualSet(_this, returnType, returnsReference, _virtual, _impl) _this = _this ? _this : corto_alloc(sizeof(corto_virtual_o)); _corto_virtualAssign(corto_virtual(_this), corto_type(returnType), returnsReference, _virtual, (void(*)(void))_impl)
...
#define corto_vtable__optional_Set(length, elements) corto_vtableAssign(corto_alloc(sizeof(corto_vtable)), length, elements)
...
#define corto_vtableSet(_this, length, elements) _this = _this ? _this : corto_alloc(sizeof(corto_vtable_o)); _corto_vtableAssign(_this, length, elements)
...
#define corto_width__optional_Set(value) corto_widthAssign(corto_alloc(sizeof(corto_width)), value)
...
#define corto_widthSet(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_width_o)); _corto_widthAssign(_this, value)
...
#define corto_word__optional_Set(value) corto_wordAssign(corto_alloc(sizeof(corto_word)), value)
...
#define corto_wordSet(_this, value) _this = _this ? _this : corto_alloc(sizeof(corto_word_o)); _corto_wordAssign(_this, value)
