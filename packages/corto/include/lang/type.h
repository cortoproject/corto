...
CORTO_EXPORT corto_bool _corto_type_checkAttr(corto_any this,
    corto_attr attributes);
#define corto_type_checkAttr(_this, attributes) _corto_type_checkAttr(_this, attributes)

CORTO_EXPORT corto_bool _corto_type_checkState(corto_any this,
    corto_state state);
#define corto_type_checkState(_this, state) _corto_type_checkState(_this, state)

CORTO_EXPORT corto_equalityKind _corto_type_compare(corto_any this,
    corto_any value);
...
CORTO_EXPORT corto_int16 _corto_type_copy(corto_any this,
    corto_any value);
#define corto_type_copy(_this, value) _corto_type_copy(_this, value)

CORTO_EXPORT corto_object _corto_type_declare(corto_any this,
    corto_string name,
    corto_type type);
#define corto_type_declare(_this, name, type) _corto_type_declare(_this, name, corto_type(type))

CORTO_EXPORT corto_int16 _corto_type_define(corto_any this);
#define corto_type_define(_this) _corto_type_define(_this)

CORTO_EXPORT corto_void _corto_type_delete(corto_any this);
...
CORTO_EXPORT corto_string _corto_type_fullpath(corto_any this);
...
CORTO_EXPORT corto_bool _corto_type_instanceof(corto_any this,
    corto_type type);
#define corto_type_instanceof(_this, type) _corto_type_instanceof(_this, corto_type(type))

CORTO_EXPORT corto_void _corto_type_invalidate(corto_any this);
#define corto_type_invalidate(_this) _corto_type_invalidate(_this)

CORTO_EXPORT corto_object _corto_type_lookup(corto_any this,
    corto_string name);
#define corto_type_lookup(_this, name) _corto_type_lookup(_this, name)

CORTO_EXPORT corto_string _corto_type_name(corto_any this);
#define corto_type_name(_this) _corto_type_name(_this)

CORTO_EXPORT corto_object _corto_type_parent(corto_any this);
#define corto_type_parent(_this) _corto_type_parent(_this)

CORTO_EXPORT corto_string _corto_type_path(corto_any this,
    corto_object from);
#define corto_type_path(_this, from) _corto_type_path(_this, from)

CORTO_EXPORT corto_object _corto_type_resolve(corto_any this,
    corto_string name);
...
CORTO_EXPORT corto_string _corto_type_str(corto_any this);
#define corto_type_str(_this) _corto_type_str(_this)

CORTO_EXPORT corto_type _corto_type_type(corto_any this);
