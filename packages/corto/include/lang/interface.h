...
CORTO_EXPORT corto_int16 _corto_interface_baseof(
...
CORTO_EXPORT corto_int16 _corto_interface_bindMethod(
    corto_interface _this,
    corto_method method);
