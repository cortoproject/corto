...
CORTO_EXPORT corto_void _corto_procedure_destruct(
    corto_procedure _this,
    corto_function object);
#define corto_procedure_destruct(_this, object) _corto_procedure_destruct(corto_procedure(_this), corto_function(object))
