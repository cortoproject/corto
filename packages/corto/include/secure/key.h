...
CORTO_EXPORT corto_string _corto_secure_key_authenticate(
...
CORTO_EXPORT corto_string _corto_secure_key_authenticate_v(
    corto_secure_key _this,
    corto_string user,
    corto_string password);
...
CORTO_EXPORT corto_int16 _corto_secure_key_construct(
    corto_secure_key _this);
#define corto_secure_key_construct(_this) _corto_secure_key_construct(corto_secure_key(_this))

CORTO_EXPORT corto_void _corto_secure_key_destruct(
    corto_secure_key _this);
