...
CORTO_EXPORT void _corto_native_typeSet(corto_native_type _this, corto_string name);
#define corto_native_typeSet(_this, name) _corto_native_typeSet(corto_native_type(_this), name)
