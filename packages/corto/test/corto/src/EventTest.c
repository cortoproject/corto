...
/* $begin(test/EventTest/construct) */
    ...
    corto_listen(this, test_EventTest_onUpdateDefine_o, 0, this->scope, NULL);
    corto_listen(this, test_EventTest_onUpdateDefineSelf_o, 0, this->scope, NULL);
    corto_listen(this, test_EventTest_onUpdateDefineScope_o, 0, this->scope, NULL);
    corto_listen(this, test_EventTest_onUpdateDefineTree_o, 0, this->scope, NULL);

    return 0;
/* $end */
}

corto_void _test_EventTest_destruct(
    test_EventTest this)
{
/* $begin(test/EventTest/destruct) */
    ...
    corto_silence(this, test_EventTest_onUpdateDefine_o, 0, this->scope);
    corto_silence(this, test_EventTest_onUpdateDefineSelf_o, 0, this->scope);
    corto_silence(this, test_EventTest_onUpdateDefineScope_o, 0, this->scope);
    corto_silence(this, test_EventTest_onUpdateDefineTree_o, 0, this->scope);

/* $end */
}

corto_void _test_EventTest_onDeclare(
    test_EventTest this,
...
corto_void _test_EventTest_onDeclareScope(
    test_EventTest this,
    corto_object observable)
{
...
corto_void _test_EventTest_onDeclareSelf(
    test_EventTest this,
    corto_object observable)
{
...
corto_void _test_EventTest_onDeclareTree(
    test_EventTest this,
    corto_object observable)
{
...
corto_void _test_EventTest_onDefine(
    test_EventTest this,
    corto_object observable)
{
...
corto_void _test_EventTest_onDefineScope(
    test_EventTest this,
    corto_object observable)
{
...
corto_void _test_EventTest_onDefineSelf(
    test_EventTest this,
    corto_object observable)
{
...
corto_void _test_EventTest_onDefineTree(
    test_EventTest this,
    corto_object observable)
{
...
corto_void _test_EventTest_onDelete(
    test_EventTest this,
    corto_object observable)
{
...
corto_void _test_EventTest_onDeleteScope(
    test_EventTest this,
    corto_object observable)
{
...
corto_void _test_EventTest_onDeleteSelf(
    test_EventTest this,
    corto_object observable)
{
...
corto_void _test_EventTest_onDeleteTree(
    test_EventTest this,
    corto_object observable)
{
...
corto_void _test_EventTest_onUpdate(
    test_EventTest this,
    corto_object observable)
{
...
corto_void _test_EventTest_onUpdateDefine(
    test_EventTest this,
    corto_object observable)
{
...
corto_void _test_EventTest_onUpdateDefineScope(
    test_EventTest this,
    corto_object observable)
{
...
corto_void _test_EventTest_onUpdateDefineSelf(
    test_EventTest this,
    corto_object observable)
{
...
corto_void _test_EventTest_onUpdateDefineTree(
    test_EventTest this,
    corto_object observable)
{
...
corto_void _test_EventTest_onUpdateScope(
    test_EventTest this,
    corto_object observable)
{
...
corto_void _test_EventTest_onUpdateSelf(
    test_EventTest this,
    corto_object observable)
{
...
corto_void _test_EventTest_onUpdateTree(
    test_EventTest this,
    corto_object observable)
{
