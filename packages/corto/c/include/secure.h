...
CORTO_EXPORT int16_t _corto_secure_accessKindUpdate(corto_secure_accessKind* _this, corto_secure_accessKind value);
...
CORTO_EXPORT int16_t _corto_secure_accessKindDefine(corto_secure_accessKind* _this, corto_secure_accessKind value);
...
CORTO_EXPORT int16_t _corto_secure_accessKindInit(corto_secure_accessKind* value);
#define corto_secure_accessKindInit(value) _corto_secure_accessKindInit(value)
CORTO_EXPORT int16_t _corto_secure_accessKindDeinit(corto_secure_accessKind* value);
...
CORTO_EXPORT int16_t _corto_secure_actionKindUpdate(corto_secure_actionKind* _this, corto_secure_actionKind value);
...
CORTO_EXPORT int16_t _corto_secure_actionKindDefine(corto_secure_actionKind* _this, corto_secure_actionKind value);
...
CORTO_EXPORT int16_t _corto_secure_actionKindInit(corto_secure_actionKind* value);
#define corto_secure_actionKindInit(value) _corto_secure_actionKindInit(value)
CORTO_EXPORT int16_t _corto_secure_actionKindDeinit(corto_secure_actionKind* value);
...
CORTO_EXPORT int16_t _corto_secure_keyUpdate(corto_secure_key _this);
...
CORTO_EXPORT int16_t _corto_secure_keyDefine(corto_secure_key _this);
...
CORTO_EXPORT int16_t _corto_secure_lockUpdate(corto_secure_lock _this, corto_string mount, corto_string expr, int16_t priority);
...
CORTO_EXPORT int16_t _corto_secure_lockDefine(corto_secure_lock _this, corto_string mount, corto_string expr, int16_t priority);
