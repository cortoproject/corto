...
CORTO_LANG_EXPORT void corto_aliasUpdate(corto_alias _this, corto_member member);
...
CORTO_LANG_EXPORT void corto_anyUpdate(corto_any* _this, corto_any value);
...
CORTO_LANG_EXPORT void corto_arrayUpdate(corto_array _this, corto_type elementType, corto_uint32 max);
...
CORTO_LANG_EXPORT void corto_attrUpdate(corto_attr* _this, corto_attr value);
...
CORTO_LANG_EXPORT void corto_binaryUpdate(corto_binary _this, corto_width width);
...
CORTO_LANG_EXPORT void corto_bitmaskUpdate(corto_bitmask _this);
...
CORTO_LANG_EXPORT void corto_boolUpdate(corto_bool* _this, corto_bool value);
...
CORTO_LANG_EXPORT void corto_booleanUpdate(corto_boolean _this);
...
CORTO_LANG_EXPORT void corto_charUpdate(corto_char* _this, corto_char value);
...
CORTO_LANG_EXPORT void corto_characterUpdate(corto_character _this, corto_width width);
...
/* ::corto::lang::class */
CORTO_LANG_EXPORT corto_class corto_classCreate(corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType);
CORTO_LANG_EXPORT corto_class corto_classCreateChild(corto_object _parent, corto_string _name, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType);
...
CORTO_LANG_EXPORT corto_int16 corto_classDefine(corto_class _this, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType);
CORTO_LANG_EXPORT void corto_classUpdate(corto_class _this, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType);
CORTO_LANG_EXPORT void corto_classSet(corto_class _this, corto_interface base, corto_modifier baseAccess, corto_interfaceseq implements, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType);
...
CORTO_LANG_EXPORT void corto_collectionUpdate(corto_collection _this, corto_type elementType, corto_uint32 max);
...
CORTO_LANG_EXPORT void corto_collectionKindUpdate(corto_collectionKind* _this, corto_collectionKind value);
...
CORTO_LANG_EXPORT void corto_compositeKindUpdate(corto_compositeKind* _this, corto_compositeKind value);
...
CORTO_LANG_EXPORT void corto_constantUpdate(corto_constant* _this, corto_constant value);
...
CORTO_LANG_EXPORT void corto_delegateUpdate(corto_delegate _this, corto_type returnType, corto_bool returnsReference, corto_parameterseq parameters);
...
CORTO_LANG_EXPORT void corto_delegatedataUpdate(corto_delegatedata* _this, corto_object instance, corto_function procedure);
...
CORTO_LANG_EXPORT void corto_destructActionUpdate(corto_destructAction* _this, corto_object instance, corto_function procedure);
...
CORTO_LANG_EXPORT void corto_dispatcherUpdate(corto_dispatcher _this);
...
CORTO_LANG_EXPORT void corto_enumUpdate(corto_enum _this);
...
CORTO_LANG_EXPORT void corto_equalityKindUpdate(corto_equalityKind* _this, corto_equalityKind value);
...
CORTO_LANG_EXPORT void corto_eventUpdate(corto_event _this, corto_uint16 kind);
...
CORTO_LANG_EXPORT void corto_eventMaskUpdate(corto_eventMask* _this, corto_eventMask value);
...
CORTO_LANG_EXPORT void corto_floatUpdate(corto_float _this, corto_width width, corto_float64 min, corto_float64 max);
...
CORTO_LANG_EXPORT void corto_float32Update(corto_float32* _this, corto_float32 value);
...
CORTO_LANG_EXPORT void corto_float64Update(corto_float64* _this, corto_float64 value);
...
CORTO_LANG_EXPORT void corto_functionUpdate(corto_function _this, corto_type returnType, corto_bool returnsReference);
...
CORTO_LANG_EXPORT void corto_initActionUpdate(corto_initAction* _this, corto_object instance, corto_function procedure);
...
CORTO_LANG_EXPORT void corto_intUpdate(corto_int _this, corto_width width, corto_int64 min, corto_int64 max);
...
CORTO_LANG_EXPORT void corto_int16Update(corto_int16* _this, corto_int16 value);
...
CORTO_LANG_EXPORT void corto_int32Update(corto_int32* _this, corto_int32 value);
...
CORTO_LANG_EXPORT void corto_int64Update(corto_int64* _this, corto_int64 value);
...
CORTO_LANG_EXPORT void corto_int8Update(corto_int8* _this, corto_int8 value);
...
CORTO_LANG_EXPORT corto_interface corto_interfaceCreate(corto_interface base, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType);
CORTO_LANG_EXPORT corto_interface corto_interfaceCreateChild(corto_object _parent, corto_string _name, corto_interface base, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType);
...
CORTO_LANG_EXPORT corto_int16 corto_interfaceDefine(corto_interface _this, corto_interface base, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType);
CORTO_LANG_EXPORT void corto_interfaceUpdate(corto_interface _this, corto_interface base, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType);
CORTO_LANG_EXPORT void corto_interfaceSet(corto_interface _this, corto_interface base, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType);
...
CORTO_LANG_EXPORT void corto_interfaceseqUpdate(corto_interfaceseq* _this, corto_interfaceseq value);
...
CORTO_LANG_EXPORT void corto_interfaceVectorUpdate(corto_interfaceVector* _this, corto_interface interface, corto_vtable vector);
...
CORTO_LANG_EXPORT void corto_interfaceVectorseqUpdate(corto_interfaceVectorseq* _this, corto_interfaceVectorseq value);
...
CORTO_LANG_EXPORT void corto_invokeActionUpdate(corto_invokeAction* _this, corto_object instance, corto_function procedure);
...
CORTO_LANG_EXPORT void corto_invokeEventUpdate(corto_invokeEvent _this, corto_replicator replicator, corto_object instance, corto_function function, corto_octetseq args);
...
CORTO_LANG_EXPORT void corto_iteratorUpdate(corto_iterator _this, corto_type elementType);
...
CORTO_LANG_EXPORT void corto_listUpdate(corto_list _this, corto_type elementType, corto_uint32 max);
...
CORTO_LANG_EXPORT void corto_mapUpdate(corto_map _this, corto_type elementType, corto_type keyType, corto_uint32 max);
...
CORTO_LANG_EXPORT void corto_memberUpdate(corto_member _this, corto_type type, corto_modifier modifiers, corto_state state, corto_bool weak);
...
CORTO_LANG_EXPORT void corto_memberseqUpdate(corto_memberseq* _this, corto_memberseq value);
...
CORTO_LANG_EXPORT void corto_metaprocedureUpdate(corto_metaprocedure _this, corto_type returnType, corto_bool returnsReference, corto_bool referenceOnly);
...
CORTO_LANG_EXPORT void corto_methodUpdate(corto_method _this, corto_type returnType, corto_bool returnsReference, corto_bool _virtual);
...
CORTO_LANG_EXPORT void corto_modifierUpdate(corto_modifier* _this, corto_modifier value);
...
CORTO_LANG_EXPORT void corto_notifyActionUpdate(corto_notifyAction* _this, corto_object instance, corto_function procedure);
...
CORTO_LANG_EXPORT void corto_objectseqUpdate(corto_objectseq* _this, corto_objectseq value);
...
CORTO_LANG_EXPORT void corto_observableEventUpdate(corto_observableEvent _this, corto_observer observer, corto_object me, corto_object source, corto_object observable);
...
CORTO_LANG_EXPORT void corto_observerUpdate(corto_observer _this, corto_eventMask mask, corto_object observable);
...
CORTO_LANG_EXPORT void corto_observerseqUpdate(corto_observerseq* _this, corto_observerseq value);
...
CORTO_LANG_EXPORT void corto_octetUpdate(corto_octet* _this, corto_octet value);
...
CORTO_LANG_EXPORT void corto_octetseqUpdate(corto_octetseq* _this, corto_octetseq value);
...
CORTO_LANG_EXPORT void corto_operatorKindUpdate(corto_operatorKind* _this, corto_operatorKind value);
...
CORTO_LANG_EXPORT void corto_packageUpdate(corto_package _this, corto_string url);
...
CORTO_LANG_EXPORT void corto_parameterUpdate(corto_parameter* _this, corto_string name, corto_type type, corto_bool passByReference);
...
CORTO_LANG_EXPORT void corto_parameterseqUpdate(corto_parameterseq* _this, corto_parameterseq value);
...
CORTO_LANG_EXPORT void corto_primitiveUpdate(corto_primitive _this, corto_width width);
...
CORTO_LANG_EXPORT void corto_primitiveKindUpdate(corto_primitiveKind* _this, corto_primitiveKind value);
...
CORTO_LANG_EXPORT corto_procedure corto_procedureCreate(corto_interface base, corto_modifier baseAccess, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType, corto_procedureKind kind);
CORTO_LANG_EXPORT corto_procedure corto_procedureCreateChild(corto_object _parent, corto_string _name, corto_interface base, corto_modifier baseAccess, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType, corto_procedureKind kind);
...
CORTO_LANG_EXPORT corto_int16 corto_procedureDefine(corto_procedure _this, corto_interface base, corto_modifier baseAccess, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType, corto_procedureKind kind);
CORTO_LANG_EXPORT void corto_procedureUpdate(corto_procedure _this, corto_interface base, corto_modifier baseAccess, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType, corto_procedureKind kind);
CORTO_LANG_EXPORT void corto_procedureSet(corto_procedure _this, corto_interface base, corto_modifier baseAccess, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType, corto_procedureKind kind);
...
CORTO_LANG_EXPORT void corto_procedureKindUpdate(corto_procedureKind* _this, corto_procedureKind value);
...
CORTO_LANG_EXPORT void corto_queryUpdate(corto_query _this, corto_object from, corto_eventMask mask);
...
CORTO_LANG_EXPORT void corto_replicatorUpdate(corto_replicator _this, corto_object mount, corto_query query, corto_notifyAction onDeclare, corto_notifyAction onUpdate, corto_notifyAction onDelete, corto_invokeAction onInvoke);
...
CORTO_LANG_EXPORT void corto_sequenceUpdate(corto_sequence _this, corto_type elementType, corto_uint32 max);
...
CORTO_LANG_EXPORT void corto_stateUpdate(corto_state* _this, corto_state value);
...
CORTO_LANG_EXPORT void corto_stringUpdate(corto_string* _this, corto_string value);
...
/* ::corto::lang::struct */
CORTO_LANG_EXPORT corto_struct corto_structCreate(corto_interface base, corto_modifier baseAccess, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType);
CORTO_LANG_EXPORT corto_struct corto_structCreateChild(corto_object _parent, corto_string _name, corto_interface base, corto_modifier baseAccess, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType);
...
CORTO_LANG_EXPORT corto_int16 corto_structDefine(corto_struct _this, corto_interface base, corto_modifier baseAccess, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType);
CORTO_LANG_EXPORT void corto_structUpdate(corto_struct _this, corto_interface base, corto_modifier baseAccess, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType);
CORTO_LANG_EXPORT void corto_structSet(corto_struct _this, corto_interface base, corto_modifier baseAccess, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType);
...
CORTO_LANG_EXPORT void corto_textUpdate(corto_text _this, corto_width charWidth, corto_uint64 length);
...
CORTO_LANG_EXPORT void corto_typeUpdate(corto_type _this, corto_type parentType, corto_state parentState, corto_type defaultType, corto_type defaultProcedureType);
...
CORTO_LANG_EXPORT void corto_typeKindUpdate(corto_typeKind* _this, corto_typeKind value);
...
CORTO_LANG_EXPORT void corto_uintUpdate(corto_uint _this, corto_width width, corto_uint64 min, corto_uint64 max);
...
CORTO_LANG_EXPORT void corto_uint16Update(corto_uint16* _this, corto_uint16 value);
...
CORTO_LANG_EXPORT void corto_uint32Update(corto_uint32* _this, corto_uint32 value);
...
CORTO_LANG_EXPORT void corto_uint64Update(corto_uint64* _this, corto_uint64 value);
...
CORTO_LANG_EXPORT void corto_uint8Update(corto_uint8* _this, corto_uint8 value);
...
CORTO_LANG_EXPORT void corto_virtualUpdate(corto_virtual _this, corto_type returnType, corto_bool returnsReference, corto_bool _virtual);
...
CORTO_LANG_EXPORT void corto_vtableUpdate(corto_vtable* _this, corto_vtable value);
...
CORTO_LANG_EXPORT void corto_widthUpdate(corto_width* _this, corto_width value);
...
CORTO_LANG_EXPORT void corto_wordUpdate(corto_word* _this, corto_word value);
