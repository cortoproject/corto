...
/* $end */
corto_resultIter _test_JsonReplicator_onRequest(test_JsonReplicator this, corto_string parent, corto_string expr, corto_bool setContent) {
