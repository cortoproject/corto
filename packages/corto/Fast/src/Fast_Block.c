...
cx_void _Fast_Block_addStatement(Fast_Block this, Fast_Node statement) {
/* $begin(::corto::Fast::Block::addStatement) */
    if (statement) {
        cx_assert(this->statements != NULL, "initialization failed");
        Fast_NodeListAppend(this->statements, statement);
    }
/* $end */
}

/* ::corto::Fast::Block::declare(string id,type type,bool isParameter,bool isReference) */
Fast_Local _Fast_Block_declare(Fast_Block this, cx_string id, cx_type type, cx_bool isParameter, cx_bool isReference) {
/* $begin(::corto::Fast::Block::declare) */
    ...
    if (Fast_Block_lookupLocal(this, id)) {
...
Fast_Local _Fast_Block_declareReturnVariable(Fast_Block this, cx_function function) {
...
Fast_Template _Fast_Block_declareTemplate(Fast_Block this, cx_string id, cx_type type, cx_bool isParameter, cx_bool isReference) {
...
Fast_Expression _Fast_Block_lookup(Fast_Block this, cx_string id) {
/* $begin(::corto::Fast::Block::lookup) */
    Fast_Expression result = NULL;

    result = Fast_Expression(Fast_Block_lookupLocal(this, id));
            ...
            if ((cx_procedure(cx_typeof(this->function))->kind == CX_METHOD) ||
               ...
               cx_observer(this->function)->template)) {
                if (strcmp(id, "this")) {
                    ...
                    thisLocal = Fast_Block_lookup(this, "this");
                    ...
                    if (!cx_instanceof(cx_type(cx_interface_o), parent)) {
                        ...
                        Fast_Parser_error(yparser(), 
                            ...
                            Fast_Parser_id(this->function, id));
                        goto error;
                    }                    
...
Fast_Local _Fast_Block_lookupLocal(Fast_Block this, cx_string id) {
...
Fast_Expression _Fast_Block_resolve(Fast_Block this, cx_string id) {
/* $begin(::corto::Fast::Block::resolve) */
    Fast_Expression result = NULL;

    if (!(result = Fast_Block_lookup(this, id))) {
        if (this->parent && !this->function) {
            result = Fast_Block_resolve(this->parent, id);
        }
    }
...
Fast_Local _Fast_Block_resolveLocal(Fast_Block this, cx_string id) {
/* $begin(::corto::Fast::Block::resolveLocal) */
    Fast_Local result = NULL;

    if (!(result = Fast_Block_lookupLocal(this, id))) {
        if (this->parent && !this->function) {
            result = Fast_Block_resolveLocal(this->parent, id);
        }
    }
...
cx_void _Fast_Block_setFunction(Fast_Block this, cx_function function) {
...
ic_node _Fast_Block_toIc_v(Fast_Block this, ic_program program, ic_storage storage, cx_bool stored) {
/* $begin(::corto::Fast::Block::toIc) */
    ...
    if (!this->_while) {
        Fast_Block_toIcBody_v(this, program, storage, stored);
    } else {
        Fast_While_toIc(this->_while, program, storage, stored);
    }
...
ic_node _Fast_Block_toIcBody_v(Fast_Block this, ic_program program, ic_storage storage, cx_bool stored) {
