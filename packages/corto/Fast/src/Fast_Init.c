...
ic_node _Fast_Init_toIc_v(Fast_Init this, ic_program program, ic_storage storage, cx_bool stored) {
/* $begin(::corto::Fast::Init::toIc) */
    ...
    IC_1(program, Fast_Node(this)->line, ic_init, s, IC_DEREF_ADDRESS);
