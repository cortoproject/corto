...
/* $begin(::corto::Fast::isOperatorAssignment) */
    cx_bool result;
    switch(operator) {
    case CX_ASSIGN:
    case CX_ASSIGN_ADD:
...
/* $begin(::corto::Fast::reportWarning) */
...
/* $begin(::corto::Fast::valueKindFromType) */
